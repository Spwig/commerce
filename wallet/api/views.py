...
@extend_schema_view(
    list=extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                name="type",
                description=_("Filter by transaction type"),
            ...
            OpenApiParameter(
                name="limit",
                description=_("Number of results (default 20, max 100)"),
                type=int,
                required=False,
            ),
            OpenApiParameter(
                name="offset",
                description=_("Pagination offset"),
                type=int,
                required=False,
            ),
        ],
...
@extend_schema_view(
    list=extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                name="search",
                description=_("Search by customer email or name"),
                required=False,
            ),
            OpenApiParameter(
                name="is_active",
...
@extend_schema_view(
    list=extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                name="wallet_id",
                description=_("Filter by wallet ID"),
                type=int,
                required=False,
            ),
            OpenApiParameter(
            ...
            OpenApiParameter(
                name="search",
                description=_("Search by customer email"),
                required=False,
            ),
            OpenApiParameter(
                name="limit",
                description=_("Number of results (default 50, max 100)"),
                type=int,
                required=False,
            ),
            OpenApiParameter(
