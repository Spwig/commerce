...
from core.api.throttling import BurstRateThrottle, PublicWriteThrottle, SustainedRateThrottle

from .models import BlogCategory, BlogPost, BlogSettings, BlogSubscriber, BlogTag
    ...
    list=extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter(
                ...
                str,
                description=_(
                    "Order by: published_at, view_count, reading_time_minutes, created_at (prefix with - for desc)"
                ),
            ),
        ],
    ),
...
class BlogPostViewSet(HeadlessAPIMixin, viewsets.ModelViewSet):
    ...
    @extend_schema(
        ...
        description=_(
            "Immediately publish a blog post. Sets status to 'published' and published_at to now if not already set."
        ),
        responses={
    ...
    @extend_schema(
        ...
        description=_(
            "Schedule a blog post for future publication. Requires `scheduled_at` in the request body (ISO 8601 datetime)."
        ),
        responses={
            200: BlogPostDetailSerializer,
...
@extend_schema_view(
    ...
    create=extend_schema(
        ...
        description=_(
            "Create a new blog category. Staff access required. Slug is auto-generated from name if not provided."
        ),
        responses={
...
@extend_schema_view(
    ...
    create=extend_schema(
        ...
        description=_(
            "Create a new blog tag. Staff access required. Slug is auto-generated from name if not provided."
        ),
        responses={
...
@extend_schema(
    ...
    parameters=[
        OpenApiParameter(
            ...
            description=_("Optional unsubscribe reason"),
            required=False,
        ),
    ],
    responses={
