...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const usePageBuilderCheckbox = $('#id_use_page_builder');
  const simpleContentField = $('.field-simple_content');
  const contentPageField = $('.field-content_page');
  ...
  const contentPageSelect = $('#id_content_page');
