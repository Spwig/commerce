    ...
    def get_sample_data(template_type: str, language: str = 'en', request=None) -> Dict:
        ...
        template_data = {
            'order_confirmation': {
                ...
                'timeline_stages': [
                    {'stage': 'ordered', 'label': 'Order Placed', 'active': True, 'completed': True},
                    {'stage': 'processing', 'label': 'Processing', 'active': False, 'completed': False},
                    {'stage': 'shipped', 'label': 'Shipped', 'active': False, 'completed': False},
                    {'stage': 'delivered', 'label': 'Delivered', 'active': False, 'completed': False},
                ],
            },
            ...
            'shipping_confirmation': {
                ...
                'timeline_stages': [
                    {'stage': 'ordered', 'label': 'Order Placed', 'active': False, 'completed': True},
                    {'stage': 'processing', 'label': 'Processing', 'active': False, 'completed': True},
            ...
            'payment_confirmation': {
                ...
                'timeline_stages': [
                    {'stage': 'ordered', 'label': 'Order Placed', 'active': False, 'completed': True},
                    {'stage': 'processing', 'label': 'Processing', 'active': True, 'completed': True},
                    {'stage': 'shipped', 'label': 'Shipped', 'active': False, 'completed': False},
                    {'stage': 'delivered', 'label': 'Delivered', 'active': False, 'completed': False},
                ],
            },
