...
class TrackingService:
    ...
    def add_tracking(
        ...
        html_with_pixel = self._add_open_tracking_pixel(
            html_body,
            tracking_id
        )

        # Rewrite links for click tracking
        html_with_tracking = self._add_link_tracking(
            html_with_pixel,
            tracking_id
        )
    ...
    def parse_tracking_id(self, tracking_id: str) -> Optional[str]:
        """
