...
class EmailTemplateTranslationService:
    ...
    def translate_template(
        ...
        try:
            ...
            return {
                'success': False,
                'message': 'Translations app not configured',
                'jobs': []
            }
        ...
        from email_system.services.template_translation_extractor import TemplateTranslationExtractor
    ...
    def get_translation_status(
        ...
        translations = EmailTemplateTranslation.objects.filter(
            template=template
        ).select_related('translation_job')
            ...
            if lang == template.language_code:
                ...
                if translation:
                    status['languages'][lang] = {
                        ...
                        'job_id': translation.translation_job_id if translation.translation_job else None
                    }
                else:
                    status['languages'][lang] = {
                        'status': 'missing',
        ...
        translated_count = sum(
            1 for lang_data in status['languages'].values()
