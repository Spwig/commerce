...
urlpatterns = [
    ...
    path('accounts/<uuid:account_id>/toggle-active/', admin_views.toggle_account_active, name='account_toggle_active'),
    path('accounts/<uuid:account_id>/set-default/', admin_views.set_account_default, name='account_set_default'),
    path('accounts/<uuid:account_id>/test-connection/', admin_views.test_account_connection, name='account_test_connection'),
