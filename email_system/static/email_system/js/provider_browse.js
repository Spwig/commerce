    ...
    class ProviderInstaller {
        ...
        async install(providerSlug, providerName) {
            try {
                ...
                const response = await fetch(AdminUtils.buildAdminUrl(`/admin/email-system/providers/install/${providerSlug}/`), {
                    method: 'POST',
                    headers: {
        ...
        updateCardToInstalled(providerSlug) {
            ...
            if (installBtn) {
                ...
                configureBtn.href = AdminUtils.buildAdminUrl('/admin/email-system/wizard/step1/');
    ...
    class ProviderUpdater {
        ...
        async update(providerSlug, providerVersion) {
            try {
                ...
                const response = await fetch(AdminUtils.buildAdminUrl(`/admin/email-system/providers/update/${providerSlug}/`), {
                    method: 'POST',
                    headers: {
                        'X-CSRFToken': this.csrfToken,
                        'Content-Type': 'application/json',
        ...
        detailsButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                try {
                    ...
                    providerData.provider_type = 'email';
