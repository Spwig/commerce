...
(function() {
    ...
    async function sendTestEmail() {
        ...
        try {
            ...
            const response = await fetch(AdminUtils.buildAdminUrl(`/admin/email-system/templates/${templateId}/send-test/`), {
                method: 'POST',
                headers: {
    ...
    async function loadTranslation(languageCode) {
        ...
        try {
            const response = await fetch(AdminUtils.buildAdminUrl(`/admin/email-system/templates/${templateId}/translation/${languageCode}/`), {
                headers: {
                    'X-CSRFToken': AdminUtils.getCsrfToken(),
                }
            });
