...
(function () {
  ...
  function initWidgets() {
    document.querySelectorAll('.social-share-widget').forEach(function (widget) {
      ...
      const shareUrl = encodeURIComponent(widget.dataset.shareUrl || window.location.href);
      const shareTitle = encodeURIComponent(widget.dataset.shareTitle || document.title);
      const trackShares = widget.dataset.trackShares === 'true';
      ...
      widget.querySelectorAll('.social-share-btn').forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          const url = template.replace(/{url}/g, shareUrl).replace(/{title}/g, shareTitle);
