...
class SocialSharingSettingsForm(forms.ModelForm):
    ...
    enabled_platforms = forms.MultipleChoiceField(
        ...
        widget=forms.CheckboxSelectMultiple(
            attrs={'class': 'social-platform-checkboxes'}
        ),
        label=_('Enabled Platforms'),
        help_text=_('Select which platforms to show. If none selected, all platforms will be shown.'),
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'placement_position',
            'enabled_platforms',
            'button_style', 'button_size', 'layout_direction',
            'show_title', 'mobile_visibility',
            'show_counts', 'track_shares',
        ]
