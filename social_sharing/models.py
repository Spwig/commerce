...
class SocialShare(models.Model):
    ...
    object_id = models.PositiveIntegerField(
        verbose_name=_("object ID"), help_text=_("ID of the shared object")
    )
    ...
    shared_url = models.URLField(
        max_length=500, verbose_name=_("shared URL"), help_text=_("URL that was shared")
    )
    ...
    user_agent = models.TextField(
        blank=True, verbose_name=_("user agent"), help_text=_("Browser user agent string")
    )
...
class ShareCount(models.Model):
    ...
    platform = models.CharField(
        max_length=20, choices=SocialShare.PLATFORM_CHOICES, verbose_name=_("platform")
    )
...
# Import settings model — force-loads settings_models so its models register with Django
from social_sharing.settings_models import SocialSharingSettings  # noqa: E402, F401
