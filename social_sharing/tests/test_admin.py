...
from social_sharing.admin import ShareCountAdmin, SocialShareAdmin, SocialSharingSettingsAdmin
...
class SocialSharingSettingsFormTest(TestCase):
    ...
    def test_form_has_checkbox_widget_for_platforms(self):
        ...
        self.assertIsInstance(
            form.fields["enabled_platforms"].widget, django_forms.CheckboxSelectMultiple
        )
