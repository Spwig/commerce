...
## Subject
⚠️ {{ component_name }} akan dihentikan pada {{ deprecation_date }}
...
{{ component_name }} akan dihentikan dan tidak lagi disarankan untuk digunakan. Silakan rencanakan migrasi ke solusi alternatif.
...
{% if recommended_alternative %}RECOMMENDED ALTERNATIVE:
{{ alternative_name }}
{{ alternative_description }}
{% endif %}
