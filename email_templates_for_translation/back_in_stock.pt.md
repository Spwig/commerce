...
## Subject
{{ product_name }} está de volta no estoque! - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Um item da sua lista de desejos está de volta no estoque
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Não perca!</strong> Itens populares vendem rápido - garanta o seu antes que fique indisponível novamente.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Continue navegando pelos nossos produtos mais recentes
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          Você recebeu este e-mail porque se inscreveu para ser notificado quando este produto ficasse disponível.
          Esta é uma notificação única - você não receberá mais e-mails sobre este produto.
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Boa notícia! {{ product_name }} está de volta no estoque!

Você nos pediu para notificá-lo quando este item ficasse disponível novamente, e estamos felizes em informá-lo que agora está em estoque.

DETALHES DO PRODUTO:
{{ product_name }}{% if variant_name %}
Variação: {{ variant_name }}{% endif %}
...
Não perca! Itens populares vendem rápido - garanta o seu antes que fique indisponível novamente.
...
Você recebeu este e-mail porque se inscreveu para ser notificado quando este produto ficasse disponível.
Este é um aviso único - você não receberá mais e-mails sobre este produto.
