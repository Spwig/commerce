...
## Subject
Ingat: Hadiah {{ reward_amount }} Anda segera kedaluwarsa
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Jangan biarkan hadiah referral {{ reward_amount }} Anda terbuang sia-sia! Ia akan kedaluwarsa dalam {{ days_until_expiration }} hari.
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Gunakan sekarang pada pembelian berikutnya sebelum terlambat!
        </mj-text>
      </mj-column>
    </mj-section>
