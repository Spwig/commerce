...
## Subject
🏆 تقرير المنتجات المميزة - {{ report_period }}
      ...
      <mj-column>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="12px">
          <mj-column>
            <mj-text font-size="14px" color="{{ theme.color.text|default:'#4b5563' }}">
              ...
              الإيرادات: {{ product.revenue }} | المبيعات: {{ product.units }}
            </mj-text>
          </mj-column>
        </mj-section>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="12px">
          <mj-column>
            <mj-text font-size="14px" color="{{ theme.color.text|default:'#4b5563' }}">
              <strong>{{ product.rank }}. {{ product.name }}</strong><br/>
              الوحدات: {{ product.units }} | الإيرادات: {{ product.revenue }}
            </mj-text>
          </mj-column>
        </mj-section>
        <mj-spacer height="8px" />
