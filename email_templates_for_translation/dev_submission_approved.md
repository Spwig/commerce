...
## Subject
Component approved: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Great news! Your component submission has been approved and is ready for publication to the Spwig Marketplace.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if review_notes %}Reviewer Notes: {{ review_notes }}{% endif %}
