...
## Subject
Tebrikler! {{ new_tier }} seviyesine yükseltildiniz
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Tebrikler! Loyaliteniz sonuç verdi. {{ new_tier }} seviyesine yükseltildiniz!
        </mj-text>

        <!-- Bonus Points (if any) -->
        {% if bonus_points %}
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          <strong>🎁 Yükseltme Bonusu: {{ bonus_points }} puan!</strong>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
{% if bonus_points %}Yükseltme Bonusu: {{ bonus_points }} puan!{% endif %}
