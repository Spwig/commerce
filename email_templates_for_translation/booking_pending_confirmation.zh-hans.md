...
## Subject
预订已收到 - {{ product_name }} 于 {{ booking_date }}
...
{% if persons_display %}宾客: {{ persons_display }}{% endif %}
{% if total_cost %}总计: {{ total_cost }}{% endif %}