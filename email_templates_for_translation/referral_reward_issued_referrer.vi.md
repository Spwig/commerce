...
## Subject
Bạn vừa nhận được phần thưởng {{ reward_amount }}!
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Cảm ơn bạn đã giới thiệu {{ referee_name }}
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Chúc mừng! {{ referee_name }} vừa thực hiện lần mua hàng đầu tiên bằng liên kết giới thiệu của bạn, và bạn đã nhận được phần thưởng {{ reward_amount }}!
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Hãy tiếp tục chia sẻ liên kết giới thiệu của bạn để nhận thêm nhiều phần thưởng. Càng nhiều bạn bè bạn giới thiệu, bạn sẽ càng nhận được nhiều hơn!
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-button background-color="{{ theme.color.primary|default:'#2563eb' }}" color="{{ theme.color.background|default:'#ffffff' }}" href="{{ referral_dashboard_url }}">
          Xem danh sách giới thiệu của bạn
        </mj-button>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Chia sẻ liên kết này với bạn bè để nhận thêm phần thưởng
        </mj-text>
      </mj-column>
    </mj-section>
...
Thống kê giới thiệu của bạn:
- Số lần giới thiệu thành công: {{ total_referrals }}
- Tổng phần thưởng đã nhận: {{ total_rewards_earned }}

Hãy tiếp tục chia sẻ liên kết giới thiệu của bạn để nhận thêm nhiều phần thưởng:
{{ referral_link }}
