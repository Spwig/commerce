...
## Subject
Glückwunsch! Sie wurden auf {{ new_tier }} upgegradet
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Glückwunsch! Ihre Treue hat sich gelohnt. Sie wurden auf {{ new_tier }} upgegradet!
        </mj-text>

        <!-- Bonus Points (if any) -->
        {% if bonus_points %}
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          <strong>🎁 Upgrade Bonus: {{ bonus_points }} Punkte!</strong>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
{% if bonus_points %}Upgrade Bonus: {{ bonus_points }} Punkte!{% endif %}
