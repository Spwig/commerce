...
## Subject
{{ product_name }} is back in stock! - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Don't miss out!</strong> Popular items sell fast - secure yours before it's gone again.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          You received this email because you signed up to be notified when this product became available.
          This is a one-time notification - you won't receive any more emails about this product.
        </mj-text>
      </mj-column>
    </mj-section>
...
You asked us to notify you when this item became available again, and we're happy to let you know it's now in stock.
...
Don't miss out! Popular items sell fast - secure yours before it's gone again.
