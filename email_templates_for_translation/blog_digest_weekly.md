...
## Subject
This week on {{ blog_name }}: {{ post_count }} new article{{ post_count|pluralize }}
...
| post_count | Posts this week | 3 |
| week_start | Week start date | February 8, 2026 |
| week_end | Week end date | February 14, 2026 |
| posts | List of posts | [{title, author, excerpt, reading_time, featured_image, url}] |
| blog_url | Blog homepage | https://shop.com/en/blog |
| unsubscribe_url | Unsub link | https://shop.com/en/blog/unsubscribe/abc123 |
| preferences_url | Preferences page | https://shop.com/en/account/preferences |

## Notes

- Weekly digest (sent Monday mornings)
- Marketing email - opt-in required
- Aggregates all posts from previous week
- Shows max 5 posts, link for more
