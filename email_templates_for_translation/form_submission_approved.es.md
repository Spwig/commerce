  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Tu envío de {{ form_name }} ha sido aprobado!
        </mj-text>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="20px">
          <mj-column>
            ...
            <mj-text color="{{ theme.color.text|default:'#4b5563' }}">
              ...
              <strong>Aprobado:</strong> {{ approval_date }}<br/>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          ¿Preguntas? <a href="{{ support_url }}">Contactar soporte</a>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
{% if cta_url %}{{ cta_text|default:'Ver detalles' }}: {{ cta_url }}{% endif %}

{% if support_url %}¿Preguntas? Contactar soporte: {{ support_url }}{% endif %}