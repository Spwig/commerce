...
|----------|-------------|---------|
| days_remaining | Days until expiry | 7 |
| license_key_masked | Masked license key | ABCD1234****EF56 |
| expires_at | Expiration date | March 30, 2026 |
| is_grace_period | Whether in grace period | True |
| renewal_url | Renewal link | https://spwig.com/pos |

## Notes

- Sent to admin email when POS license nears expiry
- Admin-only notification
- Urgency varies: normal expiry vs grace period
