...
## Subject
Anda mendapatkan hadiah sebesar {{ reward_amount }}!
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Terima kasih telah mereferensikan {{ referee_name }}
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Selamat! {{ referee_name }} baru saja melakukan pembelian pertamanya menggunakan tautan referensi Anda, dan Anda telah mendapatkan hadiah sebesar {{ reward_amount }}!
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Terus bagikan tautan referensi Anda untuk mendapatkan lebih banyak hadiah. Semakin banyak teman yang Anda referensikan, semakin banyak hadiah yang Anda peroleh!
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="18px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center" padding-bottom="15px">
          Terus Bagikan, Terus Peroleh Hadiah!
        </mj-text>
        <mj-text
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Bagikan tautan ini dengan teman-teman untuk mendapatkan lebih banyak hadiah
        </mj-text>
      </mj-column>
    </mj-section>
...
Statistik Referensi Anda:
- Referensi Berhasil: {{ total_referrals }}
- Total Hadiah yang Diperoleh: {{ total_rewards_earned }}

Terus bagikan tautan referensi Anda untuk mendapatkan lebih banyak hadiah:
{{ referral_link }}
