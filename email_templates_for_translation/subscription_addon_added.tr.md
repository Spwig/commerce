...
## Subject
✓ {{ addon_name }} abonelikinize eklendi
  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          {{ addon_name }} abonelikinize eklenmiştir ve şimdi aktif!
        </mj-text>
        ...
        <mj-section background-color="#eff6ff" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#1e40af" line-height="1.6">
              💡 Bugün mevcut faturalama döneminizin kalan kısmına yönelik {{ prorated_charge }} ücreti alınmıştır.
            </mj-text>
          </mj-column>
        </mj-section>
        {% endif %}
