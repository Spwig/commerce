...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <!-- CTA Button -->
    {% include 'email_system/mjml_components/cta_button.mjml' with url=order_url text="查看订单状态" %}
...
原始送达日期：{{ original_delivery_date }}
新的预计送达日期：{{ new_delivery_date }}
...
作为道歉...
{{ compensation_details }}
{% if discount_code %}优惠码：{{ discount_code }}{% endif %}
{% endif %}
