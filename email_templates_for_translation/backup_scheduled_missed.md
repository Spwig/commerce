...
## Subject
⚠️ Scheduled Backup Did Not Run - {{ shop_name }}
...
| scheduled_time | Expected run time | 2026-02-15 02:00:00 UTC |
| backup_type | Backup type | Daily Full Backup |
| last_successful_backup | Last successful run | 2026-02-14 02:00:00 UTC |
| time_since_last | Duration since last | 24 hours ago |
| admin_backup_url | Backup page | https://shop.com/en/admin/backups/ |
| admin_logs_url | System logs | https://shop.com/en/admin/logs/ |

## Notes

- Warning alert - sent when backup doesn't execute
