...
## Subject
Il tuo account sviluppatore Spwig è stato sospeso
...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.warning|default:'#f59e0b' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          Aggiornamento importante sul tuo account sviluppatore
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Il tuo account sviluppatore Spwig è stato sospeso. Durante questo periodo, i componenti pubblicati rimarranno disponibili, ma non potrai inviare nuovi componenti o aggiornamenti.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Se ritieni che questa sospensione sia stata effettuata per errore, contattaci a <a href="mailto:{{ support_email }}" style="color: {{ theme.color.primary|default:'#2563eb' }}; text-decoration: none;">{{ support_email }}</a>.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if suspension_reason %}Motivo: {{ suspension_reason }}{% endif %}

Se ritieni che questa sospensione sia stata effettuata per errore, contattaci a {{ support_email }}.
