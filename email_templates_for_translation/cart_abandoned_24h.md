...
## Subject
Still interested? Your cart expires soon - {{ shop_name }}
...
| cart_item_count | Number of items | 3 |
| cart_items | List with stock info | [{name, image, qty, price, low_stock, stock_remaining}] |
| cart_total | Total value | $89.99 |
| cart_url | Checkout URL | https://shop.com/en/cart |
| free_shipping_threshold | Free shipping minimum | $50 |
| preferences_url | Preference settings | https://shop.com/en/account/preferences |

## Notes

- Sent 24 hours after abandonment
- Second email in sequence - adds urgency
- Shows low stock warnings if applicable
- Highlights benefits (shipping, guarantee)
- Conversion rate: 10-15% typically
