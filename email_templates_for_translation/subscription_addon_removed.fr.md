...
## Subject
L'abonnement {{ addon_name }} a été supprimé
  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          L'abonnement {{ addon_name }} a été supprimé de votre abonnement {{ plan_name }}.
        </mj-text>
        ...
        <mj-section background-color="#f0fdf4" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#065f46" line-height="1.6">
              💰 Un crédit de {{ credit_amount }} a été appliqué à votre compte pour la partie non utilisée de cet add-on.
            </mj-text>
          </mj-column>
        </mj-section>
        {% endif %}
