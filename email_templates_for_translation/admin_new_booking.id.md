...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Telah ada pemesanan baru yang dipesan dan memerlukan perhatian Anda.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    {% include 'email_system/mjml_components/cta_button.mjml' with url=admin_booking_url text="Lihat di Admin" %}
    {% endif %}
  </mj-body>
</mjml>
...
{% if admin_booking_url %}Lihat di Admin: {{ admin_booking_url }}{% endif %}