...
## Subject
رد {{ replier_name }} على تعليقك في "{{ post_title }}"
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          مرحبًا {{ commenter_name }},
        </mj-text>

        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          {{ replier_name }} رد على تعليقك في "{{ post_title }}".
        </mj-text>
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          لا تريد إشعارات الرد؟ <a href="{{ unsubscribe_url }}">الغاء الاشتراك</a>
        </mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
...
لا تريد إشعارات الرد؟ الغاء الاشتراك: {{ unsubscribe_url }}