...
## Subject
{{ component_name }} v{{ version }} が Spwig マーケットプレイスでリリースされました！
...
あなたのコンポーネントは今やSpwigマーケットプレイスでリリースされ、すべてのSpwigの商人に利用可能になりました！

コンポーネント: {{ component_name }}
タイプ: {{ component_type }}
バージョン: v{{ version }}

コンポーネントのパフォーマンスを分析ダッシュボードで追跡してください。商人がコンポーネントを開始して使用し始めると、ダウンロード数、評価、レビューが表示されます。
