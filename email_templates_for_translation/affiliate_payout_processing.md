...
## Subject
Your {{ payout_amount }} payout is being processed
    ...
    <mj-section background-color="#f8f9fa" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="#212529">
          ...
          <strong>Amount:</strong> {{ payout_amount }}<br/>
          <strong>Payment Method:</strong> {{ payout_method }}
        </mj-text>
      </mj-column>
    </mj-section>
...
| payout_method | Payment method | PayPal |
...
- Sent when payout is initiated
- Transactional email
- Sets expectation for 3-5 business days
