  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Your subscription plan has been successfully upgraded. You now have access to all the benefits of {{ new_plan_name }}!
        </mj-text>
...
| old_plan_name | Previous plan name | Basic Plan |
| new_plan_name | New plan name | Premium Plan |
| upgrade_date | When upgraded | February 15, 2026 |
| new_features | New benefits description | • Unlimited downloads\n• Priority support\n• Advanced analytics |
| new_price | New plan price | $49.99 |
| billing_period | Billing frequency | month |
| next_billing_date | Next charge date | March 15, 2026 |
| prorated_charge | Prorated amount (if any) | $15.00 |
...
- Customer confirmation - plan upgrade
- Sent immediately after upgrade
- Explains prorated billing if applicable
- Lists new benefits and features
