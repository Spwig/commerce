...
## Subject
We received your developer application, {{ developer_name }}
...
3. Once approved, you'll get full access to the developer dashboard

View Developer Portal: {{ portal_url }}
