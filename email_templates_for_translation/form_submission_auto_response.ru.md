    ...
    <mj-section>
      <mj-column>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="{{ theme.color.text|default:'#4b5563' }}">
              <strong>Ваша ссылка на заявку:</strong> {{ submission_id }}
            </mj-text>
          </mj-column>
        </mj-section>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          Нужна срочная помощь? <a href="{{ support_url }}">Свяжитесь с поддержкой</a>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
Ваша ссылка на заявку: {{ submission_id }}

{% if support_url %}Нужна срочная помощь? Свяжитесь с поддержкой: {{ support_url }}{% endif %}