...
## Subject
Konfirmasi Pesanan #{{ order_number }} - Terima Kasih!
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          <strong>Estimasi Pengiriman:</strong> {{ estimated_delivery_start }} - {{ estimated_delivery_end }}
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px 20px 10px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="5px">
          Lacak pesanan Anda, checkout lebih cepat di masa depan, dan kelola preferensi Anda.
        </mj-text>
      </mj-column>
    </mj-section>
...
Estimasi Pengiriman: {{ estimated_delivery_start }} - {{ estimated_delivery_end }}
