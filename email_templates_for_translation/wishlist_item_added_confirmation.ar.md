...
## Subject
✓ {{ product_name }} تم إضافته إلى قائمة رغباتك - {{ shop_name }}
  ...
  <mj-body>
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          لقد أضفت {{ product_name }} بنجاح إلى قائمة رغباتك. سنراقبه من أجلك!
        </mj-text>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="20px">
          ...
          <mj-column width="65%">
            ...
            <mj-text font-size="13px" color="#dc2626">
              ⚠️ نفذ من المخزون - سنعلمك عندما يعود!
            </mj-text>
            {% endif %}
          </mj-column>
        </mj-section>
        ...
        <mj-section background-color="#f0fdf4" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#065f46" align="center">
              💡 <strong>سنعلمك بالتغييرات التالية:</strong><br/>
              • انخفاض الأسعار<br/>
              • تنبيهات إعادة توفر المنتج<br/>
              • مبيعات محدودة بالوقت
            </mj-text>
          </mj-column>
        </mj-section>
...
{{ product_name }}
Price: {{ product_price }}
{% if product_in_stock %}✓ متوفر في المخزون{% else %}⚠️ نفذ من المخزون - سنعلمك عندما يعود!{% endif %}

💡 سنعلمك بالتغييرات التالية:
• انخفاض الأسعار
• تنبيهات إعادة توفر المنتج
• مبيعات محدودة بالوقت
