...
## Subject
تمت الموافقة على المكون: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="40px 20px">
      <mj-column>
        <mj-text font-size="32px" font-weight="bold" color="{{ theme.color.background|default:'#ffffff' }}" align="center">
          تمت الموافقة على المكون!
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          تم استعداد مشاركتك للنشر
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          أخبار سارة! تم الموافقة على مكونك وتم استعداده للنشر في سوق Spwig.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          <strong>بوابة المطورين الخاصة بـ Spwig</strong>
        </mj-text>
...
{% if review_notes %}ملاحظات المراجع: {{ review_notes }}{% endif %}

عرض المساهمة: {{ submission_url }}

---
بوابة المطورين الخاصة بـ Spwig