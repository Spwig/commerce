...
## Subject
{{ product_name }} est de retour en stock ! - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Un article de votre liste de souhaits est de retour en stock
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Ne manquez pas l'occasion !</strong> Les articles populaires se vendent rapidement - assurez-vous de l'avoir avant qu'il ne soit à nouveau épuisé.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Continuez à explorer nos derniers produits
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          Vous avez reçu cet e-mail parce que vous vous êtes inscrit pour être notifié lorsque ce produit est devenu disponible.
          C'est une notification unique - vous ne recevrez plus d'autres e-mails concernant ce produit.
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Grande nouvelle ! {{ product_name }} est de retour en stock !

Vous nous avez demandé de vous notifier lorsque ce produit serait à nouveau disponible, et nous sommes heureux de vous informer qu'il est désormais en stock.
...
Ne manquez pas l'occasion ! Les articles populaires se vendent rapidement - assurez-vous de l'avoir avant qu'il ne soit à nouveau épuisé.
...
Vous avez reçu cet e-mail parce que vous vous êtes inscrit pour être notifié lorsque ce produit serait à nouveau disponible.
C'est une notification unique - vous ne recevrez plus d'autres e-mails concernant ce produit.
