...
## Subject
📦 แจ้งเตือนสินค้าใกล้หมดสต็อก - ต้องการสั่งซื้อใหม่ {{ product_count }} รายการ
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="15px" color="{{ theme.color.text|default:'#4b5563' }}">
          มี {{ product_count }} รายการสินค้าที่ต่ำกว่าจุดสั่งซื้อใหม่
        </mj-text>
