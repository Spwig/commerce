...
## Subject
✅ Pagamento ricevuto per {{ plan_name }} - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding="0 20px" line-height="1.6" align="center">
          La tua sottoscrizione rimane attiva e continui a disporre di tutti i benefici.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% endif %}Next Billing Date: {{ next_billing_date|date:"F d, Y" }}
