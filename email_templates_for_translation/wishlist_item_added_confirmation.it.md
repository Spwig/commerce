...
## Subject
✓ {{ product_name }} aggiunto alla lista dei desideri - {{ shop_name }}
    ...
    <mj-section>
      <mj-column>
        <mj-text font-size="20px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}">
          ❤️ Aggiunto alla tua lista dei desideri!
        </mj-text>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Hai aggiunto con successo {{ product_name }} alla tua lista dei desideri. Ti terremo aggiornato!
        </mj-text>
...
💡 TI TERREMO AGGIORNATO SU:
• Price drops
• Back in stock alerts
• Limited-time sales

Visualizza la mia lista dei desideri: {{ wishlist_url }}
{% if product_in_stock %}Compra ora: {{ product_url }}{% endif %}