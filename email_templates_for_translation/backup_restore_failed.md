...
| backup_filename | Failed restore file | 2026-02-14_full.sql.gz |
| restore_started_at | Restore start time | 2026-02-15 10:00:00 UTC |
| restore_failed_at | Failure timestamp | 2026-02-15 10:08:22 UTC |
| restore_duration | Time before failure | 8 minutes 22 seconds |
| error_message | Technical error | Foreign key constraint violation: orders.customer_id |
| admin_backup_url | Backup admin page | https://shop.com/en/admin/backups/ |
| support_url | Emergency support | https://shop.com/en/support/emergency |

## Notes

- CRITICAL PRIORITY - Highest alert level
- Always sent regardless of preferences
- Should trigger SMS/phone alerts
- Store may be in inconsistent state
