    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Favori listenizdeki bir ürün tekrar stokta
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Kaçmayın!</strong> Popüler ürünler hızlı satılır - tekrar stokta olana kadar kendi ürününüzü alın.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          En son ürünleri keşfetmeye devam edin
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          Bu e-postayı bu ürün mevcut olduğunda bildirilmek için kayıt oldunuz.
          Bu bir kez bildirimdir - bu ürün hakkında başka e-postalar almayacaksınız.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="12px" color="#9ca3af" align="center">
          Yardım mı istiyorsunuz? Bize {{ support_email }} adresinden ulaşın
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Harika Haber! {{ product_name }} tekrar stokta!

Bu ürün mevcut olduğunda bizi bilgilendirmenizi istediniz, ve memnuniyetle haber veriyoruz ki ürün artık stokta.

ÜRÜN DETAYLARI:
{{ product_name }}{% if variant_name %}
Variant: {{ variant_name }}{% endif %}
...
Kaçmayın! Popüler ürünler hızlı satılır - tekrar stokta olana kadar kendi ürününüzü alın.
