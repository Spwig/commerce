...
## Subject
Nova recompensa desbloqueada: {{ reward_name }}!
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Boas notícias! Você agora tem pontos suficientes para resgatar {{ reward_name }}.
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Seu saldo atual: {{ current_points }} pontos
        </mj-text>
      </mj-column>
    </mj-section>
...
{{ reward_description }}
Custo: {{ points_cost }} pontos

Seu saldo atual: {{ current_points }} pontos

Resgatar agora: {{ redeem_url }}
