...
## Subject
Componente inviato: {{ component_name }} v{{ version }}
...
Abbiamo ricevuto la tua submission del componente e ha superato la validazione automatica. Il nostro team la sta ora revisionando.

Componente: {{ component_name }}
Tipo: {{ component_type }}
Versione: v{{ version }}

Le revisioni richiedono in genere 2-3 giorni lavorativi. Ti notificheremo quando la revisione sarà completata.

Visualizza la submission: {{ submission_url }}
