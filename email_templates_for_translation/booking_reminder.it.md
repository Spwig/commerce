...
## Subject
Ricordo: {{ product_name }} - {{ booking_date }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="28px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          Ricordo Prenotazione
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Ciao {{ customer_name }}, questo è un ricordo riguardo alla tua prossima prenotazione.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="10px 20px">
      <mj-column>
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Devi apportare modifiche? Puoi <a href="{{ reschedule_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">riprogrammare</a> o <a href="{{ cancel_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">cancellare</a> la tua prenotazione dal tuo account.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if ical_url %}Aggiungi al calendario: {{ ical_url }}{% endif %}

Devono apportare modifiche? Visita il tuo account per riprogrammare o cancellare.
{{ reschedule_url }}
{{ cancel_url }}