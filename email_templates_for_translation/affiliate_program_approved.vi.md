  ...
  <mj-body background-color="#f8f9fa">
    ...
    <mj-section background-color="#ffffff" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="#212529">
          Tin vui! Bạn đã được duyệt để quảng bá {{ program_name }}.
        </mj-text>
        <mj-text font-size="16px" color="#212529">
          Bắt đầu chia sẻ chương trình này để kiếm hoa hồng!
        </mj-text>
      </mj-column>
    </mj-section>
...
Nhận liên kết đại lý: {{ portal_url }}
