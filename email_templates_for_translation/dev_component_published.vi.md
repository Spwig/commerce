...
## Subject
{{ component_name }} v{{ version }} hiện đã được phát hành trên Spwig Marketplace!
...
Thành phần của bạn hiện đã được phát hành và có sẵn cho tất cả các nhà bán hàng Spwig trên thị trường!

Thành phần: {{ component_name }}
Loại: {{ component_type }}
Phiên bản: v{{ version }}

Theo dõi hiệu suất thành phần của bạn trên bảng điều khiển phân tích — các lượt tải xuống, xếp hạng và đánh giá sẽ xuất hiện khi các nhà bán hàng bắt đầu sử dụng nó.

Xem phân tích: {{ dashboard_url }}
