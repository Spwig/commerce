  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          {{ staff_name }} adicionou uma nota ao seu pedido <strong>#{{ order_number }}</strong>:
        </mj-text>
...
{{ staff_name }} adicionou uma nota ao seu pedido #{{ order_number }}:
---
{{ note_content }}
---

{% if order_url %}Ver seu pedido: {{ order_url }}{% endif %}
