...
## Subject
Mise à jour : Retard pour la commande n°{{ order_number }}
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          <strong>Date de livraison initiale :</strong>
        </mj-text>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="15px">
          <strong>Nouvelle date estimée de livraison :</strong>
        </mj-text>
...
Nouvelle date estimée de livraison : {{ new_delivery_date }}
...
Voir le statut de la commande : {{ order_url }}
