...
## Subject
Your subscription plan has been changed to {{ new_plan_name }}
...
| old_plan_name | Previous plan name | Premium Plan |
| new_plan_name | New plan name | Basic Plan |
| downgrade_date | When downgraded | February 15, 2026 |
| effective_date | When changes take effect | March 1, 2026 (end of billing period) |
| plan_changes | Summary of changes | Your download limit will be reduced to 10 per month |
| features_lost | Features no longer available | • Priority support\n• Advanced analytics\n• Custom branding |
| new_price | New plan price | $19.99 |
| billing_period | Billing frequency | month |
| next_billing_date | Next charge date | March 1, 2026 |
| credit_applied | Boolean flag | true |
| credit_amount | Credit amount | $15.00 |
| upgrade_url | Upgrade page | https://shop.com/en/account/subscription/upgrade |
| account_url | Customer account page | https://shop.com/en/account/subscription |

## Notes

- Customer confirmation - plan downgrade
- Sent immediately after downgrade request
- Explains when changes take effect (usually end of billing period)
- Lists features that will be lost
- Proactive credit application if applicable
