...
## Subject
✓ Backup Completed Successfully - {{ shop_name }}
...
| backup_started_at | Start timestamp | 2026-02-15 02:00:00 UTC |
| backup_completed_at | Completion timestamp | 2026-02-15 02:12:30 UTC |
| backup_duration | Duration | 12 minutes 30 seconds |
| backup_size | File size | 2.4 GB |
| backup_location | Storage path | /backups/2026-02-15_full.sql.gz |
| admin_backup_url | Admin backup page | https://shop.com/en/admin/backups/ |
| next_scheduled_backup | Next backup time | 2026-02-16 02:00:00 UTC |

## Notes

- Sent after successful backup completion
- Lower priority than failure alerts
- Can be opt-in for admins (weekly summary alternative)
- Confirms data protection is working
