...
## Subject
कम्पोनेंट स्वीकृत: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          आपका अपलोड प्रकाशित करने के लिए तैयार है
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          अच्छी खबर! आपका कम्पोनेंट अपलोड स्वीकृत कर दिया गया है और Spwig मार्केटप्लेस पर प्रकाशित करने के लिए तैयार है।
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if review_notes %}समीक्षक कमेंट: {{ review_notes }}{% endif %}

अपलोड देखें: {{ submission_url }}
