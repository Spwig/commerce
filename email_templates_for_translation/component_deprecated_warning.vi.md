...
## Subject
⚠️ {{ component_name }} sẽ bị ngừng sử dụng vào {{ deprecation_date }}
...
{{ component_name }} sẽ bị ngừng sử dụng và không còn được khuyến nghị sử dụng nữa. Vui lòng lên kế hoạch di chuyển đến một giải pháp thay thế.
