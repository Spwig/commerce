    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          हेलो {{ customer_name }}, आपके लिए एक बुकिंग के लिए एक स्थान उपलब्ध हो गया है।
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}">
          <strong>उपलब्ध तिथि:</strong> {{ available_date }}
        </mj-text>
        {% endif %}
        {% if resource_name %}
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}">
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          त्वरित कार्रवाई करें! यह स्थान पहले आएगा, पहले सेवा करेगा।
        </mj-text>
      </mj-column>
    </mj-section>
...
{{ product_name }}
{% if available_date %}उपलब्ध तिथि: {{ available_date }}{% endif %}
{% if resource_name %}संसाधन: {{ resource_name }}{% endif %}

त्वरित कार्रवाई करें! यह स्थान पहले आएगा, पहले सेवा करेगा।

{% if book_now_url %}अब बुक करें: {{ book_now_url }}{% endif %}