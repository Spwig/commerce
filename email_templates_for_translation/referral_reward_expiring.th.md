...
## Subject
ข้อความเตือน: รางวัลของคุณ {{ reward_amount }} จะหมดอายุเร็ว ๆ นี้
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          อย่าปล่อยให้รางวัลแนะนำของคุณ {{ reward_amount }} กลายเป็นของเสีย! มันจะหมดอายุใน {{ days_until_expiration }} วัน
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          ใช้มันตอนนี้กับการซื้อครั้งต่อไปของคุณก่อนที่จะสายเกินไป!
        </mj-text>
      </mj-column>
    </mj-section>
