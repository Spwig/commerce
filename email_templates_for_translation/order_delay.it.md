...
## Subject
Aggiornamento: Ritardo per l'ordine #{{ order_number }}
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="28px" font-weight="bold" color="#856404" align="center">
          Notifica di ritardo dell'ordine
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          <strong>Data di consegna originale:</strong>
        </mj-text>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="15px">
          <strong>Nuova data stimata di consegna:</strong>
        </mj-text>
...
Nuova data stimata di consegna: {{ new_delivery_date }}
...
Come scusa...
{{ compensation_details }}
{% if discount_code %}Codice: {{ discount_code }}{% endif %}
{% endif %}

Visualizza lo stato dell'ordine: {{ order_url }}
