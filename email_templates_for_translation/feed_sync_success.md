...
## Subject
✓ {{ feed_name }} synced to {{ platform_name }}
...
| synced_at | Sync completion time | February 15, 2026 at 3:45 PM |
| products_synced | Total products synced | 1,247 |
| sync_duration | How long sync took | 45 seconds |
| products_added | New products | 12 |
| products_updated | Updated products | 35 |
| products_removed | Removed products | 3 |
| sync_warnings | Warning messages | 5 products missing GTIN codes |
| platform_url | External platform link | https://merchants.google.com/... |
| admin_feed_url | Admin feed page | https://shop.com/en/admin/feeds/google |

## Notes

- Admin notification - sync confirmation
- Sent after successful external platform sync
- Shows changes summary (added/updated/removed)
- May include sync warnings
- Links to external platform dashboard
- Transactional email
