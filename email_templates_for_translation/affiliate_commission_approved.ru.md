...
## Subject
Комиссия одобрена: {{ commission_amount }}
  ...
  <mj-body background-color="#f8f9fa">
    ...
    <mj-section background-color="#ffffff" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="#212529">
          Ваша комиссия в размере {{ commission_amount }} с заказа #{{ order_number }} одобрена и будет включена в вашу следующую выплату.
        </mj-text>
        <mj-text font-size="16px" color="#212529">
          Выплаты обрабатываются в соответствии с вашим графиком оплат. Вы получите еще один email, когда выплата будет обработана.
        </mj-text>
      </mj-column>
    </mj-section>
...
Посмотреть вашу комиссию: {{ portal_url }}
