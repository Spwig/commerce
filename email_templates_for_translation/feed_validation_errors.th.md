...
## Subject
⚠️ {{ feed_name }}: พบ {{ error_count }} ข้อผิดพลาดในการตรวจสอบข้อมูล
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="15px" color="{{ theme.color.text|default:'#4b5563' }}">
          พบ {{ error_count }} ข้อผิดพลาดในการตรวจสอบข้อมูลใน {{ feed_name }} ปัญหาเหล่านี้อาจทำให้สินค้าไม่ปรากฏบน {{ platform_name }}
        </mj-text>
        ...
        <mj-section background-color="#fee2e2" border-radius="8px" padding="12px">
          <mj-column>
            ...
            <mj-text font-size="13px" color="#991b1b">
              พบ {{ error.count }} สินค้า{{ error.count|pluralize }}ที่ได้รับผลกระทบ: {{ error.message }}
            </mj-text>
          </mj-column>
        </mj-section>
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          แก้ไขข้อผิดพลาดเหล่านี้เพื่อให้แน่ใจว่าสินค้าทั้งหมดปรากฏบน {{ platform_name }}.
        </mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
