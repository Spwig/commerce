...
## Subject
Nuova ricompensa sbloccata: {{ reward_name }}!
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Buone notizie! Ora hai abbastanza punti per sbloccare {{ reward_name }}.
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Il tuo saldo attuale: {{ current_points }} punti
        </mj-text>
      </mj-column>
    </mj-section>
...
{{ reward_description }}
Costo: {{ points_cost }} punti

Il tuo saldo attuale: {{ current_points }} punti

Sblocca ora: {{ redeem_url }}
