...
## Subject
สินค้า {{ product_name }} กลับมาพร้อมสต็อกอีกครั้ง! - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          สินค้าในรายการต้องการของคุณกลับมาพร้อมสต็อกอีกครั้ง
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>อย่าพลาด!</strong> สินค้าที่นิยมขายเร็ว - รีบจับจองก่อนที่จะหมดอีกครั้ง
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          ต่อเนื่องการเลือกสินค้าใหม่ของเรา
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          คุณได้รับอีเมลนี้เพราะคุณสมัครเพื่อรับการแจ้งเตือนเมื่อสินค้านี้มีพร้อมใช้งานอีกครั้ง
          นี่คือการแจ้งเตือนครั้งเดียวเท่านั้น - คุณจะไม่ได้รับอีเมลเพิ่มเติมเกี่ยวกับสินค้านี้
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
ข่าวดี! สินค้า {{ product_name }} กลับมาพร้อมสต็อกอีกครั้ง!

คุณได้แจ้งให้เราแจ้งเตือนเมื่อสินค้านี้มีพร้อมใช้งานอีกครั้ง และเรายินดีแจ้งให้คุณทราบว่าตอนนี้มีสต็อกแล้ว

รายละเอียดสินค้า:
{{ product_name }}{% if variant_name %}
ตัวเลือก: {{ variant_name }}{% endif %}
...
อย่าพลาด! สินค้าที่นิยมขายเร็ว - รีบจับจองก่อนที่จะหมดอีกครั้ง
