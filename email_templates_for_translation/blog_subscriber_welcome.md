  ...
  <mj-body>
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Thank you for subscribing! We're excited to share our latest content with you.
        </mj-text>
...
| publish_frequency | Update frequency | Weekly |
| popular_posts | Top posts list | [{title, featured_image, reading_time, url}] |
...
- Sets expectations for content frequency
