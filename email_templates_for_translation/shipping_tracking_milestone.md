...
## Subject
Your order #{{ order_number }} is {{ milestone_status }} - {{ shop_name }}
...
| milestone_status | Tracking milestone | Out for Delivery |
| milestone_description | Status explanation | Your package is on the delivery vehicle and will arrive today |
| tracking_number | Carrier tracking # | 1Z999AA10123456784 |
| carrier_name | Shipping carrier | UPS |
| current_location | Package location | Local Distribution Center, New York, NY |
| estimated_delivery | ETA | Today by 8:00 PM |
...
- Transactional email for major tracking milestones
- Common milestones: "Arrived at Facility", "In Transit", "Out for Delivery", "Delivery Attempted"
- Triggered by shipping provider webhooks
- Keeps customers informed proactively
