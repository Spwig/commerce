...
## Subject
✓ {{ addon_name }} telah ditambahkan ke langganan Anda
        ...
        <mj-section background-color="#eff6ff" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#1e40af" line-height="1.6">
              💡 Anda dikenakan biaya {{ prorated_charge }} hari ini untuk sisa masa pembayaran saat ini Anda.
            </mj-text>
          </mj-column>
        </mj-section>
        {% endif %}
...
{{ addon_name }} telah ditambahkan ke langganan {{ plan_name }} Anda dan sekarang aktif!
