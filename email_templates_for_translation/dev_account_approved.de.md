...
## Subject
Willkommen im Spwig Developer Program, {{ developer_name }}!
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          Ihre Anwendung als Entwickler wurde genehmigt
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Herzlichen Glückwunsch! Ihre Anwendung als Entwickler wurde genehmigt. Sie haben nun vollen Zugriff auf das Spwig Developer Portal.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px 20px 0">
      <mj-column>
        <mj-text font-size="18px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" padding-bottom="10px">
          Ihre kostenlose Entwicklerlizenz wartet auf Sie
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Als genehmigter Entwickler erhalten Sie eine <strong>kostenlose Spwig Shop + POS-Installation</strong> mit dauerhaften Updates. Beantragen Sie Ihre Lizenz, installieren Sie Spwig auf Ihrem Server und beginnen Sie sofort mit der Entwicklung von Komponenten.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-bottom="10px">
          <strong>1.</strong> Lizenz beantragen
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-bottom="10px">
          <strong>2.</strong> Spwig auf Ihrem Server installieren
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-bottom="10px">
          <strong>3.</strong> Erstellen Sie Ihre erste Komponente mit unseren SDKs
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          <strong>4.</strong> Übermitteln Sie sie über Ihr Dashboard
        </mj-text>
      </mj-column>
    </mj-section>
...
Ihre kostenlose Entwicklerlizenz wartet auf Sie
Als genehmigter Entwickler erhalten Sie eine kostenlose Spwig Shop + POS-Installation mit dauerhaften Updates. Beantragen Sie Ihre Lizenz, installieren Sie Spwig auf Ihrem Server und beginnen Sie sofort mit der Entwicklung von Komponenten.

Lizenz beantragen: {{ license_url }}

Loslegen:
1. Lizenz beantragen: {{ license_url }}
2. Spwig auf Ihrem Server installieren
3. Erstellen Sie Ihre erste Komponente mit unseren SDKs
4. Übermitteln Sie sie über Ihr Dashboard
