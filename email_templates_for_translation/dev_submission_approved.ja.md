...
## Subject
コンポーネントが承認されました: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          グッドニュース！あなたのコンポーネントの提出は承認され、Spwig Marketplaceへの公開準備ができています。
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if review_notes %}レビューのコメント: {{ review_notes }}{% endif %}

提出内容を確認する: {{ submission_url }}
