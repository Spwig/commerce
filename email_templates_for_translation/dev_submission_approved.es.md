...
## Subject
Componente aprobado: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          Su envío está listo para su publicación
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          ¡Buena noticia! Su componente ha sido aprobado y está listo para su publicación en el Spwig Marketplace.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="12px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          ¿Tiene preguntas? Póngase en contacto con el soporte de desarrolladores
        </mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
...
{% if review_notes %}Notas del revisor: {{ review_notes }}{% endif %}

Ver envío: {{ submission_url }}
