...
## Subject
अपडेट: आदेश #{{ order_number }} के लिए देरी
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          <strong>मूल डिलीवरी तिथि:</strong>
        </mj-text>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="15px">
          <strong>नई अनुमानित डिलीवरी:</strong>
        </mj-text>
...
मूल डिलीवरी तिथि: {{ original_delivery_date }}
नई अनुमानित डिलीवरी: {{ new_delivery_date }}
...
एक अपोलोजी के रूप में...
{{ compensation_details }}
{% if discount_code %}कोड: {{ discount_code }}{% endif %}
{% endif %}

आदेश स्थिति देखें: {{ order_url }}
