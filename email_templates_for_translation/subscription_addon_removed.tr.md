...
## Subject
{{ addon_name }} abonelikten kaldırıldı
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-section background-color="#f0fdf4" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#065f46" line-height="1.6">
              💰 {{ credit_amount }} tutarında bir krediniz, bu ek add-on'un kullanılmayan kısmına uygulandı.
            </mj-text>
          </mj-column>
        </mj-section>
        {% endif %}
        ...
        <mj-text font-size="15px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          Herhangi bir zamanda {{ addon_name }}'ı aboneliklerinize geri ekleyebilirsiniz.
        </mj-text>
