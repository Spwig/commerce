...
## Subject
Обновление: Задержка по заказу #{{ order_number }}
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          <strong>Оригинальная дата доставки:</strong>
        </mj-text>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="15px">
          <strong>Новая ожидаемая дата доставки:</strong>
        </mj-text>
...
Оригинальная дата доставки: {{ original_delivery_date }}
Новая ожидаемая дата доставки: {{ new_delivery_date }}
...
В качестве извинения...
{{ compensation_details }}
{% if discount_code %}Код: {{ discount_code }}{% endif %}
{% endif %}

Просмотр статуса заказа: {{ order_url }}
