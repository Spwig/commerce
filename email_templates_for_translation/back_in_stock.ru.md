...
## Subject
{{ product_name }} снова в наличии! - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Товар из вашего списка желаний снова в наличии
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Не упустите!</strong> Популярные товары раскупают быстро — закажите свой до того, как он снова исчезнет.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Продолжайте просматривать наши последние товары
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          ...
          Это одноразовое уведомление — вы больше не получите писем об этом товаре.
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Великолепные новости! {{ product_name }} снова в наличии!

Вы подписались на уведомление о наличии этого товара, и мы рады сообщить, что он теперь в наличии.

ДЕТАЛИ ТОВАРА:
{{ product_name }}{% if variant_name %}
Вариант: {{ variant_name }}{% endif %}
...
Не упустите! Популярные товары раскупают быстро — закажите свой до того, как он снова исчезнет.
