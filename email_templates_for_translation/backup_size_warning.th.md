...
## Subject
⚠️ การเตือนขนาดสำรองข้อมูล - {{ shop_name }}
  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          สำรองข้อมูลล่าสุดของคุณสำหรับ {{ shop_name }} ได้เกินเกณฑ์ขนาดที่แนะนำแล้ว นี่อาจบ่งบอกถึงความต้องการเก็บข้อมูลที่เพิ่มขึ้น
        </mj-text>
