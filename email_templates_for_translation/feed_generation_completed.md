...
## Subject
✓ Product feed generated: {{ feed_name }}
...
| feed_format | Feed file format | XML (Google Merchant) |
| product_count | Number of products | 1,247 |
| generated_at | Generation timestamp | February 15, 2026 at 3:45 PM |
| file_size | Feed file size | 2.4 MB |
| warnings_count | Number of warnings | 12 |
| feed_url | Public feed URL | https://shop.com/feeds/google-shopping.xml |
| download_url | Direct download link | https://shop.com/en/admin/feeds/google/download |
| admin_feed_url | Admin feed page | https://shop.com/en/admin/feeds/google |

## Notes

- Admin notification - sent to feed administrators
- Confirmation of successful feed generation
- Includes product count and warnings
- Provides feed URL for external platforms
- Transactional email
