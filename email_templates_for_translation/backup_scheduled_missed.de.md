...
## Subject
⚠️ Geplanter Backup wurde nicht ausgeführt - {{ shop_name }}
  ...
  <mj-body>
    <mj-section background-color="#fef3c7">
      <mj-column>
        <mj-text font-size="20px" font-weight="bold" color="#92400e" align="center">
          ⚠️ Geplanter Backup wurde verpasst
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Ein geplanter Backup für {{ shop_name }} wurde nicht wie erwartet ausgeführt. Ihre Daten können nicht vollständig geschützt sein.
        </mj-text>
        ...
        <mj-text color="{{ theme.color.text|default:'#4b5563' }}">
          • Server war offline oder nicht erreichbar<br/>
          • Geplanter Aufgaben-Dienst nicht aktiv<br/>
          • Unzureichende Berechtigungen<br/>
          • Speicherplatz voll<br/>
...
POSSIBLE CAUSES:
• Server war offline oder nicht erreichbar
• Geplanter Aufgaben-Dienst nicht aktiv
