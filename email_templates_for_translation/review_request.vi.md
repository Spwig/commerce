...
## Subject
Bạn đã hài lòng với đơn hàng của mình chưa? Đánh giá ngay!
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="10px" line-height="1.8">
          Chúng tôi hy vọng bạn đang hài lòng với đơn hàng gần đây của mình! Phản hồi của bạn giúp chúng tôi cải thiện và hỗ trợ các khách hàng khác đưa ra quyết định sáng suốt.
        </mj-text>
      </mj-column>
    </mj-section>
...
- {{ item.name }} (Số lượng: {{ item.quantity }})
  Viết đánh giá: {{ item.review_url }}
{% endfor %}

{% if incentive_offered %}
🎁 Phần thưởng đặc biệt
{{ incentive_details }}
{% if incentive_code %}Mã: {{ incentive_code }}{% endif %}
{% endif %}
