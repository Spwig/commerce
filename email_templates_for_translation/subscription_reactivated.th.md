...
## Subject
ยินดีต้อนรับกลับ! การสมัครสมาชิก {{ plan_name }} ของคุณได้ถูกเปิดใช้งานอีกครั้ง - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          การสมัครสมาชิกของคุณได้ถูกเปิดใช้งานอีกครั้ง
        </mj-text>
      </mj-column>
    </mj-section>
        ...
        <mj-wrapper background-color="#f0fdf4" padding="30px" border="2px solid {{ theme.color.success|default:'#10b981' }}" border-radius="12px">
          <mj-section background-color="transparent">
            <mj-column>
              ...
              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>เปิดใช้งานอีกครั้งเมื่อ:</strong> {{ reactivation_date|date:"F d, Y" }}
              </mj-text>

              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>รอบการเรียกเก็บเงินถัดไป:</strong> {{ new_billing_date|date:"F d, Y" }}
              </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="8px 20px" line-height="1.6">
          ...
          การสมัครสมาชิกของคุณได้ถูกเปิดใช้งานแล้ว
        </mj-text>

        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="8px 20px" line-height="1.6">
          <span style="color: {{ theme.color.success|default:'#10b981' }}; font-size: 18px; margin-right: 8px;">&#10003;</span>
          การเข้าถึงสิทธิประโยชน์ทั้งหมดของคุณได้ถูกฟื้นฟูแล้ว
        </mj-text>

        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="8px 20px" line-height="1.6">
          <span style="color: {{ theme.color.success|default:'#10b981' }}; font-size: 18px; margin-right: 8px;">&#10003;</span>
          การเรียกเก็บเงินครั้งแรกของคุณจะเกิดขึ้นในวันที่ {{ new_billing_date|date:"F d, Y" }}
        </mj-text>
      </mj-column>
    </mj-section>
...
รายละเอียดการสมัครสมาชิก:
แผน: {{ plan_name }}
เปิดใช้งานอีกครั้งเมื่อ: {{ reactivation_date|date:"F d, Y" }}
รอบการเรียกเก็บเงินถัดไป: {{ new_billing_date|date:"F d, Y" }}
