...
## Subject
✓ {{ product_name }} ถูกเพิ่มเข้าไปในรายการสิ่งที่คุณชอบ - {{ shop_name }}
    ...
    <mj-section>
      <mj-column>
        <mj-text font-size="20px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}">
          ❤️ ถูกเพิ่มเข้าไปในรายการสิ่งที่คุณชอบ!
        </mj-text>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          คุณได้เพิ่ม {{ product_name }} เข้าไปในรายการสิ่งที่คุณชอบอย่างสำเร็จ เราจะติดตามมันให้คุณ!
        </mj-text>
