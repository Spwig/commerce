    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Ein Artikel auf Ihrer Wunschliste ist wieder auf Lager
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>Verpassen Sie nicht!</strong> Beliebte Artikel verkaufen sich schnell - sichern Sie sich Ihren noch bevor es wieder ausverkauft ist.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          Sie haben diese E-Mail erhalten, weil Sie sich angemeldet haben, um benachrichtigt zu werden, wenn dieses Produkt wieder verfügbar ist.
          Dies ist eine Einmalbenachrichtigung - Sie erhalten keine weiteren E-Mails zu diesem Produkt.
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Große Nachricht! {{ product_name }} ist wieder auf Lager!

Sie haben uns gebeten, Sie zu benachrichtigen, wenn dieser Artikel wieder verfügbar wird, und wir freuen uns, Ihnen mitzuteilen, dass er jetzt wieder auf Lager ist.
...
Verpassen Sie nicht! Beliebte Artikel verkaufen sich schnell - sichern Sie sich Ihren noch bevor es wieder ausverkauft ist.
