...
## Subject
Ihr Spwig-Entwicklerkonto wurde gesperrt
...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Ihr Spwig-Entwicklerkonto wurde gesperrt. Während dieser Zeit bleiben Ihre veröffentlichten Komponenten weiterhin verfügbar, Sie können jedoch keine neuen Komponenten oder Updates einreichen.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Wenn Sie glauben, dass diese Sperrung aus einem Fehler resultiert, kontaktieren Sie uns bitte unter <a href="mailto:{{ support_email }}" style="color: {{ theme.color.primary|default:'#2563eb' }}; text-decoration: none;">{{ support_email }}</a>.
        </mj-text>
      </mj-column>
    </mj-section>
...
Wenn Sie glauben, dass diese Sperrung aus einem Fehler resultiert, kontaktieren Sie uns bitte unter {{ support_email }}.
