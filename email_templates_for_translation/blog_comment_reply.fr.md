...
## Subject
💬 {{ replier_name }} a répondu à votre commentaire sur "{{ post_title }}"
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          Ne souhaitez-vous plus recevoir des notifications de réponses ? <a href="{{ unsubscribe_url }}">Se désinscrire</a>
        </mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
...
Voir & répondre: {{ reply_url }}

Ne souhaitez-vous plus recevoir des notifications de réponses ? Se désinscrire: {{ unsubscribe_url }}
