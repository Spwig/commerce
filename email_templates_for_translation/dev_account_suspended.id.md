...
## Subject
Akun Pengembang Spwig Anda Telah Diblokir
...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.warning|default:'#f59e0b' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          Pembaruan penting mengenai akun pengembang Anda
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Akun pengembang Spwig Anda telah diblokir. Selama periode ini, komponen yang telah Anda publikasikan tetap tersedia, tetapi Anda tidak dapat mengirimkan komponen baru atau pembaruan.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Jika Anda percaya ini adalah kesalahan, silakan hubungi kami di <a href="mailto:{{ support_email }}" style="color: {{ theme.color.primary|default:'#2563eb' }}; text-decoration: none;">{{ support_email }}</a>.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if suspension_reason %}Alasan: {{ suspension_reason }}{% endif %}

Jika Anda percaya ini adalah kesalahan, silakan hubungi kami di {{ support_email }}.
