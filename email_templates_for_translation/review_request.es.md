...
## Subject
¿Cómo fue tu compra? Deja una reseña
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="10px" line-height="1.8">
          Esperamos que estés disfrutando de tu reciente compra. Tu opinión nos ayuda a mejorar y a otros clientes tomar decisiones informadas.
        </mj-text>
      </mj-column>
    </mj-section>
...
- {{ item.name }} (Cantidad: {{ item.quantity }})
  Escribir reseña: {{ item.review_url }}
{% endfor %}
