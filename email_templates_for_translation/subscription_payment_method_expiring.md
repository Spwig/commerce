...
## Subject
💳 Update Required: Payment Method Expiring Soon - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Action required to avoid subscription interruption
        </mj-text>
      </mj-column>
    </mj-section>
          ...
          <mj-section background-color="transparent">
            <mj-column>
              ...
              <mj-text font-size="13px" color="{{ theme.color.error|default:'#ef4444' }}" padding="5px 0" font-weight="600">
                ⚠️ Please update your payment method before {{ expiration_date|date:"m/Y" }} to avoid service interruption.
              </mj-text>
            </mj-column>
          </mj-section>
        </mj-wrapper>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="8px 20px" line-height="1.6">
          ...
          Add a new payment method or update your existing card
        </mj-text>

        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="8px 20px" line-height="1.6">
          <span style="color: {{ theme.color.warning|default:'#f59e0b' }}; font-size: 18px; margin-right: 8px;">2.</span>
          Make sure to update before your next billing date
        </mj-text>
...
Next Billing: {{ next_billing_date|date:"F d, Y" }}

⚠️ Please update your payment method before {{ expiration_date|date:"m/Y" }} to avoid service interruption.

What You Need to Do:
1. Add a new payment method or update your existing card
2. Make sure to update before your next billing date
3. Your subscription will continue uninterrupted
