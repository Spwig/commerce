...
## Subject
Bir {{ reward_amount }} ödülleri kazandınız!
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          {{ referee_name }}'yi referans verdiğiniz için teşekkür ederiz
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Tebrik ederiz! {{ referee_name }} sizi referans vererek ilk alışverişini yaptı ve siz de bir {{ reward_amount }} ödül kazandınız!
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Referans linkinizi paylaşmaya devam edin ve daha fazla ödül kazanın. Referans verdiğiniz arkadaş sayısı arttıkça kazandığınız ödül de artar!
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="18px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center" padding-bottom="20px">
          Referans Verme İstatistikleriniz
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="18px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center" padding-bottom="15px">
          Paylaşmaya Devam Edin, Daha Fazla Kazanın!
        </mj-text>
        <mj-text
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Arkadaşlarınızla bu bağlantıyı paylaşarak daha fazla ödül kazanın
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
Bir {{ reward_amount }} ödül kazandınız!
...
Referans Verme İstatistikleriniz:
- Başarılı Referanslar: {{ total_referrals }}
- Toplam Kazanılan Ödüller: {{ total_rewards_earned }}

Referans linkinizi paylaşmaya devam edin ve daha fazla ödül kazanın:
{{ referral_link }}
