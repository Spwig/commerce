...
## Subject
{{ component_name }} v{{ version }} अब Spwig मार्केटप्लेस पर लाइव है!
...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="50px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="15px">
          Your component is on the Spwig Marketplace
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Your component is now live and available to all Spwig merchants on the marketplace!
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="25px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Track your component's performance on the analytics dashboard — downloads, ratings, and reviews will appear as merchants start using it.
        </mj-text>
      </mj-column>
    </mj-section>
...
आपका कॉम्पोनेंट अब लाइव है और सभी Spwig व्यापारियों के लिए मार्केटप्लेस पर उपलब्ध है!

कॉम्पोनेंट: {{ component_name }}
प्रकार: {{ component_type }}
संस्करण: v{{ version }}

आपके कॉम्पोनेंट के प्रदर्शन को एनालिटिक्स डैशबोर्ड पर ट्रैक करें — डाउनलोड, रेटिंग और समीक्षाएं व्यापारियों द्वारा इसके उपयोग शुरू करते समय दिखाई देंगी।

एनालिटिक्स देखें: {{ dashboard_url }}
