...
## Subject
💳 Ödeme Yöntemi Güncellemesi Gerekiyor: Yakında Süresi Biten - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        <mj-text font-size="32px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          💳 Ödeme Yöntemi Süresi Bitiyor
        </mj-text>
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Abonelik kesilmemesi için eylem gerekli
        </mj-text>
      </mj-column>
    </mj-section>
          ...
          <mj-section background-color="transparent">
            <mj-column>
              <mj-text font-size="20px" font-weight="600" color="#9a3412" align="center" padding-bottom="15px">
                Süresi Biten Ödeme Yöntemi
              </mj-text>

              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>Abonelik:</strong> {{ plan_name }}
              </mj-text>
              ...
              <mj-text font-size="14px" color="{{ theme.color.warning|default:'#f59e0b' }}" padding="5px 0">
                <strong>Süresi Bitiyor:</strong> {{ expiration_date|date:"m/Y" }}
              </mj-text>

              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>Bir Sonraki Fatura Tarihi:</strong> {{ next_billing_date|date:"F d, Y" }}
              </mj-text>
              ...
              <mj-text font-size="13px" color="{{ theme.color.error|default:'#ef4444' }}" padding="5px 0" font-weight="600">
                ⚠️ {{ expiration_date|date:"m/Y" }} tarihinden önce ödeme yönteminizi güncellemeyi unutmayın, aksi takdirde hizmet kesilir.
              </mj-text>
            </mj-column>
          </mj-section>
        </mj-wrapper>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="12px" color="#9ca3af" align="center">
          Yardma mı gerek? Bize {{ support_email }} adresinden ulaşın
        </mj-text>
      </mj-column>
    </mj-section>
...
SÜRESİ BİTEN ÖDEME YÖNTEMİ:
Abonelik: {{ plan_name }}
Ödeme Yöntemi: {{ payment_method }}
Süresi Bitiyor: {{ expiration_date|date:"m/Y" }}
Bir Sonraki Fatura: {{ next_billing_date|date:"F d, Y" }}

⚠️ {{ expiration_date|date:"m/Y" }} tarihinden önce ödeme yönteminizi güncellemeyi unutmayın, aksi takdirde hizmet kesilir.

Yapmanız Gerekenler:
1. Yeni bir ödeme yöntemi ekleyin veya mevcut kartınızı güncelleyin
2. Bir sonraki fatura tarihinizden önce güncellemeyi unutmayın
3. Abonelik kesilmeden devam edecektir
