  ...
  <mj-body>
    <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}">
      <mj-column>
        <mj-text font-size="20px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}">
          Un messaggio riguardo alla tua ordinazione
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          {{ staff_name }} ha aggiunto una nota alla tua ordinazione <strong>#{{ order_number }}</strong>:
        </mj-text>
...
{{ staff_name }} ha aggiunto una nota alla tua ordinazione #{{ order_number }}:
---
{{ note_content }}
---

{% if order_url %}Visualizza la tua ordinazione: {{ order_url }}{% endif %}
