...
| location | Physical location | Main Store - Front Counter |
| last_seen | Last heartbeat timestamp | February 15, 2026 at 3:45 PM |
| offline_since | When went offline | February 15, 2026 at 3:46 PM |
| offline_duration | How long offline | 15 minutes |
| active_shift | Boolean flag | true |
| admin_terminals_url | Terminals management page | https://shop.com/en/admin/pos/terminals |

## Notes

- CRITICAL admin/manager notification
- Sent when terminal heartbeat timeout detected
- May indicate operational disruption
- Includes troubleshooting steps
- Warns if shift is active (data sync risk)
- Transactional email
