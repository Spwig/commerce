...
## Subject
Confirmation de commande n°{{ order_number }} - Merci !
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          <strong>Estimate de livraison :</strong> {{ estimated_delivery_start }} - {{ estimated_delivery_end }}
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px 20px 10px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="5px">
          Suivez vos commandes, faites vos achats plus rapidement la prochaine fois et gérez vos préférences.
        </mj-text>
      </mj-column>
    </mj-section>
...
Estimate de livraison : {{ estimated_delivery_start }} - {{ estimated_delivery_end }}
