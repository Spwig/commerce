...
## Subject
Post Baru: {{ post_title }} - Blog {{ shop_name }}
  ...
  <mj-body>
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Kita baru saja menerbitkan sebuah postingan baru yang kami pikir Anda akan sukai!
        </mj-text>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_secondary|default:'#6b7280' }}">
          Oleh {{ author_name }} | {{ publish_date }} | {{ reading_time }} menit dibaca
        </mj-text>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="4px" padding="12px">
          <mj-column>
            ...
            <mj-text font-size="14px">
              <a href="{{ post.url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">Baca lebih lanjut →</a>
            </mj-text>
          </mj-column>
        </mj-section>
        {% endfor %}
        ...
        <mj-text font-size="13px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          Anda menerima email ini karena Anda berlangganan {{ blog_name }}.<br/>
          <a href="{{ unsubscribe_url }}">Batalkan langganan pembaruan blog</a>
        </mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
...
Anda menerima email ini karena Anda berlangganan {{ blog_name }}.
Batalkan langganan pembaruan blog: {{ unsubscribe_url }}