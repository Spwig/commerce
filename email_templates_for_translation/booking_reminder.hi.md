...
## Subject
स्मरण चिन्ह: {{ product_name }} - {{ booking_date }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          हेलो {{ customer_name }}, यह आपकी आगामी बुकिंग के बारे में एक स्मरण चिन्ह है।
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="10px 20px">
      <mj-column>
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          कोई बदलाव करना है? अपने खाते से आप अपनी बुकिंग को <a href="{{ reschedule_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">बुकिंग फिर से तय करें</a> या <a href="{{ cancel_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">रद्द करें</a>।
        </mj-text>
      </mj-column>
    </mj-section>
...
कोई बदलाव करना है? अपने खाते में जाएं और बुकिंग को फिर से तय करें या रद्द करें।
{{ reschedule_url }}
{{ cancel_url }}