...
## Subject
✓ {{ addon_name }} a été ajouté à votre abonnement
  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          {{ addon_name }} a été ajouté à votre abonnement {{ plan_name }} et est maintenant actif !
        </mj-text>
        ...
        <mj-section background-color="#eff6ff" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="#1e40af" line-height="1.6">
              💡 Vous avez été facturé {{ prorated_charge }} aujourd'hui pour le reste de votre période de facturation actuelle.
            </mj-text>
          </mj-column>
        </mj-section>
        {% endif %}
