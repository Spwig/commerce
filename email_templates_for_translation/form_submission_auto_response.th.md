    ...
    <mj-section>
      <mj-column>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="15px">
          <mj-column>
            <mj-text font-size="14px" color="{{ theme.color.text|default:'#4b5563' }}">
              <strong>อ้างอิงการส่งของคุณ:</strong> {{ submission_id }}
            </mj-text>
          </mj-column>
        </mj-section>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          ต้องการความช่วยเหลือทันที? <a href="{{ support_url }}">ติดต่อฝ่ายสนับสนุน</a>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
อ้างอิงการส่งของคุณ: {{ submission_id }}

{% if support_url %}ต้องการความช่วยเหลือทันที? ติดต่อฝ่ายสนับสนุน: {{ support_url }}{% endif %}