...
## Subject
स्मरण: {{ expiring_points }} अंक जल्दी खत्म हो जाएंगे
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="#856404" align="center">
          points expire in {{ days_until_expiration }} days
        </mj-text>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Don't let your points go to waste! You have {{ expiring_points }} points that will expire soon.
        </mj-text>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Redeem them now to get exclusive rewards before they're gone.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}">
          Browse our rewards catalog and redeem your points before they expire.
        </mj-text>
      </mj-column>
    </mj-section>
...
Don't let your points go to waste! You have {{ expiring_points }} points that will expire in {{ days_until_expiration }} days.

Expiration date: {{ expiration_date }}

Redeem them now to get exclusive rewards before they're gone.

Redeem points: {{ rewards_url }}
