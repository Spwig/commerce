...
## Subject
Verpasste Buchung - {{ product_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Hallo {{ customer_name }}, es sieht so aus, als hätten Sie Ihre Buchung verpasst.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="10px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Möchten Sie umbuchten? Besuchen Sie unsere Website, um einen neuen Termin zu buchen, der für Sie passt.
        </mj-text>
      </mj-column>
    </mj-section>
