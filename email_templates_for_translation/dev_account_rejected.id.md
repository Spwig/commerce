...
## Subject
Pembaruan Aplikasi Pengembang Spwig Anda
...
<mjml>
  ...
  <mj-body background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}">
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Terima kasih atas minat Anda terhadap Program Pengembang Spwig. Setelah tinjauan yang cermat, kami saat ini tidak dapat menyetujui aplikasi Anda.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}">
          Jika Anda memiliki pertanyaan atau percaya bahwa ini adalah kesalahan, silakan hubungi kami di <a href="mailto:{{ support_email }}" style="color: {{ theme.color.primary|default:'#2563eb' }}; text-decoration: none;">{{ support_email }}</a>.
        </mj-text>
      </mj-column>
    </mj-section>
...
Jika Anda memiliki pertanyaan atau percaya bahwa ini adalah kesalahan, silakan hubungi kami di {{ support_email }}.
