...
## Subject
{{ product_name }} が再入荷しました！ - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.warning_light|default:'#fef3c7' }}" padding="15px 20px">
      <mj-column>
        <mj-text font-size="14px" color="#92400e" align="center">
          <strong>見逃さないで！</strong> 人気商品は売れ行きが早いです - 再び在庫切れになる前に今すぐ確保してください。
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background_secondaryondary|default:'#f9fafb' }}" padding="20px">
      <mj-column>
        <mj-text font-size="11px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" line-height="1.5">
          このメールを受け取ったのは、この商品が再入荷したときに通知されるよう登録したためです。
          これは一回限りの通知です - この商品に関するメールは今後受け取ることはありません。
        </mj-text>
      </mj-column>
    </mj-section>
...
## Text Content
良いニュースです！ {{ product_name }} が再入荷しました！

この商品が再入荷したときに通知してほしいとご希望いただいたため、お知らせいたします。商品は現在在庫があります。

商品の詳細:
{{ product_name }}{% if variant_name %}
バリアント: {{ variant_name }}{% endif %}
...
見逃さないで！人気商品は売れ行きが早いです - 再び在庫切れになる前に今すぐ確保してください。
