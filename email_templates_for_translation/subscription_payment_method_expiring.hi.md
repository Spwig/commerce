...
## Subject
💳 अद्यतन आवश्यक: भुगतान विधि जल्दी ही समाप्त हो जाएगी - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        <mj-text font-size="32px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          💳 भुगतान विधि समाप्त हो रही है
        </mj-text>
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          सद्गति के बाधित होने से बचने के लिए कार्रवाई आवश्यक है
        </mj-text>
      </mj-column>
    </mj-section>
          ...
          <mj-section background-color="transparent">
            <mj-column>
              <mj-text font-size="20px" font-weight="600" color="#9a3412" align="center" padding-bottom="15px">
                समाप्त होने वाली भुगतान विधि
              </mj-text>

              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>सद्गति:</strong> {{ plan_name }}
              </mj-text>
              ...
              <mj-text font-size="14px" color="{{ theme.color.warning|default:'#f59e0b' }}" padding="5px 0">
                <strong>समाप्त होता है:</strong> {{ expiration_date|date:"m/Y" }}
              </mj-text>

              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>अगला भुगतान:</strong> {{ next_billing_date|date:"F d, Y" }}
              </mj-text>
              ...
              <mj-text font-size="13px" color="{{ theme.color.error|default:'#ef4444' }}" padding="5px 0" font-weight="600">
                ⚠️ {{ expiration_date|date:"m/Y" }} तक अपनी भुगतान विधि को अपडेट करें ताकि सेवा के बाधित होने से बचा जा सके।
              </mj-text>
            </mj-column>
          </mj-section>
        </mj-wrapper>
...
समाप्त होता है: {{ expiration_date|date:"m/Y" }}
अगला भुगतान: {{ next_billing_date|date:"F d, Y" }}

⚠️ {{ expiration_date|date:"m/Y" }} तक अपनी भुगतान विधि को अपडेट करें ताकि सेवा के बाधित होने से बचा जा सके।

आपको क्या करना है:
1. एक नई भुगतान विधि जोड़ें या अपने मौजूदा कार्ड को अपडेट करें
2. अपने अगले भुगतान तिथि से पहले अपडेट करना सुनिश्चित करें
3. आपकी सद्गति अविच्छिन्न रहेगी

भुगतान विधि को अपडेट करें: {{ update_payment_url }}
सद्गति का प्रबंधन करें: {{ manage_subscription_url }}
