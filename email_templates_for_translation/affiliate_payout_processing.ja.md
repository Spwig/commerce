  ...
  <mj-body background-color="#f8f9fa">
    ...
    <mj-section background-color="#ffffff" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="#212529">
          よろしいニュースです！{{ payout_amount }}の出金が今処理されています。
        </mj-text>
        <mj-text font-size="16px" color="#212529">
          お支払いは3〜5営業日以内に口座に反映される予定です。出金が完了した際に、もう1度メールをお送りします。
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#f8f9fa" padding="30px 20px">
      <mj-column>
        <mj-text font-size="16px" color="#212529">
          <strong>出金ID:</strong> {{ payout_id }}<br/>
          <strong>金額:</strong> {{ payout_amount }}<br/>
          <strong>支払い方法:</strong> {{ payout_method }}
        </mj-text>
      </mj-column>
    </mj-section>
