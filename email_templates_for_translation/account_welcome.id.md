    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Kami sangat senang memiliki Anda sebagai bagian dari komunitas kami
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.info_light|default:'#dbeafe' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Akun Anda telah berhasil dibuat. Anda siap untuk mulai berbelanja!
        </mj-text>
      </mj-column>
    </mj-section>
...
Mulai berbelanja: {{ browse_products_url }}
Kelola akun Anda: {{ account_url }}
