...
## Subject
💳 ต้องอัปเดต: วิธีการชำระเงินใกล้หมดอายุ - {{ shop_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="40px 20px">
      <mj-column>
        <mj-text font-size="32px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}" align="center">
          💳 วิธีการชำระเงินใกล้หมดอายุ
        </mj-text>
        <mj-text font-size="18px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          ต้องดำเนินการเพื่อหลีกเลี่ยงการหยุดการสมัครสมาชิก
        </mj-text>
      </mj-column>
    </mj-section>
          ...
          <mj-section background-color="transparent">
            <mj-column>
              ...
              <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding="5px 0">
                <strong>การสมัครสมาชิก:</strong> {{ plan_name }}
              </mj-text>
              ...
              <mj-text font-size="14px" color="{{ theme.color.warning|default:'#f59e0b' }}" padding="5px 0">
                <strong>หมดอายุ:</strong> {{ expiration_date|date:"m/Y" }}
              </mj-text>
              ...
              <mj-text font-size="13px" color="{{ theme.color.error|default:'#ef4444' }}" padding="5px 0" font-weight="600">
                ⚠️ กรุณาอัปเดตวิธีการชำระเงินของคุณก่อนวันที่ {{ expiration_date|date:"m/Y" }} เพื่อหลีกเลี่ยงการหยุดบริการ
              </mj-text>
            </mj-column>
          </mj-section>
        </mj-wrapper>
...
หมดอายุ: {{ expiration_date|date:"m/Y" }}
รอบการเรียกเก็บเงินถัดไป: {{ next_billing_date|date:"F d, Y" }}

⚠️ กรุณาอัปเดตวิธีการชำระเงินของคุณก่อนวันที่ {{ expiration_date|date:"m/Y" }} เพื่อหลีกเลี่ยงการหยุดบริการ

สิ่งที่คุณต้องทำ:
1. เพิ่มวิธีการชำระเงินใหม่หรืออัปเดตบัตรที่มีอยู่
2. ตรวจสอบให้แน่ใจว่าได้อัปเดตก่อนวันเรียกเก็บเงินครั้งถัดไปของคุณ
3. การสมัครสมาชิกของคุณจะดำเนินต่อไปโดยไม่มีการขัดข้อง
