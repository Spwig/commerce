...
## Subject
Rappel : {{ product_name }} - {{ booking_date }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Bonjour {{ customer_name }}, ceci est un rappel concernant votre prochaine réservation.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="10px 20px">
      <mj-column>
        <mj-text font-size="13px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Besoin de faire des modifications ? Vous pouvez <a href="{{ reschedule_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">réajuster</a> ou <a href="{{ cancel_url }}" style="color: {{ theme.color.primary|default:'#2563eb' }};">annuler</a> votre réservation depuis votre compte.
        </mj-text>
      </mj-column>
    </mj-section>
...
Besoin de faire des modifications ? Visitez votre compte pour réajuster ou annuler.
{{ reschedule_url }}
{{ cancel_url }}