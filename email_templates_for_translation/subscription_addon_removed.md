...
## Subject
{{ addon_name }} has been removed from your subscription
...
| removed_date | When addon removed | February 15, 2026 |
| effective_date | When removal takes effect | March 1, 2026 (end of billing period) |
| access_until | When access ends | March 1, 2026 |
| old_total | Previous total price | $59.98 |
| addon_price | Add-on price | $9.99 |
| new_total | New total price | $49.99 |
| billing_period | Billing frequency | month |
| credit_applied | Boolean flag | true |
| credit_amount | Credit amount | $3.00 |
| data_retention_info | Data/access warning | Your extra storage data will be deleted after March 1. Download your files before then. |
| addons_url | Add-ons browse page | https://shop.com/en/account/subscription/addons |
| account_url | Customer account page | https://shop.com/en/account/subscription |

## Notes

- Customer confirmation - addon removal
- Sent immediately after removal request
- Explains when removal takes effect (usually end of billing period)
- Shows new reduced total cost
- Warns about data retention/deletion if applicable
- Offers easy re-purchase path
