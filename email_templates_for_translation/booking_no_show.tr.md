...
## Subject
Rezervasyonu Kaçırdınız - {{ product_name }}
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center" padding-top="10px">
          Merhaba {{ customer_name }}, rezervasyonunuzu kaçırdığınız gibi görünüyor.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="10px 20px">
      <mj-column>
        <mj-text font-size="14px" color="{{ theme.color.text_muted|default:'#6b7280' }}" align="center">
          Yeniden planlamak ister misiniz? Web sitemizi ziyaret ederek size uygun bir zaman diliminde yeni bir randevu alabilirsiniz.
        </mj-text>
      </mj-column>
    </mj-section>
