...
## Subject
⚠️ Apresse-se! {{ product_name }} está se esgotando rápido - {{ shop_name }}
    ...
    <mj-section>
      <mj-column>
        <mj-text font-size="20px" font-weight="bold" color="{{ theme.color.text|default:'#1f2937' }}">
          Aja Rápido, {{ customer_name }}!
        </mj-text>

        <mj-text font-size="16px" line-height="1.6" color="{{ theme.color.text|default:'#4b5563' }}">
          Um produto em sua lista de desejos está ficando escasso. Apenas {{ stock_remaining }} unidade{{ stock_remaining|pluralize }} restante(s) - compre agora antes que acabe!
        </mj-text>
...
Compre antes que acabe: {{ product_url }}