...
## Subject
كيف كانت تجربتك الشرائية؟ اترك تقييمك
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="20px">
      <mj-column>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="10px" line-height="1.8">
          نتمنى أنك تستمتع بشراءك الأخير! آرائك تساعدنا على التحسين وتُساعِد العملاء الآخرين في اتخاذ قرارات مبنية على معلومات.
        </mj-text>
      </mj-column>
    </mj-section>
