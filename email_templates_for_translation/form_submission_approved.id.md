...
## Subject
✓ Pengajuan {{ form_name }} Anda telah disetujui!
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-section background-color="{{ theme.color.surface|default:'#f9fafb' }}" border-radius="8px" padding="20px">
          <mj-column>
            ...
            <mj-text color="{{ theme.color.text|default:'#4b5563' }}">
              ...
              <strong>Disetujui:</strong> {{ approval_date }}<br/>
        ...
        <mj-text font-size="14px" color="{{ theme.color.text_secondary|default:'#6b7280' }}" align="center">
          Pertanyaan? <a href="{{ support_url }}">Hubungi Dukungan</a>
        </mj-text>
        {% endif %}
      </mj-column>
    </mj-section>
...
{% if support_url %}Pertanyaan? Hubungi Dukungan: {{ support_url }}{% endif %}