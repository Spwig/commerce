...
## Subject
Componente approvato: {{ component_name }} v{{ version }}
    ...
    <mj-section background-color="{{ theme.color.success|default:'#10b981' }}" padding="40px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.background|default:'#ffffff' }}" align="center" padding-top="10px">
          La tua candidatura è pronta per la pubblicazione
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="{{ theme.color.background|default:'#ffffff' }}" padding="30px 20px">
      <mj-column>
        ...
        <mj-text font-size="16px" color="{{ theme.color.text|default:'#1f2937' }}" padding-top="20px">
          Buone notizie! La tua candidatura del componente è stata approvata e è pronta per la pubblicazione sul mercato Spwig.
        </mj-text>
      </mj-column>
    </mj-section>
...
{% if review_notes %}Note del revisore: {{ review_notes }}{% endif %}

Visualizza la candidatura: {{ submission_url }}
