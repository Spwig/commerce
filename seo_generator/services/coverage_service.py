...
class SEOCoverageService:
    ...
    def get_site_coverage(self, use_cache=True):
        ...
        result = {
            ...
            'quality': {
                ...
                'total_issues': (
                    grand_title_too_short + grand_title_too_long +
                    grand_desc_too_short + grand_desc_too_long
                ),
            }
        }
    ...
    def _calculate_model_coverage(self, model_type, model_class):
        ...
        stats = qs.aggregate(
            ...
            with_description=Count('pk', filter=~Q(meta_description='') & Q(meta_description__isnull=False)),
            with_both=Count('pk', filter=(
