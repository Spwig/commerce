...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            nargs='?',
            default='8.8.8.8',
            help='IP address to test (default: 8.8.8.8)'
        )
        parser.add_argument(
            '--verbose',
            action='store_true',
    ...
    def handle(self, *args, **options):
        ...
        if hasattr(request, 'geo_location'):
            ...
            if location:
                ...
                self.stdout.write(f"Country: {location.get('country', 'Unknown')} "
                ...
                self.stdout.write(f"Coordinates: {location.get('lat', 'N/A')}, {location.get('lon', 'N/A')}")
