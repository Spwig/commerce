            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if health.get('status') == 'healthy':
                        logger.info(f"Spwig GeoIP initialized successfully - Database: {health.get('services', {}).get('database', {}).get('ip_ranges', 0):,} IP ranges")
        ...
        try:
            ...
            if result:
                ...
                if formatted:
                    ...
                    formatted['confidence'] = result.get('confidence') or (0.98 if result.get('data_source') == 'BGP' else 0.95)
