...
from .models import VisitorLocation, PageView
...
BOT_UA_PATTERNS = (
    ...
    'puppeteer', 'playwright', 'wget', 'curl',
    'python-requests', 'python-urllib', 'httpx', 'aiohttp',
    'go-http-client', 'java/', 'libwww', 'okhttp',
    ...
    'zgrab', 'masscan', 'nikto', 'censys', 'shodan',
    'nmap', 'sqlmap', 'nuclei',
)
...
def track_page_view(request, page_url: str, source: str = 'middleware'):
    ...
    try:
        ...
        referrer = (
            request.META.get('HTTP_X_PAGE_REFERRER')
