...
from pos_api.views import (
    auth, terminal, catalog, cart, checkout,
    inventory, customer, orders, sync, reports, loyalty,
    terminal_provider, receipts, webauthn,
)
...
urlpatterns = [
    ...
    path('terminals/display-pairing/', terminal.generate_display_pairing_code, name='terminal_display_pairing'),
    ...
    path('cart/items/<int:item_id>/discount/remove/', cart.remove_item_discount, name='cart_item_discount_remove'),
    path('cart/manual-discount/', cart.apply_cart_discount, name='cart_manual_discount'),
    path('cart/manual-discount/remove/', cart.remove_cart_discount, name='cart_manual_discount_remove'),
    ...
    path('cart/parked/<int:parked_id>/restore/', cart.restore_parked_cart, name='cart_parked_restore'),
    ...
    path('checkout/gift-card/balance/', checkout.check_gift_card_balance, name='checkout_gift_card_balance'),
    path('checkout/split/', checkout.checkout_split, name='checkout_split'),

    # Terminal Provider (integrated card readers)
    path('terminal-provider/config/', terminal_provider.provider_config, name='terminal_provider_config'),
    path('terminal-provider/connection-token/', terminal_provider.connection_token, name='terminal_provider_connection_token'),
    path('terminal-provider/readers/', terminal_provider.list_readers, name='terminal_provider_readers'),
    path('terminal-provider/create-payment-intent/', terminal_provider.create_payment_intent, name='terminal_provider_create_intent'),
    path('terminal-provider/capture/', terminal_provider.capture_payment, name='terminal_provider_capture'),
    path('terminal-provider/cancel/', terminal_provider.cancel_payment, name='terminal_provider_cancel'),
    path('terminal-provider/initiate-cloud-payment/', terminal_provider.initiate_cloud_payment, name='terminal_provider_cloud_payment'),
    path('terminal-provider/payment-status/<str:transaction_id>/', terminal_provider.check_payment_status, name='terminal_provider_payment_status'),
    path('terminal-provider/cancel-cloud-payment/', terminal_provider.cancel_cloud_payment, name='terminal_provider_cancel_cloud'),
    ...
    path('inventory/<int:product_id>/all-locations/', inventory.cross_location_stock, name='inventory_cross_location'),
    ...
    path('orders/<int:order_id>/send-receipt/', receipts.send_digital_receipt, name='order_send_receipt'),
    path('orders/<int:order_id>/receipt-status/', receipts.receipt_status, name='order_receipt_status'),
    ...
    path('sync/stock-adjustments/', sync.upload_offline_stock_adjustments, name='sync_stock_adjustments'),
    ...
    path('webauthn/register/begin/', webauthn.webauthn_register_begin, name='webauthn_register_begin'),
    path('webauthn/register/complete/', webauthn.webauthn_register_complete, name='webauthn_register_complete'),
    path('webauthn/authenticate/begin/', webauthn.webauthn_authenticate_begin, name='webauthn_authenticate_begin'),
    path('webauthn/authenticate/complete/', webauthn.webauthn_authenticate_complete, name='webauthn_authenticate_complete'),
