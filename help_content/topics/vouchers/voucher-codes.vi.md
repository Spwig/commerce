...
## Bảng điều khiển mã khuyến mãi

Trang mã khuyến mãi hiển thị tổng quan với:

- **Thẻ Thống kê** — Số lượng mã khuyến mãi đang hoạt động, không hoạt động, số lần sử dụng và tổng số mã
- **Lọc** — Tìm kiếm theo mã hoặc tên, lọc theo Loại, Trạng thái và Phạm vi
- **Thẻ mã khuyến mãi** — Mỗi mã khuyến mãi được hiển thị với chi tiết về việc sử dụng và trạng thái
...
| Loại | Mô tả | Ví dụ |
|------|-------------|---------|
| **Giá cố định** | Trừ một khoản tiền cố định | Giảm $20 cho đơn hàng |
| **Tỷ lệ phần trăm** | Trừ một tỷ lệ phần trăm của tổng số tiền | Giảm 15% cho đơn hàng |
| **Miễn phí vận chuyển** | Loại bỏ phí vận chuyển | Miễn phí vận chuyển cho bất kỳ đơn hàng nào |

## Quản lý mã khuyến mãi

### Thẻ mã khuyến mãi

Mỗi thẻ mã khuyến mãi hiển thị:
- **Mã** — Mã khuyến mãi được in đậm
- **Mô tả** — Điều mà mã khuyến mãi thực hiện
- **Biểu tượng trạng thái** — Hoạt động hoặc Không hoạt động
- **Chi tiết giảm giá** — Loại và giá trị (ví dụ: "$ 20.00" hoặc "15.00%")
- **Phạm vi** — Xác định mã khuyến mãi áp dụng cho toàn bộ giỏ hàng hoặc các mặt hàng cụ thể
- **Số lần sử dụng** — Số lần mã khuyến mãi đã được sử dụng
- **Ngày tạo** — Thời điểm mã khuyến mãi được tạo
- **Hết hạn** — Ngày hết hạn hoặc "Không có ngày hết hạn"

### Hành động mã khuyến mãi

Mỗi thẻ có các nút hành động:
- **Chỉnh sửa** — Thay đổi cài đặt mã khuyến mãi
- **Xem lịch sử** — Xem lịch sử sử dụng
- **Xóa** — Xóa mã khuyến mãi

### Lọc mã khuyến mãi

Sử dụng thanh lọc để tìm mã khuyến mãi cụ thể:
...
Đối với các chiến dịch lớn, bạn có thể tạo mã khuyến mãi theo lô:
1. Hệ thống tự động tạo mã duy nhất (ví dụ: "COUPONX1600406498")
2. Thiết lập các tham số chung cho tất cả mã khuyến mãi được tạo
3. Phân phối mã qua email, mạng xã hội hoặc in ra

## Trải nghiệm khách hàng

Khi khách hàng có mã khuyến mãi:
1. Họ tiến hành đến **bước thanh toán**
2. Nhập mã vào trường **mã giảm giá**
