...
AI購物讓AI購物助手能夠找到您的產品，並在您允許的情況下，代表客戶從您的商店進行購買。預設情況下，此功能是**關閉的** — 啟用它是有意的選擇，直到您啟用為止，您的商店不會向這些助手公開任何內容。

## 啟用功能

打開 **設定 → AI購物**，並將 **啟用代理式商務** 開關打開。從此之後，支援通用商務協議的助手可以發現您的商店並讀取您的目錄。您的正常商店前端不會有任何變化。

## 準備狀態儀表板

AI購物頁面頂部以一句話回答了一個問題：**目前AI助手實際上能否從您的商店購買？**
