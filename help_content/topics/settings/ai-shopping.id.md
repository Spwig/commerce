...
Daftar pemeriksaan mencerminkan konfigurasi **aktif** Anda: hubungkan penyedia pembayaran atau tambahkan metode pengiriman dan penilaian akan diperbarui saat Anda membuka halaman berikutnya.

## Penghentian Darurat

**Penghentian darurat** adalah sakelar terpisah dari utama. Gunakan untuk menghentikan semua aktivitas asisten secara langsung — misalnya jika sesuatu terlihat tidak benar — tanpa mengubah konfigurasi Anda. Bersihkan untuk melanjutkan. Pikirkan sakelar utama sebagai "apakah fitur ini dikonfigurasi" dan penghentian darurat sebagai "hentikan semuanya sekarang".
...
Setiap produk memiliki pengaturan **Tampak untuk Agen Pembelian AI** (aktif secara default). Matikan untuk menjaga produk tertentu dari asisten sementara tetap muncul di toko Anda — berguna untuk barang yang lebih baik dijual melalui situs Anda sendiri.

## Mengelola Asisten Individual

Ketika asisten membeli pertama kali — atau mencoba — Spwig mencatatnya di bawah **Pembelian dengan AI → Identitas Agen**. Setiap entri menunjukkan rumah yang diverifikasi asisten (direktori yang mereka tanda tangani) dan jumlah permintaan yang telah mereka buat. Nama dan logo yang ditampilkan oleh asisten hanya ditampilkan sebagai *detail yang dinyatakan* — perlakukan sebagai label, bukan bukti identitas; rumah yang diverifikasi adalah bagian yang dapat dipercaya.

Asisten baru mulai **dibatasi**: mereka dapat melakukan transaksi, tetapi dalam batas tertentu. Untuk menghentikan satu, pilih dan pilih **Blokir asisten yang dipilih** — checkout terbuka berakhir dan asisten tidak dapat membeli lagi, sementara pembayaran yang sudah diterima tetap tidak tersentuh. **Buka kembali asisten yang dipilih** mengembalikannya ke keadaan terbatas (tidak langsung ke tak terbatas — mengangkat batasan selalu merupakan langkah terpisah dan sadar).

## Catatan Aktivitas

**Pembelian dengan AI → Acara Agen** adalah catatan yang dapat dibuktikan bahwa asisten melakukan — setiap permintaan yang diverifikasi, setiap upaya yang diblokir, setiap perubahan yang Anda lakukan. Ini hanya dapat dilihat dan tidak dapat diedit atau dihapus, sehingga menjadi bukti Anda jika pembelian yang dilakukan oleh asisten pernah diperdebatkan.
