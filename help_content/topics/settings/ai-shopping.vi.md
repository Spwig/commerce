...
Mua sắm AI cho phép các trợ lý mua sắm AI tìm kiếm sản phẩm của bạn và, khi bạn cho phép, mua hàng từ cửa hàng của bạn thay mặt khách hàng. Tính năng này **mặc định là tắt** — việc bật nó là một lựa chọn có ý thức, và cho đến khi bạn bật, cửa hàng của bạn sẽ không tiết lộ bất cứ thứ gì cho các trợ lý này.
...
Dưới phần kết luận, bạn sẽ thấy một danh sách kiểm tra ngắn — nhà cung cấp thanh toán được kết nối, có thể báo giá vận chuyển, sản phẩm có thể được trợ lý xem — kèm theo lời nhắc về bất cứ thứ gì vẫn cần được chú ý. Các con số hiển thị số lượng sản phẩm mà trợ lý có thể bán, số lượng bạn đã ẩn khỏi họ, số lượng trợ lý đã truy cập và số lượng bạn đã chặn.
...
Một cửa hàng có thể được phát hiện nhưng không thể mua hàng — đây là cách hữu ích để bắt đầu.

## Ẩn sản phẩm cụ thể

Mỗi sản phẩm đều có cài đặt **Hiển thị cho các trợ lý mua sắm AI** (mặc định là bật). Tắt nó để giữ một sản phẩm cụ thể không hiển thị cho các trợ lý trong khi nó vẫn hiển thị trên cửa hàng của bạn — rất hữu ích cho các mặt hàng bạn muốn chỉ bán thông qua trang web của riêng bạn.

## Quản lý các trợ lý cá nhân

Khi một trợ lý thực hiện giao dịch đầu tiên — hoặc cố gắng — Spwig sẽ ghi lại dưới mục **Mua sắm AI → Nhận dạng Trợ lý**. Mỗi mục hiển thị nơi nhà ở được xác minh của trợ lý (thư mục mà trợ lý ký tên) và số lượng yêu cầu mà trợ lý đã thực hiện. Tên và biểu tượng mà trợ lý hiển thị chỉ được hiển thị như **chi tiết được tuyên bố** — hãy coi đó là nhãn, không phải bằng chứng xác minh danh tính; nơi nhà ở được xác minh là phần duy nhất có thể tin cậy.

Các trợ lý mới bắt đầu ở trạng thái **bị giới hạn**: họ có thể thực hiện giao dịch, nhưng trong giới hạn nhất định. Để dừng một trợ lý, hãy chọn nó và chọn **Chặn trợ lý đã chọn** — các giao dịch mở sẽ kết thúc và trợ lý không còn thể mua hàng, trong khi bất kỳ khoản thanh toán nào đã được thực hiện sẽ không bị ảnh hưởng. **Mở lại trợ lý đã chọn** sẽ đưa nó trở lại trạng thái bị giới hạn (không bao giờ trực tiếp trở lại không giới hạn — việc xóa giới hạn luôn là bước riêng biệt và có ý thức).

## Nhật ký hoạt động

**Mua sắm AI → Sự kiện Trợ lý** là một bản ghi có thể phát hiện được việc can thiệp của các trợ lý — mọi yêu cầu được xác minh, mọi nỗ lực bị chặn, mọi thay đổi bạn thực hiện. Đây là bản ghi chỉ đọc và không thể chỉnh sửa hoặc xóa, vì vậy nó sẽ là bằng chứng của bạn nếu có tranh chấp về một giao dịch mà trợ lý đã thực hiện.

## Một chú ý về các nền tảng trợ lý
