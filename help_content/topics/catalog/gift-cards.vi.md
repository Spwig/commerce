...
Các cài đặt này kiểm soát cách khách hàng chọn số tiền khi mua thẻ quà tặng:

| Loại | Mô tả |
|------|-------------|
| **Mệnh giá cố định** | Khách hàng chọn từ các số tiền được đặt sẵn (ví dụ: $25, $50, $100) |
| **Số tiền tùy chỉnh** | Khách hàng nhập bất kỳ số tiền nào trong khoảng tối thiểu và tối đa |
| **Cả hai** | Cung cấp các mệnh giá được đặt sẵn cùng với tùy chọn số tiền tùy chỉnh |

## Tạo sản phẩm thẻ quà tặng

Mọi thẻ quà tặng — dù cuối cùng sẽ được bán hoặc được cấp phát thủ công hôm nay — đều cần có một sản phẩm loại thẻ quà tặng đằng sau.

### Bước 1: Thiết lập sản phẩm

1. Di chuyển đến **Sản phẩm > Tất cả sản phẩm** và nhấp vào **+ Thêm sản phẩm**
2. Đặt **Loại sản phẩm** thành **Thẻ quà tặng**
3. Điền tên sản phẩm và mô tả
4. Cấu hình cài đặt mệnh giá:
   - Chọn **Loại mệnh giá** (Cố định, Tùy chỉnh hoặc Cả hai)
   - Với Cố định: đặt các mệnh giá sẵn có
   - Với Tùy chỉnh: đặt **Tối thiểu** và **Tối đa** số tiền được phép
5. Đặt **Số ngày hết hạn** (0 = không bao giờ hết hạn) — điều này xác định thời gian thẻ quà tặng còn hiệu lực sau khi mua
...
- **Mã** — Mã xác nhận duy nhất (ví dụ: GC-XXXX-XXXX-XXXX)
- **Người nhận** — Email và tên
- **Biểu tượng trạng thái** — Trạng thái hiện tại với mã màu
- **Số dư / Số dư ban đầu / Đã sử dụng** — Tổng quan tài chính với phần trăm đã sử dụng
- **Ngày quan trọng** — Ngày tạo, ngày phát hành, ngày sử dụng lần đầu
- **Người gửi** — Người mua (hoặc người phát hành) thẻ quà tặng
...
**Tại cửa hàng**, tại máy POS của bạn:

1. Nhân viên thu ngân nhập mã tại bước thanh toán
2. Mã được xác minh — đang hoạt động, chưa hết hạn, có số dư và cùng loại tiền với giao dịch
3. Số dư được áp dụng cho toàn bộ số tiền phải trả, bao gồm thuế và phí vận chuyển
...
Email giao hàng bao gồm liên kết kiểm tra số dư mà người nhận có thể sử dụng bất kỳ lúc nào.
- Nếu bạn bán hàng cho khách hàng ở nhiều quốc gia, bạn có thể phát hành thẻ quà tặng bằng các loại tiền tệ cụ thể — xem chủ đề trợ giúp **Thẻ quà tặng đa tiền tệ** để biết thêm chi tiết.