...
Les avis des clients permettent de noter un produit et d'écrire sur leur expérience. Les avis que vous approuvez s'affichent sur la page du produit dans votre boutique, où ils aident les autres acheteurs à décider de leur achat. Spwig vous donne un contrôle complet sur les avis qui seront publiés : rien n'est publié avant que vous ne l'ayez approuvé.
...
| **Note moyenne** | La moyenne des étoiles sur chaque avis |
...
- **Répartition des notes** — un graphique en barres de la quantité d'avis qui tombent dans chaque note (1 à 5). Un regroupement d'avis à 1 étoile ici mérite d'être investigué immédiatement.
- **Volume des avis (12 semaines)** — un graphique en courbe du nombre d'avis semaine après semaine, afin de repérer les pics après une promotion ou une baisse qui nécessite de l'attention.
- **Canal d'achat des commentateurs** — un graphique en camembert du canal marketing (direct, courriel, recherche payante, réseaux sociaux organiques, etc.) qui a conduit à l'**achat** derrière chaque avis. Cela réutilise vos données d'attribution et est véritablement utile pour voir quels canaux attirent des clients qui finissent par laisser des avis — mais cela n'est pas une trace de la manière dont le client a trouvé le formulaire d'avis lui-même. Spwig ne suit pas cela séparément ; voir « Ce que le parcours fait et ne fait pas » plus bas dans ce guide.

Deux listes complètent le tableau de bord :

- **Produits les plus commentés** — vos produits les plus commentés, chacun avec leur nombre d'avis et leur note moyenne, qui mène directement vers le produit.
...
Chaque carte affiche la miniature du produit, le titre de l'avis, la note étoile, un badge **Approuvé**/**En attente**, un badge **Achat vérifié** lorsqu'il est pertinent, un aperçu du commentaire, et qui l'a rédigé et à quelle date.
...
Les avis ne sont pas visibles sur votre boutique jusqu'à ce que vous les approuviez. Vous pouvez approuver ou rejeter les avis individuellement ou en bloc.
...
C'est le moyen le plus rapide pour traiter un ensemble d'avis nouveaux.

### Avis individuel

1.

Cliquez sur l'icône de modification sur une carte d'avis, ou son titre, pour ouvrir l'avis
2.
...
Cliquez sur le bouton coche en haut pour enregistrer

## La page d'édition de l'aperçu

L'ouverture d'un aperçu vous donne une vue de type tableau de bord centrée sur cet aperçu unique — une en-tête avec le nom du produit, la note, un badge **Approuvé**/**En attente**, un badge **Acheteur vérifié** lorsqu'il est pertinent, qui a rédigé l'aperçu et à quelle date, ainsi qu'une ligne de statistiques (**Note**, **Votes utiles**, **Commandes clients**, **Dépense sur la vie**). Ci-dessous, les détails sont organisés en quatre onglets.
...
- **Images** — la liste sous-jacente des URL d'images derrière la galerie ci-dessus ; vous n'avez normalement pas besoin d'y toucher, mais elle reste éditable pour les cas extrêmes (par exemple, supprimer une photo d'un aperçu à plusieurs images)
...
Cet onglet vous donne un aperçu de la personne ayant rédigé l'aperçu : nombre total de commandes, combien de commentaires ils ont rédigés, leur note moyenne donnée, combien de temps ils sont clients, et leurs coordonnées, avec un lien pour ouvrir leur enregistrement client complet.
...
Lisez cette timeline comme le **parcours d'arrivée et d'achat** du client — comment ils ont trouvé votre magasin et ont acheté. Ce n'est **pas** un enregistrement de la visite pendant laquelle ils ont rédigé cet aperçu. Spwig ne suit pas où se trouvait le client, ou quel appareil ou session ils ont utilisés, au moment où ils ont soumis l'aperçu. Si la timeline montre "Email > soins de la peau en été" trois semaines avant la date de l'aperçu, cela vous indique que la campagne e-mail a probablement conduit à l'*achat* — cela ne dit rien sur le fait qu'ils soient revenus depuis un résultat de recherche, un signet, ou un e-mail de suivi pour réellement rédiger l'aperçu. Traitez cet onglet comme un contexte marketing utile, et non comme une trace littérale de la soumission de l'aperçu.

### Onglet Achat

![Page d'édition de l'aperçu — Onglet Achat](/static/core/admin/img/help/product-reviews/review-edit-purchase-tab.webp)

Cet onglet liste chaque commande dans laquelle le client a acheté le produit évalué — numéro de commande, date, montant total, statut, et le canal d'achat pour cette commande. Si l'une de ces commandes a atteint un statut livré (expédié ou livré), vous verrez une note de confirmation que c'est une commande vérifiée — le même signal qui définit automatiquement **Acheteur vérifié** sur l'onglet Aperçu.

Si aucune commande correspondante n'apparaît ici, le client a soit acheté le produit avant que votre magasin ne suive les commandes dans Spwig, soit ils n'ont jamais réellement acheté le produit — à noter avant de décider de la valeur à accorder à l'aperçu.

### Onglet Avancé

Des métadonnées que vous n'avez rarement besoin de toucher : **Nombre d'utilisateurs utiles** (combien de clients ont marqué l'aperçu comme utile), la provenance de l'import si l'aperçu a été migré d'une autre plateforme, et les horodatages de création/mise à jour.
...
- Un groupe de commentaires à 1 étoile sur le même produit dans le graphique **Répartition des notes** est un signe clair pour investiguer sur l'emballage, la qualité du produit ou votre texte de présentation
...
- Approuvez les avis rapidement, y compris les critiques — un avis négatif visible accompagné d'aucune réponse peut sembler plus mauvais qu'une réclamation traitée, et les avis qui s'affichent lentement découragent les clients de laisser des retours futurs
- Ne lisez pas trop en profondeur le **Parcours provenant du trafic** ou le graphique **Canal d'achat des rédacteurs d'avis** du tableau de bord — ils décrivent comment le client est arrivé et a acheté, pas comment il est arrivé pour écrire l'avis
- Les avis accompagnés de photos méritent une attention particulière avant approbation ; les photos de produits provenant de clients réels sont l'un des contenus les plus convaincants sur votre boutique