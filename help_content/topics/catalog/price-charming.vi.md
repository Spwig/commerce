...
| **Custom ending** | Bất kỳ — chỉ định bên dưới | Khi thương hiệu của bạn sử dụng kết thúc cụ thể như `.88` |
...
Sử dụng trường **Minimum Price Threshold** để bỏ qua định giá hấp dẫn cho các mặt hàng có giá rất thấp, nơi việc điều chỉnh sẽ trông kỳ lạ. Ví dụ, thiết lập ngưỡng là `5.00` có nghĩa là các sản phẩm có giá dưới $5 sẽ được hiển thị với giá tính toán thực tế mà không áp dụng định giá hấp dẫn.
...
Để tạm dừng định giá hấp dẫn mà không xóa quy tắc, hãy bỏ chọn **Active** và lưu lại. Quy tắc được giữ nguyên và có thể được kích hoạt lại bất kỳ lúc nào.
...
- Đồng Yen Nhật Bản và các loại tiền tệ theo số nguyên tương tự hoạt động tốt nhất với **Làm tròn đến 10 gần nhất** hoặc **Làm tròn đến 100 gần nhất**, vì các kết thúc thập phân trông không tự nhiên.
- Việc định dạng giá sẽ được áp dụng sau tất cả các ưu đãi và khuyến mãi, do đó giá bán của bạn cũng sẽ được định dạng trừ khi bạn bỏ chọn **Áp dụng cho Giá bán khuyến mãi**.
