...
1. Navigasikan ke **Produk > Kartu Hadiah** dan klik **+ Tambah Kartu Hadiah**
...
4. Secara opsional, atur tanggal **Berakhir Pada**, dan biarkan **Aktif** dicentang agar kartu dapat ditukarkan
5. Isi bagian **Penerima**, lebih jauh di halaman yang sama:
   ...
   - **Waktu Kirim Terjadwal** — opsional; biarkan kosong dan kirim kapan saja Anda siap, atau atur tanggal/waktu di masa depan (misalnya, ulang tahun)
6. Klik **Simpan**
...
- **Saldo** — Memiliki Saldo atau Tidak Memiliki Saldo
...
- Klik kartu hadiah untuk **mengedit** detailnya dan lihat **riwayat transaksi** lengkapnya, yang ditampilkan secara inline di halaman yang sama
...
Catat bahwa kasir mengambil kode pada **pembayaran**, bukan saat membangun keranjang. Kartu hadiah adalah uang yang sudah diberikan oleh pelanggan, jadi kartu ini menyelesaikan tagihan daripada memberikan diskon pada barang.

**Secara online**, proses checkout memiliki bidang kartu hadiah pada langkah pembayaran. Pelanggan memasukkan kode mereka, saldo dikurangi dari jumlah yang terutang — setelah pajak dan pengiriman — dan sisa dibebankan ke kartu mereka seperti biasa. Jika kartu menutupi seluruh pesanan, tidak diperlukan pembayaran lain. Saldo hanya benar-benar dikurangi setelah pembayaran dikonfirmasi, jadi checkout yang dibatalkan tidak akan menyentuh kartu.
...
- **Kartu hadiah yang dibeli oleh pelanggan, belum digunakan** — kartu dinonaktifkan dan saldonya diatur ke nol, sehingga kredit menghilang bersama pengembalian dana.
...
- **Kartu hadiah yang digunakan untuk membayar pesanan yang dikembalikan** — pengembalian dana dikembalikan ke kartu terlebih dahulu, sebelum pembayaran kartu atau bank apa pun. Mengembalikan uang ke bank yang tidak pernah benar-benar dikumpulkan oleh penjual adalah kesalahan terburuk, dan mengembalikan nilai ke sumber asalnya juga menutup jalur penipuan yang diketahui. Jika kartu asli telah kedaluarsa atau dinonaktifkan, kartu pengganti diterbitkan ke penerima yang sama tanpa tanggal kedaluarsa.
...
- Gunakan penerbitan manual untuk kredit kebaikan, penyelesaian masalah layanan pelanggan, atau kasus apa pun di mana Anda ingin memberikan kredit toko kepada pelanggan tanpa pembelian di toko.
...
- Gunakan jenis denominasi "Both" untuk menawarkan kemudahan (jumlah yang ditetapkan) dan fleksibilitas (jumlah kustom).
...
- Jika Anda menjual kepada pelanggan di beberapa negara, Anda dapat menerbitkan kartu hadiah dalam mata uang tertentu — lihat topik bantuan **Multi-Currency Gift Cards** untuk detailnya.