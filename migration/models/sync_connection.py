...
class SyncConnection(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text=_("Descriptive name (e.g., 'Production Server', 'Staging')")
    )
    ...
    remote_version = models.CharField(
        max_length=20,
        blank=True,
        help_text=_("Spwig version running on the remote instance")
    )
    remote_site_name = models.CharField(
        max_length=200,
        blank=True,
        help_text=_("Site name of the remote instance")
    )

    is_verified = models.BooleanField(
        default=False,
        help_text=_("Whether the connection has been verified")
    )
    ...
    last_sync_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text=_("Last time a sync was performed using this connection")
    )
