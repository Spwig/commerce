...
class MigrationJob(models.Model):
    ...
    platform = models.CharField(
        max_length=20, choices=PLATFORM_CHOICES, help_text=_("Source e-commerce platform")
    )
    ...
    method = models.CharField(
        max_length=20, choices=METHOD_CHOICES, help_text=_("Migration method used")
    )

    # Connection Configuration (encrypted JSON)
    # Example: {"store_url": "...", "consumer_key": "...", "consumer_secret": "..."}
    connection_config = models.JSONField(
        default=dict, blank=True, help_text=_("Connection configuration (API keys, URLs, etc.)")
    )
    ...
    import_affiliates = models.BooleanField(
        default=False, help_text=_("Import affiliate data via Spwig Migration Bridge plugin")
    )
    ...
    current_step = models.CharField(
        max_length=100, blank=True, help_text=_("Current import step being processed")
    )
    ...
    warning_summary = models.TextField(blank=True, help_text=_("Summary of warnings encountered"))
