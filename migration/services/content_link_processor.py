...
class ContentLinkProcessor:
    ...
    def _scan_field(
        ...
        for a_tag in soup.find_all('a', href=True):
            ...
            if '/wp-json/' in href or '/wp-admin/' in href or '/wp-content/' in href or '/wp-includes/' in href:
                continue
    ...
    def _match_by_permalink(self, url: str) -> Optional[dict]:
    ...
    def _match_by_path_pattern(self, path_segments: List[str]) -> Optional[dict]:
    ...
    def _match_by_external_id(self, external_id: str) -> Optional[dict]:
    ...
    def _match_slug_to_blog_post(self, slug: str, confidence: float = 0.9) -> Optional[dict]:
    ...
    def _match_slug_across_models(self, slug: str, confidence: float = 0.7) -> Optional[dict]:
