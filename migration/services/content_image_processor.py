...
class ContentImageProcessor:
    ...
    def _process_image_url(self, url: str) -> str | None:
        """
    ...
    def _download_and_create_asset(self, url: str) -> MediaAsset | None:
        """
        ...
        try:
            ...
            existing = MediaAsset.objects.filter(external_id=f"wp_content_image_{url_hash}").first()
