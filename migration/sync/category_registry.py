...
SYNC_CATEGORIES = OrderedDict([
    ...
    ('site_settings', {
        ...
        'description': _('Core site configuration: name, branding, currency, checkout, SEO, maintenance'),
    ...
    ('design_theme', {
        ...
        'models': [
            'design.Theme', 'design.GlobalDesignSettings',
            'design.DesignToken', 'design.CustomCSS', 'design.ThemeBranding',
        ],
    ...
    ('design_layout', {
        ...
        'models': [
            'design.HeaderTemplate', 'design.FooterTemplate',
            'design.Widget', 'design.WidgetPlacement',
            'design.Menu', 'design.MenuItem',
        ],
    ...
    ('email_config', {
        ...
        'models': [
            'email_system.EmailAccount', 'email_system.EmailTemplate',
    ...
    ('payment_providers', {
        ...
        'group': 'providers',
        'has_credentials': True,
        'production_warning': _('Sandbox/test credentials will NOT be synced to production.'),
    }),

    ('shipping_config', {
        'label': _('Shipping Configuration'),
        'description': _('Shipping providers, zones, methods, promotions, rate tables, packages, carrier presets, locations'),
        'models': [
            'shipping.ProviderAccount', 'shipping.ShippingZone',
            'cart.ShippingMethod',
            'shipping.ShippingPromotion', 'shipping.ShippingRateTable',
            'shipping.ShippingPackage', 'shipping.CarrierPreset',
            'shipping.Location',
        ],
    ...
    ('tax_currency', {
        ...
        'description': _('Supported currencies, exchange rate providers, manual exchange rates'),
        'models': [
    ...
    ('tax_config', {
        ...
        'models': [
            'cart.TaxRate', 'cart.TaxPresetGroup', 'cart.TaxPresetRate',
        ],
    ...
    ('warehouse_config', {
        ...
        'description': _('Sales regions, warehouse locations, and fulfillment configuration'),
    ...
    ('commerce_rules', {
        ...
        'description': _('Vouchers, promotions, loyalty program, subscriptions, referral program'),
        'models': [
            'vouchers.VoucherCode', 'vouchers.VoucherRestriction',
            'catalog.Promotion',
            'loyalty.LoyaltyTier', 'loyalty.LoyaltyRule', 'loyalty.LoyaltyReward',
            'loyalty.LoyaltyBadge', 'loyalty.LoyaltyCampaign', 'loyalty.LoyaltySegment',
            'subscriptions.SubscriptionPlan', 'subscriptions.PlanAddon',
        ],
    ...
    ('page_content', {
        ...
        'models': [
            'page_builder.Page', 'page_builder.PageTemplate',
    ...
    ('social_connectors', {
        ...
        'group': 'providers',
        'has_credentials': True,
        'production_warning': _('OAuth tokens will need to be re-authorized on the destination.'),
    }),
    ...
    ('customer_analytics_config', {
        ...
        'models': [
            'customers.CustomerSegment', 'customers.LTVSettings',
    ...
    ('affiliate_config', {
        ...
        'models': [
            'affiliate.AffiliateSettings', 'affiliate.AffiliateReportSettings',
            'affiliate.Program',
        ],
    ...
    ('pos_config', {
        ...
        'description': _('Store groups, terminals, receipt templates, promo slides, staff discounts'),
        'models': [
            'pos_app.StoreGroup', 'pos_app.POSTerminalProvider',
            'pos_app.POSTerminal', 'pos_app.ReceiptTemplate',
            'pos_app.PromoSlide', 'pos_app.POSStaffDiscount',
        ],
    ...
    ('installed_components', {
        ...
        'description': _('Installed themes, provider integrations, and utility components with filesystem packages'),
        'models': [
    ...
    ('catalog', {
        ...
        'models': [
            'catalog.Category', 'catalog.Brand',
            'catalog.Product', 'catalog.ProductVariant', 'catalog.ProductImage',
            'catalog.ProductAttribute', 'catalog.AttributeValue',
            'catalog.ProductAttributeAssignment', 'catalog.BundleItem',
        ],
    ...
    ('customers', {
        ...
        'models': [
            'auth.User', 'accounts.CustomerProfile',
            'accounts.CommunicationPreference', 'orders.Address',
        ],
    ...
    ('inventory', {
        ...
        'description': _('Per-warehouse stock quantities, reserved stock, and reorder points'),
    ...
    ('digital_products', {
        ...
        'description': _('Digital assets, license key templates, license pools, license providers'),
        'models': [
            'catalog.DigitalAsset', 'catalog.LicenseKeyTemplate',
            'catalog.LicensePool', 'catalog.LicenseProvider',
        ],
    ...
    ('gift_cards', {
        ...
        'models': [
            'catalog.GiftCard', 'catalog.GiftCardTransaction',
            'vouchers.VoucherUsage', 'vouchers.AppliedVoucher',
        ],
    ...
    ('loyalty_members', {
        ...
        'description': _('Loyalty members, points balances, transactions, redemptions, badges'),
        'models': [
            'loyalty.LoyaltyMember', 'loyalty.LoyaltyBalance',
            'loyalty.LoyaltyTransaction', 'loyalty.LoyaltyRedemption',
            'loyalty.LoyaltyMemberBadge',
            'loyalty.LoyaltyCampaignExecution', 'loyalty.LoyaltySegmentMembership',
        ],
    ...
    ('subscriptions_active', {
        ...
        'description': _('Subscription plans pricing, active subscriptions, billing cycles, payment tokens'),
        'models': [
            'subscriptions.PlanPricingTier',
            'subscriptions.CustomerSubscription', 'subscriptions.CustomerSubscriptionAddon',
            'subscriptions.SubscriptionDiscount', 'subscriptions.BillingCycleLog',
        ...
        'production_warning': _('Payment tokens may not be valid across different payment provider installations.'),
    }),
    ...
    ('customer_analytics', {
        ...
        'models': [
            'customers.CustomerNote', 'customers.AbandonedCart',
            'customers.CustomerCohort', 'customers.CohortMetrics',
    ...
    ('affiliate_data', {
        ...
        'description': _('Affiliate accounts, program memberships, links, commissions, payouts'),
        'models': [
            'affiliate.Affiliate', 'affiliate.AffiliateProgramMembership',
            'affiliate.Link', 'affiliate.Commission', 'affiliate.Payout',
        ],
    ...
    ('pos_transactions', {
        ...
        'models': [
            'pos_app.POSShift', 'pos_app.CashMovement',
            'pos_app.POSPayment', 'pos_app.ParkedCart',
        ],
...
def resolve_dependencies(selected_categories):
    ...
    in_degree = {k: 0 for k in required}
