...
class SpwigSyncClient:
    ...
    def _request(self, method, path, **kwargs):
        ...
        try:
            ...
            raise SyncClientConnectionError(f"Cannot connect to {self.base_url}: {e}")
        except requests.Timeout:
            raise SyncClientConnectionError(f"Connection to {self.base_url} timed out")
    ...
    def export_category_all(self, category, credential_mode="redact"):
        ...
        """
        page = 1
        first_result = self.export_category(category, page=page, credential_mode=credential_mode)
        ...
        while page <= total_pages:
            result = self.export_category(category, page=page, credential_mode=credential_mode)
