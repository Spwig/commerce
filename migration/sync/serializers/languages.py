...
class LanguagesSerializer(CollectionSyncSerializer):
    ...
    def get_count(self):
        from translations.models import SiteLanguage, TranslationProvider, UITranslationOverride

        return (
            SiteLanguage.objects.count()
    ...
    def export(self, credential_mode="redact"):
        ...
        for lang in SiteLanguage.objects.all():
            ...
            try:
                ...
                data["_ui_overrides"] = {f: getattr(override, f) for f in UI_OVERRIDE_FIELDS}
