...
STAFF_ROLE_FIELDS = [
    ...
    'is_predefined', 'permission_categories', 'pos_permissions',
    'can_access_admin', 'can_access_pos', 'sort_order',
]
...
class StaffRolesSerializer(CollectionSyncSerializer):
    ...
    def _delete_absent(self, remote_items):
        ...
        remote_names = {item['display_name'] for item in remote_items
    ...
    def generate_diff(self, remote_data):
        ...
        for item in items:
            ...
            if existing:
                ...
                if field_changes:
                    changes.append({
                        'type': 'modify', 'model': 'StaffRole',
                        'name': item.get('display_name', 'Unknown'),
                        'changes': field_changes,
                    })
            else:
                changes.append({
                    'type': 'add', 'model': 'StaffRole',
                    'name': item.get('display_name', 'Unknown'),
