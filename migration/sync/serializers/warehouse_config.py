...
SALES_REGION_FIELDS = [
    'name', 'code', 'countries', 'default_currency',
    'is_active', 'priority',
]
...
WAREHOUSE_FIELDS = [
    ...
    'latitude', 'longitude',
    # Settings
    'is_active', 'fulfillment_priority', 'stock_buffer_percentage',
    # Display
    'display_name', 'show_on_frontend',
    # Contact
    'contact_name', 'contact_email', 'contact_phone',
    # POS / Retail
    'is_retail_location', 'pos_display_name',
]
...
class WarehouseConfigSerializer(CollectionSyncSerializer):
    ...
    def export(self, credential_mode='redact'):
        ...
        # Warehouses
        for wh in Warehouse.objects.select_related('region', 'shipping_location', 'store_group').all():
            ...
            data['_shipping_location_code'] = wh.shipping_location.code if wh.shipping_location else None
