...
SITE_SETTINGS_FIELDS = [
    ...
    # Security
    "staff_2fa_enforcement",
    "staff_2fa_grace_period_days",
    "allow_trusted_devices",
    "trusted_device_duration_days",
    # Error reporting
    "error_reporting_enabled",
    "error_reporting_include_js",
    # Translations
    "translations",
]
