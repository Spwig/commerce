...
from .authentication import SyncTokenAuthError, authenticate_sync_request
from .category_registry import FEATURE_BOTH, SYNC_CATEGORIES, get_categories_for_feature
        ...
        result.append(
            {
                ...
                "has_credentials": config.get("has_credentials", False),
                "has_files": config.get("has_files", False),
                "production_warning": str(config["production_warning"])
                if config.get("production_warning")
                else None,
