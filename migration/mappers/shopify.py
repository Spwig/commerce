    ...
    def map(self, source_data: Dict) -> Dict:
        ...
        try:
            ...
            mapped = {
                ...
                'allow_backorders': (
                    first_variant.get('inventory_policy', 'deny') == 'continue'
                ),
...
class ShopifyOrderMapper(BaseMapper):
    ...
    def map(self, source_data: Dict) -> Dict:
        ...
        try:
            ...
            mapped = {
                ...
                'order_number': str(
                    source_data.get('order_number', source_data.get('id'))
                ),

                # Customer
                'customer_id': customer.get('id', 0),
                'customer_email': source_data.get('email') or source_data.get(
                    'contact_email', ''
                ),
                ...
                'discount_total': self._parse_price(
                    source_data.get('total_discounts', 0)
                ),
                ...
                'shipping_address': self._map_address(
                    source_data.get('shipping_address', {})
                ),
                ...
                # Shipping
                'shipping_lines': self._map_shipping_lines(
                    source_data.get('shipping_lines', [])
                ),
    ...
    def _map_order_status(self, financial_status: str,
                          fulfillment_status: Optional[str],
                          cancelled_at: Optional[str]) -> str:
        """
        ...
        try:
            ...
            mapped = {
                ...
                'max_uses_per_customer': (
                    price_rule.get('once_per_customer') and 1
                ) or None,
    ...
    def map(self, source_data: Dict) -> Dict:
        ...
        try:
            ...
            mapped = {
                ...
                'excerpt': self.parse_html(
                    source_data.get('summary_html', '') or ''
                ),
