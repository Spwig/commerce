...
class PreFlightChecker:
    ...
    def run_all_checks(self):
        ...
        """
        results = {"critical_failures": [], "warnings": [], "info": [], "all_passed": True}
        ...
        try:
            ...
            endpoints = [
                ...
                (
                    "products/categories",
                    "Categories",
                ),  # Correct: products/categories not product_categories
            ]
            ...
            for endpoint, name in endpoints:
                try:
                    response = requests.get(
                        f"{base_url}/{endpoint}", auth=auth, params={"per_page": 1}, timeout=5
                    )
            ...
            if len(accessible) == len(endpoints):
                ...
                return {
                    ...
                    "details": {"accessible": accessible, "not_accessible": not_accessible},
                }
            else:
                return {
                    "name": "API Permissions",
        ...
        try:
            ...
            try:
                ...
                return {
                    ...
                    "details": {"size_bytes": db_size_bytes, "size_pretty": db_size_pretty},
                }
            except Exception:
