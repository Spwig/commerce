...
def filter_subscription_plans(request):
    ...
    # Build queryset
    queryset = SubscriptionPlan.objects.annotate(subscription_count=Count("subscriptions")).all()
    ...
    # Render results
    html = render_to_string("admin/subscriptions/partials/plan_cards.html", {"plans": queryset})
...
def filter_customer_subscriptions(request):
    ...
    html = render_to_string(
        "admin/subscriptions/partials/subscription_cards.html", {"subscriptions": queryset}
    )
