...
(function() {
    ...
    const resultsContainer = document.getElementById('plan-results') || document.getElementById('subscription-results');
    ...
    function showLoadingState(container) {
        const loadingText = CONFIG.resultsContainerId === 'plan-results'
    ...
    function showErrorState(container, message) {
        const errorText = CONFIG.resultsContainerId === 'plan-results'
    ...
    function initResultsListeners() {
        ...
        if (typeof django !== 'undefined' && django.jQuery && CONFIG.resultsContainerId) {
            ...
            $results.find('.action-select').off('click').on('click', function() {
                const $checkbox = $(this);
