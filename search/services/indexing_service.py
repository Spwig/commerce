...
class IndexingService:
        ...
        if hasattr(product, "translations") and product.translations:
            for lang, trans_data in product.translations.items():
                ...
                index["translations"][lang] = {
                    ...
                    "description": trans_data.get("short_description", "")
                    or trans_data.get("full_description", ""),
                }
    ...
    def index_blog_post(self, post) -> dict[str, Any]:
        ...
        index = {
            ...
            "content": [post.simple_content]
            if hasattr(post, "simple_content") and post.simple_content
            else [],
            "tags": [],
            "translations": {},
        }
