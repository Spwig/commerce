...
(function () {
    ...
    function getTranslations() {
        var el = document.getElementById('wizard-credentials-translations');
        if (el) {
    ...
    function toggleCredentialMode(isTestMode) {
        ...
        var banner = document.getElementById('credential-mode-banner');
        var icon = document.getElementById('mode-icon');
        var title = document.getElementById('mode-title');
        var description = document.getElementById('mode-description');

        var testFields = document.querySelectorAll('[data-group="test_credentials"]');
        var liveFields = document.querySelectorAll('[data-group="live_credentials"]');
        ...
        if (isTestMode) {
            ...
            testFields.forEach(function(el) { el.classList.remove('credential-field--hidden'); });
            liveFields.forEach(function(el) { el.classList.add('credential-field--hidden'); });
        } else {
            ...
            testFields.forEach(function(el) { el.classList.add('credential-field--hidden'); });
            liveFields.forEach(function(el) { el.classList.remove('credential-field--hidden'); });
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var testModeCheckbox = document.getElementById('id_test_mode');
        if (testModeCheckbox) {
