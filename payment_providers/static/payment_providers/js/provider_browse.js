    ...
    async install(providerSlug, providerName) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/payment-providers/providers/install/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
  ...
  class ProviderUpdater {
    ...
    async update(providerSlug, providerVersion) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/payment-providers/providers/update/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
              'X-CSRFToken': this.csrfToken,
