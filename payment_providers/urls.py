...
from .views import wizard, provider_browse, payment_dashboard
...
urlpatterns = [
    ...
    path('providers/install/<str:provider_slug>/', provider_browse.install_provider_ajax, name='install_provider'),
    path('providers/update/<str:provider_slug>/', provider_browse.update_provider_ajax, name='update_provider'),
    ...
    path('api/test-connection/<uuid:account_id>/', views.test_provider_connection, name='test_connection'),
