...
from providers_common.utils import load_manifest_translations, validate_credential_fields, validate_dual_environment_credentials
...
class ProviderWizardStep1View(WizardSessionMixin, View):
            ...
            if not provider_dir.exists():
                ...
                try:
                    ...
                    logger.warning(
                        ...
                        component.slug, provider_dir, exc,
                    )
    ...
    def post(self, request):
        ...
        try:
            component = ComponentRegistry.objects.get(id=component_id, component_type='payment_provider')
        except ComponentRegistry.DoesNotExist:
