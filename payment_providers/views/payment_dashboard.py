...
def payment_dashboard_view(request):
    ...
    provider_performance = PaymentAnalyticsService.get_provider_performance(start_date, end_date)
    revenue_over_time = PaymentAnalyticsService.get_revenue_over_time(
        start_date, end_date, compare, grouping
    )
    transaction_by_status = PaymentAnalyticsService.get_transaction_by_status(start_date, end_date)
    ...
    webhook_stats = PaymentAnalyticsService.get_webhook_stats(start_date, end_date)
    refund_metrics = PaymentAnalyticsService.get_refund_metrics(start_date, end_date, compare)
