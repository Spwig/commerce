...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS("✓ Created Stripe payment gateway"))
        else:
            self.stdout.write(self.style.WARNING("! Stripe gateway already exists"))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS("✓ Created PayPal payment gateway"))
        else:
            self.stdout.write(self.style.WARNING("! PayPal gateway already exists"))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS("✓ Created Square payment gateway"))
        else:
            self.stdout.write(self.style.WARNING("! Square gateway already exists"))
