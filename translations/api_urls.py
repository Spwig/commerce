...
urlpatterns = [
    ...
    # UI Translations API
    path(
        "ui-translations/<str:language_code>/",
        views.ui_translations_api,
        name="ui_translations_api",
    ),
    path(
        "ui-translations/<str:language_code>/save/",
        views.ui_translations_save_api,
        name="ui_translations_save",
    ),
    path(
        "ui-translations/<str:language_code>/auto-translate/",
        views.ui_translations_auto_translate_api,
        name="ui_translations_auto_translate",
    ),
    path(
        "ui-translations/<str:language_code>/export/",
        views.ui_translations_export_api,
        name="ui_translations_export",
    ),
    path(
        "ui-translations/<str:language_code>/import/preview/",
        views.ui_translations_import_preview_api,
        name="ui_translations_import_preview",
    ),
    path(
        "ui-translations/<str:language_code>/import/apply/",
        views.ui_translations_import_apply_api,
        name="ui_translations_import_apply",
    ),
    path(
        "ui-translations/<str:language_code>/translate-string/",
        views.ui_translations_translate_string_api,
        name="ui_translations_translate_string",
    ),
    path(
        "ui-translations/<str:language_code>/lock/",
        views.ui_translation_lock_api,
        name="ui_translation_lock",
    ),
    # Coverage API
    ...
    # Translate All API
    path(
        "translate-all/estimate/", views.translate_all_estimate_api, name="translate_all_estimate"
    ),
