...
UI_STRING_REGISTRY = {
    ...
    'cart.havent_added_items': gettext_noop("Looks like you haven't added any items to your cart yet."),
    ...
    'mini_cart.havent_added_anything': gettext_noop("Looks like you haven't added anything to your cart yet."),
    ...
    'checkout.please_wait': gettext_noop('Please wait while we confirm your payment. Do not close this page.'),
    'checkout.payment_confirmed': gettext_noop('Payment Confirmed!'),
    'checkout.redirecting_confirmation': gettext_noop('Redirecting you to your order confirmation...'),
    'checkout.payment_not_completed': gettext_noop('Payment Not Completed'),
    'checkout.payment_could_not_process': gettext_noop('Your payment could not be processed. Please try again or choose a different payment method.'),
    'checkout.return_to_checkout': gettext_noop('Return to Checkout'),
    'checkout.still_processing': gettext_noop('Still Processing'),
    'checkout.still_processing_desc': gettext_noop("Your payment is still being processed. You'll receive an email confirmation once it's complete."),
    ...
    'category.use_search': gettext_noop('Use our search feature to find exactly what you need, or contact our support team for personalized assistance.'),
    ...
    'home.discover': gettext_noop('Discover amazing products at great prices. Free shipping on orders over $50.'),
    'home.shop_now': gettext_noop('Shop Now'),
    'home.why_choose_us': gettext_noop('Why Choose Us?'),
    'home.experience': gettext_noop('Experience the future of online shopping with our cutting-edge platform.'),
    ...
    'home.join_customers': gettext_noop('Join thousands of satisfied customers who love our products.'),
    ...
    'stock.get_notified_back_in_stock': gettext_noop('Get notified when this item is back in stock'),
    'stock.enter_your_email': gettext_noop('Enter your email'),
    'stock.notify_me': gettext_noop('Notify Me'),
    'stock.notify_email_disclaimer': gettext_noop("We'll send you a one-time email when this product is available."),
    ...
    'account.view_support_conversations': gettext_noop('View support conversations and send messages'),
    ...
    'search.enter_search_term': gettext_noop('Enter a search term to find products, categories, and more.'),
    ...
    'blog.subscribe_notification': gettext_noop('Subscribe to get notified when we publish new content.'),
    ...
    'blog.select_categories_interest': gettext_noop("Select categories you're interested in. Leave all unchecked to receive posts from all categories."),
    ...
    'blog.preferences_saved': gettext_noop('Your subscription preferences have been saved successfully.'),

    # === 3D Configurator ===
    'configurator_3d.start_with_preset': gettext_noop('Start with a preset'),
    'configurator_3d.choose_starting_config': gettext_noop('Choose a starting configuration or build from scratch.'),
    ...
    'form_builder.preview_info': gettext_noop("Test your form's functionality here. Visual styling options are available when adding this form to a page using the Page Builder."),
    ...
    'js.failed_to_save_shipping_method': gettext_noop('Failed to save shipping method. Please try again.'),
    ...
    'js.failed_to_save_payment_method': gettext_noop('Failed to save payment method. Please try again.'),
    ...
    'js.payment_form_error_message': gettext_noop('We could not connect to the payment service. This may be a temporary issue. Please try again or choose a different payment method.'),
    'js.payment_form_try_again': gettext_noop('Try Again'),
    'js.payment_form_choose_different': gettext_noop('Or go back to select a different payment method'),
    ...
    'loyalty.start_earning_message': gettext_noop('Make purchases, engage with us, and start earning points today.'),
    # Rewards Catalog
    ...
    'loyalty.check_back_soon': gettext_noop('Check back soon for new rewards to redeem with your points!'),
    ...
    'loyalty.no_transactions_message': gettext_noop('Your transaction history will appear here once you start earning and redeeming points.'),
    # Tier Info
    'loyalty.tier_information': gettext_noop('Tier Information'),
    'loyalty.loyalty_tiers': gettext_noop('Loyalty Tiers'),
    'loyalty.unlock_benefits_message': gettext_noop('Unlock exclusive benefits as you earn more points'),
    ...
    'loyalty.reward_processed_message': gettext_noop('Your reward has been processed. Details below.'),
    ...
    'loyalty.no_badges_message': gettext_noop('Complete activities to earn badges and bonus points!'),
    ...
    'loyalty.keep_shopping_message': gettext_noop('Keep shopping and engaging to earn your first badge!'),
    ...
    'cookies.default_description': gettext_noop('We use cookies to improve your experience, analyse site traffic and personalise content.'),
    ...
    'cookies.necessary_desc': gettext_noop('Required for the site to function correctly. Cannot be disabled.'),
    'cookies.analytics': gettext_noop('Analytics'),
    'cookies.analytics_desc': gettext_noop('Help us understand how visitors use our site to improve the experience.'),
    'cookies.marketing': gettext_noop('Marketing'),
    'cookies.marketing_desc': gettext_noop('Used to show you relevant advertisements on other websites.'),
    'cookies.functional': gettext_noop('Functional'),
    'cookies.functional_desc': gettext_noop('Enable enhanced features like live chat and saved preferences.'),
    ...
    'category.use_our_search_feature_or_contact_our_customer_ser': gettext_noop('Use our search feature or contact our customer service team for personalized assistance.'),
    ...
    'checkout.you_ll_be_able_to_create_an_account_after_placing': gettext_noop("You'll be able to create an account after placing your order"),
    ...
    'contact.we_d_love_to_hear_from_you_get_in_touch_with_our_t': gettext_noop("We'd love to hear from you. Get in touch with our team."),
    ...
    'elements.add_frames_to_create_your_image_accordion': gettext_noop('Add frames to create your image accordion'),
    'elements.add_images_to_create_your_gallery': gettext_noop('Add images to create your gallery'),
    'elements.add_products_to_display_in_the_carousel': gettext_noop('Add products to display in the carousel'),
    'elements.add_testimonials_to_showcase_customer_feedback': gettext_noop('Add testimonials to showcase customer feedback'),
    ...
    'elements.configure_the_data_source_or_select_products_manua': gettext_noop('Configure the data source or select products manually.'),
    ...
    'elements.drop_elements_here_to_build_your_modal_content': gettext_noop('Drop elements here to build your modal content'),
    'elements.email_address': gettext_noop('Email Address'),
    'elements.ends_in': gettext_noop('Ends in:'),
    'elements.enter_city_postal_code_or_address': gettext_noop('Enter city, postal code, or address'),
    ...
    'elements.get_in_touch_with_us_we_d_love_to_hear_from_you': gettext_noop("Get in touch with us. We'd love to hear from you."),
    ...
    'elements.no_menu_selected_configure_this_element_to_select': gettext_noop('No menu selected. Configure this element to select a menu.'),
    ...
    'elements.no_stores_found_matching_your_search': gettext_noop('No stores found matching your search'),
    'elements.no_vouchers_available_at_this_time': gettext_noop('No vouchers available at this time'),
    ...
    'elements.select_a_form_from_the_form_builder_or_create_a_ne': gettext_noop('Select a form from the Form Builder or create a new one in the element settings.'),
    'elements.slide': gettext_noop('Slide'),
    'elements.sorry_there_was_an_error_sending_your_message_plea': gettext_noop('Sorry, there was an error sending your message. Please try again.'),
    ...
    'elements.thank_you_for_your_message_we_ll_get_back_to_you_s': gettext_noop("Thank you for your message! We'll get back to you soon."),
    'elements.thank_you_for_your_review_it_will_be_visible_once': gettext_noop('Thank you for your review! It will be visible once approved.'),
    ...
    'elements.your_browser_does_not_support_the_video_tag': gettext_noop('Your browser does not support the video tag.'),
    ...
    'faq.can_i_modify_my_order_after_placing_it': gettext_noop('Can I modify my order after placing it?'),
    'faq.click_log_in_then_forgot_password_enter_your_email': gettext_noop("Click \"Log In\", then \"Forgot Password\". Enter your email address and we'll send you a link to reset your password."),
    'faq.click_sign_up_in_the_header_enter_your_email_and_c': gettext_noop('Click "Sign Up" in the header, enter your email and create a password. You can also create an account during checkout.'),
    'faq.do_you_ship_internationally': gettext_noop('Do you ship internationally?'),
    'faq.find_answers_to_common_questions_about_our_product': gettext_noop('Find answers to common questions about our products and services'),
    ...
    'faq.i_forgot_my_password_how_do_i_reset_it': gettext_noop('I forgot my password. How do I reset it?'),
    ...
    'faq.log_into_your_account_go_to_order_history_select_t': gettext_noop('Log into your account, go to Order History, select the order, and click "Request Return". Follow the instructions to print your return label.'),
    'faq.once_your_order_ships_you_ll_receive_an_email_with': gettext_noop("Once your order ships, you'll receive an email with tracking information. You can also track your order in your account dashboard."),
    'faq.ordering': gettext_noop('Ordering'),
    'faq.our_customer_support_team_is_here_to_help': gettext_noop('Our customer support team is here to help.'),
    'faq.refunds_are_processed_within_5_7_business_days_aft': gettext_noop('Refunds are processed within 5-7 business days after we receive your return. The refund will be credited to your original payment method.'),
    'faq.simply_browse_our_products_add_items_to_your_cart': gettext_noop('Simply browse our products, add items to your cart, and proceed to checkout. You can create an account or checkout as a guest.'),
    'faq.still_have_questions': gettext_noop('Still have questions?'),
    'faq.we_accept_all_major_credit_cards_visa_mastercard_a': gettext_noop('We accept all major credit cards (Visa, Mastercard, American Express), PayPal, and Apple Pay.'),
    'faq.we_accept_returns_within_30_days_of_purchase_items': gettext_noop('We accept returns within 30 days of purchase. Items must be unused and in original packaging. See our Returns Policy for full details.'),
    'faq.we_offer_free_standard_shipping_on_orders_over_a_c': gettext_noop('We offer free standard shipping on orders over a certain amount. Check the cart for current free shipping thresholds.'),
    'faq.we_offer_standard_shipping_5_7_business_days_expre': gettext_noop('We offer standard shipping (5-7 business days), express shipping (2-3 business days), and overnight shipping where available.'),
    ...
    'faq.yes_we_ship_to_most_countries_worldwide_internatio': gettext_noop('Yes, we ship to most countries worldwide. International shipping times and costs vary by destination.'),
    'faq.yes_we_use_industry_standard_ssl_encryption_to_pro': gettext_noop('Yes, we use industry-standard SSL encryption to protect your payment information. We never store your full credit card details.'),
    'faq.you_can_modify_your_order_within_1_hour_of_placing': gettext_noop('You can modify your order within 1 hour of placing it. After that, please contact our customer service team for assistance.'),
    ...
    # === Home (additional) ===
    'home.designed_for_all_devices_and_screen_sizes': gettext_noop('Designed for all devices and screen sizes'),
    'home.discover_amazing_products_with_our_modern_fast_and': gettext_noop('Discover amazing products with our modern, fast, and lightweight shopping experience.'),
    'home.experience_the_future_of_online_shopping_with_our': gettext_noop('Experience the future of online shopping with our cutting-edge platform'),
    'home.join_thousands_of_satisfied_customers': gettext_noop('Join thousands of satisfied customers'),
    ...
    'home.your_data_and_transactions_are_always_protected': gettext_noop('Your data and transactions are always protected'),
    ...
    'order.we_ve_sent_a_confirmation_email_to_your_inbox': gettext_noop("We've sent a confirmation email to your inbox."),
    'order.or_sign_up_with': gettext_noop('or sign up with'),

    # === Privacy Policy Page ===
    'privacy.access_controls_and_authentication': gettext_noop('Access controls and authentication'),
    ...
    'privacy.analytics_providers_to_improve_our_services': gettext_noop('Analytics providers to improve our services'),
    'privacy.analyze_site_traffic_and_usage': gettext_noop('Analyze site traffic and usage'),
    'privacy.automatically_collected_information': gettext_noop('Automatically Collected Information'),
    'privacy.by_using_our_website_you_agree_to_the_collection_a': gettext_noop('By using our website, you agree to the collection and use of information in accordance with this policy.'),
    'privacy.communicating_with_you_about_your_orders_and_accou': gettext_noop('Communicating with you about your orders and account'),
    ...
    'privacy.depending_on_your_location_you_may_have_the_follow': gettext_noop('Depending on your location, you may have the following rights:'),
    ...
    'privacy.if_you_have_questions_about_this_privacy_policy_or': gettext_noop('If you have questions about this privacy policy or our data practices, please contact us:'),
    'privacy.improving_our_website_and_services': gettext_noop('Improving our website and services'),
    'privacy.information_we_collect': gettext_noop('Information We Collect'),
    'privacy.introduction': gettext_noop('Introduction'),
    'privacy.keep_you_signed_in_to_your_account': gettext_noop('Keep you signed in to your account'),
    'privacy.last_updated': gettext_noop('Last updated:'),
    'privacy.legal_authorities_when_required_by_law': gettext_noop('Legal authorities when required by law'),
    'privacy.marketing_partners_with_your_consent': gettext_noop('Marketing partners (with your consent)'),
    'privacy.name_and_contact_details_email_phone_address': gettext_noop('Name and contact details (email, phone, address)'),
    ...
    'privacy.pages_visited_and_time_spent_on_our_site': gettext_noop('Pages visited and time spent on our site'),
    'privacy.payment_information_processed_securely_by_our_paym': gettext_noop('Payment information (processed securely by our payment providers)'),
    'privacy.payment_processors_to_complete_transactions': gettext_noop('Payment processors to complete transactions'),
    'privacy.personal_information': gettext_noop('Personal Information'),
    'privacy.personalize_content_and_advertisements': gettext_noop('Personalize content and advertisements'),
    'privacy.preventing_fraud_and_ensuring_security': gettext_noop('Preventing fraud and ensuring security'),
    'privacy.processing_and_fulfilling_your_orders': gettext_noop('Processing and fulfilling your orders'),
    ...
    'privacy.regular_security_audits_and_updates': gettext_noop('Regular security audits and updates'),
    'privacy.remember_your_preferences_and_cart_contents': gettext_noop('Remember your preferences and cart contents'),
    'privacy.request_deletion_of_your_data': gettext_noop('Request deletion of your data'),
    'privacy.ssl_encryption_for_all_data_transmission': gettext_noop('SSL encryption for all data transmission'),
    'privacy.secure_payment_processing_through_trusted_provider': gettext_noop('Secure payment processing through trusted providers'),
    'privacy.sending_marketing_communications_with_your_consent': gettext_noop('Sending marketing communications (with your consent)'),
    'privacy.sharing_your_information': gettext_noop('Sharing Your Information'),
    'privacy.shipping_carriers_to_deliver_your_orders': gettext_noop('Shipping carriers to deliver your orders'),
    'privacy.to_exercise_these_rights_please_contact_us_using_t': gettext_noop('To exercise these rights, please contact us using the details below.'),
    'privacy.we_collect_several_types_of_information_to_provide': gettext_noop('We collect several types of information to provide and improve our services:'),
    'privacy.we_do_not_sell_your_personal_information_to_third': gettext_noop('We do not sell your personal information to third parties.'),
    'privacy.we_implement_appropriate_security_measures_to_prot': gettext_noop('We implement appropriate security measures to protect your personal information, including:'),
    'privacy.we_may_share_your_information_with': gettext_noop('We may share your information with:'),
    'privacy.we_respect_your_privacy_and_are_committed_to_prote': gettext_noop('We respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information when you visit our website or make a purchase.'),
    'privacy.we_use_cookies_and_similar_technologies_to': gettext_noop('We use cookies and similar technologies to:'),
    'privacy.we_use_your_information_for_the_following_purposes': gettext_noop('We use your information for the following purposes:'),
    'privacy.withdraw_consent_for_marketing': gettext_noop('Withdraw consent for marketing'),
    'privacy.you_can_manage_your_cookie_preferences_through_you': gettext_noop('You can manage your cookie preferences through your browser settings. Please note that disabling certain cookies may affect site functionality.'),
    ...
    'product.this_product_is_not_available_for_purchase_in_your': gettext_noop('This product is not available for purchase in your region.'),
    'product.this_slot_is_fully_booked_join_the_waitlist_to_be': gettext_noop('This slot is fully booked. Join the waitlist to be notified if a spot opens.'),
    ...
    'returns.accompanied_by_the_receipt_or_proof_of_purchase': gettext_noop('Accompanied by the receipt or proof of purchase'),
    'returns.choose_the_reason_for_your_return_from_the_dropdow': gettext_noop('Choose the reason for your return from the dropdown menu. This helps us improve our products and services.'),
    'returns.credit_debit_cards_3_5_business_days_for_the_refun': gettext_noop('Credit/Debit Cards: 3-5 business days for the refund to appear on your statement'),
    'returns.damaged_or_defective_items': gettext_noop('Damaged or Defective Items'),
    'returns.drop_off_your_package_at_any_authorized_shipping_l': gettext_noop('Drop off your package at any authorized shipping location. Keep your receipt for tracking purposes.'),
    ...
    'returns.hazardous_materials_or_flammable_liquids': gettext_noop('Hazardous materials or flammable liquids'),
    'returns.how_to_return_an_item': gettext_noop('How to Return an Item'),
    'returns.if_you_need_a_different_size_color_or_product_we_r': gettext_noop('If you need a different size, color, or product, we recommend returning the original item for a refund and placing a new order. This ensures the fastest processing time and guarantees availability of your desired item.'),
    'returns.if_you_received_a_damaged_or_defective_item_please': gettext_noop('If you received a damaged or defective item, please contact us immediately. We will arrange for a replacement or full refund at no additional cost to you.'),
    'returns.in_the_original_packaging_with_all_tags_attached': gettext_noop('In the original packaging with all tags attached'),
    'returns.intimate_or_sanitary_goods': gettext_noop('Intimate or sanitary goods'),
    'returns.items_marked_as_final_sale_or_non_returnable': gettext_noop('Items marked as "Final Sale" or "Non-Returnable"'),
    'returns.items_must_be_unused_with_tags_attached': gettext_noop('Items must be unused with tags attached'),
    'returns.log_into_your_account_and_go_to_order_history_sele': gettext_noop('Log into your account and go to "Order History". Select the order containing the item you wish to return and click "Request Return".'),
    'returns.need_help': gettext_noop('Need Help?'),
    'returns.non_returnable_items': gettext_noop('Non-Returnable Items'),
    'returns.once_approved_you_ll_receive_a_prepaid_shipping_la': gettext_noop("Once approved, you'll receive a prepaid shipping label via email. Print it and attach it to your package."),
    'returns.once_we_receive_and_inspect_your_return_we_ll_proc': gettext_noop("Once we receive and inspect your return, we'll process your refund to the original payment method."),
    'returns.original_packaging': gettext_noop('Original Packaging'),
    'returns.our_customer_service_team_is_available_to_assist_y': gettext_noop('Our customer service team is available to assist you with returns and refunds.'),
    ...
    'returns.please_include_photos_of_the_damage_when_contactin': gettext_noop('Please include photos of the damage when contacting customer support to expedite the process.'),
    ...
    'returns.refunds_are_processed_within_5_7_business_days_aft': gettext_noop('Refunds are processed within 5-7 business days after we receive your return. The refund will be credited to your original payment method:'),
    'returns.refunds_processed_in_5_7_business_days': gettext_noop('Refunds processed in 5-7 business days'),
    'returns.return_within_30_days_of_purchase': gettext_noop('Return within 30 days of purchase'),
    'returns.returned_within_30_days_of_the_delivery_date': gettext_noop('Returned within 30 days of the delivery date'),
    ...
    'returns.store_credit_immediately_available_in_your_account': gettext_noop('Store Credit: Immediately available in your account'),
    'returns.the_following_items_cannot_be_returned': gettext_noop('The following items cannot be returned:'),
    'returns.to_be_eligible_for_a_return_your_item_must_be': gettext_noop('To be eligible for a return, your item must be:'),
    'returns.unused_and_in_the_same_condition_that_you_received': gettext_noop('Unused and in the same condition that you received it'),
    'returns.view_faq': gettext_noop('View FAQ'),
    'returns.we_cover_return_shipping_costs': gettext_noop('We cover return shipping costs'),
    'returns.we_want_you_to_be_completely_satisfied_with_your_p': gettext_noop('We want you to be completely satisfied with your purchase'),
    ...
    'elements.no_results_try_different': gettext_noop('No results found. Try a different search term.'),
    'elements.find_a_store': gettext_noop('Find a Store'),
    'elements.locate_stores_near_you': gettext_noop('Locate our stores near you for pickup and in-person shopping'),
