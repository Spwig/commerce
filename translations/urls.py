...
urlpatterns = [
    ...
    path(
        ...
        views.install_translation_provider_ajax,
        name="install_provider",
    ),
    path(
        "providers/update/<slug:provider_slug>/",
        views.update_translation_provider_ajax,
        name="update_provider",
    ),
    path(
        "provider-wizard/<str:provider_type>/", views.provider_wizard_view, name="provider_wizard"
    ),
