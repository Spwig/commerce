...
urlpatterns = [
    ...
    path(
        "admin/provideraccount/<int:provider_id>/toggle-active/",
        toggle_provider_active,
        name="provider_toggle_active",
    ),
    path(
        "admin/provideraccount/<int:provider_id>/set-primary/",
        set_provider_primary,
        name="provider_set_primary",
    ),
    path(
        "admin/provideraccount/<int:provider_id>/sync-rates/",
        sync_provider_rates,
        name="provider_sync_rates",
    ),
    path(
        "admin/provideraccount/<int:provider_id>/delete/", delete_provider, name="provider_delete"
    ),
    ...
    path(
        "admin/manual-rate/<int:rate_id>/toggle-active/",
        toggle_manual_rate_active,
        name="manual_rate_toggle_active",
    ),
    path(
        "admin/manual-rate/<int:rate_id>/toggle-locked/",
        toggle_manual_rate_locked,
        name="manual_rate_toggle_locked",
    ),
    path(
        "admin/manual-rate/sync-from-provider/",
        sync_from_provider,
        name="manual_rate_sync_from_provider",
    ),
]
