...
(function() {
    ...
    function toggleProviderActive(providerId, button) {
        ...
        fetch(AdminUtils.buildAdminUrl(`/admin/exchange-rates/admin/provideraccount/${providerId}/toggle-active/`), {
            method: 'POST',
            headers: {
    ...
    function setProviderPrimary(providerId, button) {
        ...
        fetch(AdminUtils.buildAdminUrl(`/admin/exchange-rates/admin/provideraccount/${providerId}/set-primary/`), {
            method: 'POST',
            headers: {
                'X-CSRFToken': AdminUtils.getCsrfToken(),
                'Content-Type': 'application/json',
    ...
    function syncProviderRates(providerId, button) {
        ...
        fetch(AdminUtils.buildAdminUrl(`/admin/exchange-rates/admin/provideraccount/${providerId}/sync-rates/`), {
            method: 'POST',
            headers: {
                'X-CSRFToken': AdminUtils.getCsrfToken(),
                'Content-Type': 'application/json',
    ...
    async function deleteProvider(providerId, button) {
        ...
        fetch(AdminUtils.buildAdminUrl(`/admin/exchange-rates/admin/provideraccount/${providerId}/delete/`), {
            method: 'POST',
            headers: {
                'X-CSRFToken': AdminUtils.getCsrfToken(),
                'Content-Type': 'application/json',
