    ...
    async install(providerSlug, providerName) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/exchange-rates/providers/install/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
  ...
  class ProviderUpdater {
    async update(providerSlug, providerVersion) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/exchange-rates/providers/update/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
              'X-CSRFToken': AdminUtils.getCsrfToken(),
