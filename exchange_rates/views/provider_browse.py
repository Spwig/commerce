...
class ProviderBrowseView(View):
    ...
    def get(self, request):
        ...
        try:
            ...
            available_from_server = update_manager.list_available_components(component_type='exchange_rate_provider')
        ...
        installed_db = {p.slug: p.current_version for p in ComponentRegistry.objects.filter(component_type='exchange_rate_provider')}
...
def install_provider_ajax(request, provider_slug):
    ...
    try:
        ...
        available_providers = update_manager.list_available_components(component_type='exchange_rate_provider')
