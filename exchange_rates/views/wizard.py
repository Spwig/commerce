...
class ProviderWizardStep1View(WizardSessionMixin, View):
    ...
    def get(self, request):
        ...
        for component in providers:
            try:
                ...
                provider_dir = INTEGRATIONS_DIR / 'exchange_rate_provider' / component.slug / version
                    ...
                    if manifest:
                        ...
                        if logo_filename:
                            ...
                            if logo_path.exists():
                                ...
                                logo_url = static(f'exchange_rate_provider/{component.slug}/current/{logo_filename}')
    ...
    def post(self, request):
        ...
        try:
            component = ComponentRegistry.objects.get(id=component_id, component_type='exchange_rate_provider')
        except ComponentRegistry.DoesNotExist:
            ...
            if action == 'test':
                ...
                try:
                    ...
                    return JsonResponse({
                        ...
                        'redirect_url': reverse('admin:exchange_rates_exchangerateprovideraccount_change', args=[provider_account.id])
                    })
