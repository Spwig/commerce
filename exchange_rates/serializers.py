...
class ManualExchangeRateListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'currency_pair', 'base_currency', 'target_currency',
            'rate', 'is_active', 'exclude_from_auto_sync', 'updated_at',
        ]
...
class ManualExchangeRateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'currency_pair', 'base_currency', 'target_currency',
            'rate', 'is_active', 'exclude_from_auto_sync', 'notes',
...
class ManualExchangeRateBulkSerializer(serializers.Serializer):
    ...
    rates = serializers.ListField(
        ...
        min_length=1,
        max_length=100,
        help_text=_("List of rate objects with base_currency, target_currency, rate, and optional is_active/notes")
    )
