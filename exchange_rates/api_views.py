...
@extend_schema_view(
    list=extend_schema(
        ...
        description=_(
            "Returns all manual exchange rates for the current site. Staff authentication required."
        ),
    ...
    create=extend_schema(
        ...
        description=_(
            "Create a new manual exchange rate for a currency pair. "
        ...
        responses={
            ...
            400: OpenApiResponse(
                description=_("Validation error (duplicate pair, invalid rate, etc.)")
            ),
        },
    ),
    ...
    partial_update=extend_schema(
        ...
        description=_(
            "Update specific fields of a manual exchange rate. "
    ...
    destroy=extend_schema(
        ...
        description=_(
            "Permanently delete a manual exchange rate. "
...
class ManualExchangeRateViewSet(viewsets.ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return Response(
            {"success": True, "message": str(_("Manual exchange rate deleted successfully."))},
            status=status.HTTP_200_OK,
        )
    ...
    @extend_schema(
        ...
        description=_(
            "Toggle the active/inactive status of a manual exchange rate. "
    ...
    @extend_schema(
        ...
        description=_(
            "Create or update multiple manual exchange rates in a single request. "
        ...
        with transaction.atomic():
            for i, rate_data in enumerate(rates_data):
                    ...
                    errors.append(
                        {
                            "index": i,
                            "error": str(
                                _("base_currency, target_currency, and rate are required.")
                            ),
                        }
                    )
                    continue
                ...
                try:
                    ...
                    errors.append({"index": i, "error": str(_("Invalid rate value."))})
                    continue
                ...
                _obj, created = ManualExchangeRate.objects.update_or_create(
                    site=site, base_currency=base, target_currency=target, defaults=defaults
                )
        ...
        return Response(
            {
                ...
                "message": str(
                    _("Bulk operation completed: %(created)d created, %(updated)d updated.")
    ...
    @extend_schema(
        ...
        description=_(
            "Auto-populate manual exchange rates from the latest provider rates. "
    ...
    def sync_from_provider(self, request):
        ...
        try:
                ...
                try:
                    _obj, was_created = ManualExchangeRate.objects.update_or_create(
                        ...
                        defaults={
                            ...
                            "is_active": True,
                            "notes": str(
                                _("Synced from provider on %(date)s")
                    ...
                    errors.append(
                        {"currency": f"{base_currency}/{target_currency}", "error": str(e)}
                    )
            ...
            return Response(
                {"success": False, "message": str(_("An error occurred during sync."))},
