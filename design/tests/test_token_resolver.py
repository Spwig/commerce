...
from design.models import DesignToken, ComponentStore
...
class TestDesignTokenModel:
    ...
    def test_helper_methods(self, system_token_primary, theme_token_primary,
                           component_token_primary, brand_builder_token_primary):
...
class TestTokenResolver:
    ...
    def test_cascade_priority_system_to_brand_builder(
        self, system_token_primary, theme_token_primary,
        component_token_primary, brand_builder_token_primary,
        theme, component_hero
    ):
    ...
    def test_cascade_without_brand_builder(
        self, system_token_primary, theme_token_primary,
        component_token_primary, theme, component_hero
    ):
    ...
    def test_component_scoped_resolution(self, system_token_primary, component_hero, component_footer):
    ...
    def test_get_cascade_for_token(
        self, system_token_primary, theme_token_primary,
        brand_builder_token_primary, theme
    ):
