...
from design.models import PageTier, ComponentStore, TierComponentPermission
...
class TestPageSchemaRegistry:
    ...
    def test_validate_page_schema_missing_component_field(
        self, schema_registry, tier_b_product
    ):
    ...
    def test_validate_page_schema_invalid_structure(
        self, schema_registry, tier_b_product
    ):
...
class TestSchemaRegistryIntegration:
    ...
    def test_tier_a_strict_enforcement(
        self, schema_registry, tier_a_checkout, approved_component
    ):
        """Test that Tier A enforces strict security."""
        # Create permission for Tier A
        TierComponentPermission.objects.create(
            tier=tier_a_checkout,
            component=approved_component,
    ...
    def test_tier_c_flexible_enforcement(
        self, schema_registry, tier_c_home, approved_component
    ):
