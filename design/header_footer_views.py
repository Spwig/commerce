...
from .header_footer_models import FooterTemplate, HeaderTemplate, Menu, Widget
...
class MenuBuilderView(View):
    ...
    def get(self, request, menu_id=None):
        ...
        if menu_id is None:
            ...
            return HttpResponseRedirect(reverse("design:menu_builder", args=[menu.id]))
        ...
        items_tree = (
            menu.get_all_items_tree()
            if hasattr(menu, "get_all_items_tree")
            else self._get_items_tree(menu)
        )
