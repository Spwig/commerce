...
class Command(SeedCommand):
    ...
    FONT_FAMILIES = [
        ('font-sans', 'ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', 'System sans-serif stack'),
        ('font-serif', 'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif', 'System serif stack'),
        ('font-mono', 'ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, monospace', 'System monospace stack'),
    ]
    FONT_SIZES = [
