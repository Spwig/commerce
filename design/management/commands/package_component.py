...
from design.component_packager import ComponentPackager
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if show_stats:
            ...
            self.stdout.write(
                f"  Assets: {stats['asset_count']} files ({stats['asset_size_kb']:.2f} KB)"
            )
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Package created successfully"))
            ...
            if verbose:
                ...
                with zipfile.ZipFile(package_path, "r") as zf:
                    for name in zf.namelist():
                        ...
                        self.stdout.write(f"  {name} ({info.file_size} bytes)")
