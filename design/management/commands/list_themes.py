    ...
    def handle(self, *args, **options):
        ...
        for theme in themes:
            ...
            if options['verbose']:
                ...
                self.stdout.write(f'  Engine: {theme.engine_min_version} - {theme.engine_max_version or "latest"}')
                ...
                if asset_count:
                    ...
                    self.stdout.write(f'  Assets: {asset_count} total ({css_count} CSS, {js_count} JS)')
