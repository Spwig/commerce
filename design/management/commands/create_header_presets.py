...
class Command(BaseCommand):
    ...
    def create_classic_ecommerce(self, user, widgets):
        ...
        if created:
            ...
            WidgetPlacement.objects.create(header=header, widget=widgets['logo'], zone='main-header_left', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['search'], zone='main-header_center', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['cart'], zone='main-header_right', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['account'], zone='main-header_right', order=1)
            WidgetPlacement.objects.create(header=header, widget=widgets['language'], zone='main-header_right', order=2)
            # Bottom bar: navigation
            WidgetPlacement.objects.create(header=header, widget=widgets['menu'], zone='bottom-bar_full', order=0)
    ...
    def create_centered_boutique(self, user, widgets):
        ...
        if created:
            ...
            WidgetPlacement.objects.create(header=header, widget=widgets['search'], zone='main-header_left', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['logo'], zone='main-header_center', order=0,
    ...
    def create_minimal_startup(self, user, widgets):
        ...
        if created:
            WidgetPlacement.objects.create(header=header, widget=widgets['logo'], zone='main-header_left', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['menu'], zone='main-header_right', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['cart'], zone='main-header_right', order=1)
            WidgetPlacement.objects.create(header=header, widget=widgets['account'], zone='main-header_right', order=2)
            self.stdout.write(f'  \u2713 Created: {header.name}')
    ...
    def create_mega_menu_store(self, user, widgets):
        ...
        if created:
            ...
            WidgetPlacement.objects.create(header=header, widget=widgets['menu'], zone='mega-menu-bar_full', order=0)
            self.stdout.write(f'  \u2713 Created: {header.name}')
    ...
    def create_split_navigation(self, user, widgets):
        ...
        if created:
            ...
            WidgetPlacement.objects.create(header=header, widget=widgets['logo'], zone='top-bar_left', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['search'], zone='top-bar_right', order=0)
            WidgetPlacement.objects.create(header=header, widget=widgets['cart'], zone='top-bar_right', order=1)
            WidgetPlacement.objects.create(header=header, widget=widgets['account'], zone='top-bar_right', order=2)
            WidgetPlacement.objects.create(header=header, widget=widgets['language'], zone='top-bar_right', order=3)
            # Main header: full-width navigation
            WidgetPlacement.objects.create(header=header, widget=widgets['menu'], zone='main-header_left', order=0)
            self.stdout.write(f'  \u2713 Created: {header.name}')
