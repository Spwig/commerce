...
PRODUCT_TEMPLATE_OPTIONS = {
    ...
    "designer": {
        ...
        "tab_style": {
            ...
            "label": _("Info sections layout"),
            "help": _(
                "How description, specifications, and reviews are displayed below the editor."
            ),
        },
    },
}
...
CATEGORY_TEMPLATE_OPTIONS = {
    "grid": {
        ...
        "card_image_fallback": {
            ...
            "help": _(
                "When a category has no image: show first product image, or a placeholder icon."
            ),
        },
        "products_per_page": {
            "type": "select",
    ...
    "carousel": {
        ...
        "row_size": {
            ...
            "label": _("Products per row"),
            "help": _(
                "Maximum products in each carousel row. Rows stack vertically — extra products create a new row below."
            ),
        },
        "products_per_page": {
            "type": "select",
    ...
    "featured": {
        ...
        "hero_layout": {
            ...
            "label": _("Hero layout"),
            "help": _(
                "Layout of the featured product hero section. Full width spans the page; split shows image and details side by side."
            ),
        },
        "show_subcategories": {
            "type": "bool",
    ...
    "accordion": {
        "panels_per_row": {
            ...
            "help": _(
                "Maximum category panels per accordion row. When categories exceed this, additional rows are created below."
            ),
        },
        "height": {
            "type": "select",
            ...
            "help": _(
                "Height of the accordion panels. Larger values create a more dramatic visual effect."
            ),
        },
        "expand_ratio": {
            "type": "select",
        ...
        "mobile_layout": {
            ...
            "help": _(
                "How panels are displayed on mobile devices. Stack shows them vertically; grid uses a compact grid."
            ),
        },
...
CHECKOUT_TEMPLATE_META = {
    "accordion": {
        "name": _("Accordion"),
        "description": _(
            "All checkout steps on one page with collapsible sections. Steps collapse after completion, showing a summary. Great for general-purpose stores."
        ),
        "icon": "fa-layer-group",
    ...
    "multi_step": {
        "name": _("Multi-Step"),
        "description": _(
            "One step per screen with a progress bar at top. Clean, focused input with smooth transitions. Ideal for mobile-first stores and impulse purchases."
        ),
        "icon": "fa-shoe-prints",
    ...
    "single_page": {
        "name": _("Single Page"),
        "description": _(
            "All checkout fields visible at once in a two-column layout. No collapsing or stepping. Perfect for B2B, repeat buyers, and digital products."
        ),
        "icon": "fa-file-alt",
    ...
    "express": {
        "name": _("Express"),
        "description": _(
            "Streamlined checkout for returning customers with saved addresses and payment methods. Falls back to another template for new customers."
        ),
        "icon": "fa-bolt",
...
CATEGORY_TEMPLATE_META = {
    "grid": {
        "name": _("Grid"),
        "description": _(
            "Classic responsive grid of product cards with configurable columns. The most versatile layout for general-purpose stores."
        ),
        "icon": "fa-th-large",
    ...
    "list": {
        "name": _("List"),
        "description": _(
            "Product rows with image and details side by side. Great for categories where customers need to compare specs at a glance."
        ),
        "icon": "fa-list",
    ...
    "carousel": {
        "name": _("Carousel"),
        "description": _(
            "Horizontal product slider with navigation arrows and dot indicators. Ideal for curated collections and featured selections."
        ),
        "icon": "fa-images",
    ...
    "masonry": {
        "name": _("Masonry"),
        "description": _(
            "Pinterest-style staggered grid that adapts to varying image heights. Best for visual products like fashion, art, and photography."
        ),
        "icon": "fa-columns",
    },
    "featured": {
        "name": _("Featured"),
        "description": _(
            "Large hero spotlight for top products with a supporting grid below. Perfect for categories with standout items or new arrivals."
        ),
        "icon": "fa-star",
    ...
    "accordion": {
        "name": _("Accordion"),
        "description": _(
            "Interactive horizontal image panels for browsing categories. Each panel expands on hover to reveal the category. Best for 3-8 categories."
        ),
        "icon": "fa-layer-group",
    },
}
...
PRODUCT_TEMPLATE_META = {
    "classic": {
        "name": _("Classic"),
        "description": _(
            "Gallery left, product info right. The familiar two-column layout used by major retailers. Tabs below for details, specs, and reviews."
        ),
        "icon": "fa-columns",
    ...
    "full_width": {
        "name": _("Full Width"),
        "description": _(
            "Large hero gallery spanning the full width, with product info centered below. Editorial feel that emphasizes product imagery. Great for lifestyle and luxury brands."
        ),
    ...
    "gallery_focus": {
        ...
        "description": _(
            "Gallery-heavy 60/40 layout with a sticky info sidebar. Shows more images by default. Ideal for jewelry, furniture, art, and handmade products."
        ),
        "icon": "fa-images",
    ...
    "digital": {
        "name": _("Digital"),
        "description": _(
            "Optimized for digital products with feature lists, instant delivery badges, license info, and no shipping-related UI. Perfect for software, ebooks, and courses."
        ),
        "icon": "fa-download",
    ...
    "designer": {
        "name": _("Designer"),
        "description": _(
            "Full-width design editor with compact product info bar. Optimized for customizable products where the visual editor is the primary interaction."
        ),
        "icon": "fa-paint-brush",
...
BLOG_POST_TEMPLATE_META = {
    "classic": {
        "name": _("Classic"),
        "description": _(
            "Full-width featured image at top, article body below with sidebar. Traditional blog layout with categories, tags, and subscribe."
        ),
        "icon": "fa-newspaper",
    ...
    "minimal": {
        "name": _("Minimal"),
        "description": _(
            "Clean centered reading experience with no sidebar. Focus on typography and content with comfortable reading width."
        ),
        "icon": "fa-align-left",
    ...
    "magazine": {
        "name": _("Magazine"),
        "description": _(
            "Large hero image, author bio section, and editorial feel with sidebar. Great for long-form content and storytelling."
        ),
        "icon": "fa-book-open",
    ...
    "full_width": {
        "name": _("Full Width"),
        "description": _(
            "Edge-to-edge featured image hero with wide content area and no sidebar. Immersive layout for visual storytelling."
        ),
        "icon": "fa-expand-arrows-alt",
...
BLOG_LIST_TEMPLATE_META = {
    "grid": {
        "name": _("Grid"),
        "description": _(
            "Card-based responsive grid with featured images, titles, and excerpts. Classic blog homepage layout."
        ),
        "icon": "fa-th-large",
    ...
    "list": {
        "name": _("List"),
        "description": _(
            "Full-width article rows with image on left and text on right. Scannable format for content-heavy blogs."
        ),
        "icon": "fa-list",
    ...
    "magazine": {
        "name": _("Magazine"),
        "description": _(
            "Featured post hero at top with mixed grid and list layout below. Editorial magazine look and feel."
        ),
        "icon": "fa-book-open",
    ...
    "minimal": {
        "name": _("Minimal"),
        "description": _(
            "Title-and-date list with no images. Clean, text-focused index page for blogs focused on writing."
        ),
        "icon": "fa-align-left",
