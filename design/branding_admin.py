...
class BrandingAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "animation_tokens": forms.Textarea(
                attrs={"rows": 5, "style": "font-family: monospace;"}
            ),
            "component_overrides": forms.Textarea(
                attrs={"rows": 10, "style": "font-family: monospace;"}
            ),
            "custom_css": forms.Textarea(
                attrs={"rows": 15, "class": "vLargeTextField", "style": "font-family: monospace;"}
            ),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            ...
            self.fields["font_family_heading"].initial = typography_tokens.get(
                "font-family-heading", ""
            )
            ...
            self.fields["line_height_base"].initial = typography_tokens.get(
    ...
    def save(self, commit=True):
        ...
        instance.typography_tokens = {
            "font-family-heading": self.cleaned_data.get("font_family_heading")
            or "Inter, system-ui, sans-serif",
            "font-family-body": self.cleaned_data.get("font_family_body")
            or "Inter, system-ui, sans-serif",
