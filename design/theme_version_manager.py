...
class ThemeVersionManager:
    ...
    @staticmethod
    def activate_theme_version(theme_slug: str, version: str, *, update_active_theme: bool = True) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Activating {theme_slug} {version} (update_active_theme={update_active_theme})")
            ...
            if update_active_theme:
                try:
                    ...
                    if theme_obj:
                        ...
                        logger.warning(f"Theme '{theme_slug}' not found in database, skipping DB update")
    ...
    @staticmethod
    def get_current_version(theme_slug: str) -> Optional[str]:
    ...
    @staticmethod
    def rollback_theme(theme_slug: str, to_version: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not current:
                return {
                    'success': False,
                    'error': f'No current version for {theme_slug}'
                }
    ...
    @staticmethod
    def uninstall_theme(theme_slug: str, version: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def get_active_theme() -> Optional[Dict[str, Any]]:
        """
    ...
    def health_check(theme_slug: str, version: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if current_link.exists() and current_link.is_symlink():
                ...
                return {
                    'status': 'degraded',
                    'message': 'Current symlink is missing or invalid'
                }
            ...
            if not manifest_path.exists():
                return {
                    'status': 'unhealthy',
                    'message': 'Theme manifest.json is missing'
                }
            ...
            if not css_dir.exists():
                return {
                    'status': 'unhealthy',
                    'message': 'Theme CSS directory is missing'
                }

            return {
                'status': 'healthy',
                'message': f'Theme {theme_slug} {version} is healthy'
            }
