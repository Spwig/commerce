...
urlpatterns = [
    ...
    path('widget-placement/<int:placement_id>/', WidgetPlacementAPIView.as_view(), name='widget_placement_update'),
    path('widget-placement/reorder/', ReorderPlacementsAPIView.as_view(), name='reorder_placements'),
    ...
    path('presets/<str:template_type>/<int:preset_id>/clone/', ClonePresetAPIView.as_view(), name='clone_preset'),

    # Header management
    path('header/<int:header_id>/duplicate/', DuplicateHeaderAPIView.as_view(), name='duplicate_header'),
    path('header/<int:header_id>/delete/', DeleteHeaderAPIView.as_view(), name='delete_header'),
    path('header/<int:header_id>/set-default/', SetDefaultHeaderAPIView.as_view(), name='set_default_header'),
]
