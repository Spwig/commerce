...
from .header_footer_models import FooterTemplate, HeaderTemplate, Menu
...
class WidgetLibraryResponseSerializer(serializers.Serializer):
    ...
    widgets = serializers.DictField(child=WidgetLibraryItemSerializer(many=True))
...
class WidgetSchemasResponseSerializer(serializers.Serializer):
    ...
    schemas = serializers.DictField(child=WidgetSchemaSerializer())
