...
class HeaderTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Mobile Settings"), {"fields": ("mobile_layout",), "classes": ("collapse",)}),
        (_("Styling"), {"fields": ("css_classes", "custom_css"), "classes": ("collapse",)}),
...
class FooterTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            _("Layout"),
            {"fields": ("layout_type", "column_count", "has_bottom_bar", "bottom_bar_content")},
        ),
        (
            _("Styling"),
            {
                "fields": ("background_color", "text_color", "css_classes", "custom_css"),
                "classes": ("collapse",),
            },
        ),
        (_("Status"), {"fields": ("is_active", "is_default")}),
...
class WidgetAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "visibility_rules": forms.Textarea(
                attrs={"rows": 5, "style": "font-family: monospace;"}
            ),
...
class WidgetAdmin(admin.ModelAdmin):
    ...
    list_display = ["name", "widget_type", "visibility_summary", "is_active", "usage_count"]
    list_filter = [
        "widget_type",
        "is_active",
        "show_on_mobile",
    ...
    fieldsets = (
        (_("Basic Information"), {"fields": ("name", "widget_type")}),
        (
            _("Configuration"),
            {
        ...
        (_("Styling"), {"fields": ("css_classes", "custom_css"), "classes": ("collapse",)}),
        (_("Performance"), {"fields": ("cache_duration",), "classes": ("collapse",)}),
    ...
    def visibility_summary(self, obj):
        ...
        if obj.show_on_mobile:
            devices.append('<i class="fas fa-mobile-alt" title="{}"></i>'.format(_("Mobile")))
        if obj.show_on_tablet:
            devices.append('<i class="fas fa-tablet-alt" title="{}"></i>'.format(_("Tablet")))
...
class MenuAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Basic Information"), {"fields": ("name", "slug", "description")}),
        (_("Configuration"), {"fields": ("location", "display_type")}),
        (_("Styling"), {"fields": ("css_classes", "custom_css"), "classes": ("collapse",)}),
        (_("Status"), {"fields": ("is_active",)}),
    )
    ...
    def edit_items_link(self, obj):
        ...
        return format_html('<a href="{}" class="button">Build Menu</a>', url)
...
class MenuItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Basic Information"), {"fields": ("menu", "parent", "title", "url", "target")}),
        (
            _("Appearance"),
            {
        ...
        (_("Order & Status"), {"fields": ("order", "is_active")}),
    )
