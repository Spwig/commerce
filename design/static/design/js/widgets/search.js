...
(function () {
    ...
    if (window._widgetSearchInit) { return; }
    ...
    function initWidget(widget) {
        ...
        var trigger = widget.querySelector('.search-mobile-trigger');
        var closeBtn = widget.querySelector('.search-mobile-close');
        var backdrop = widget.querySelector('.search-mobile-backdrop');
