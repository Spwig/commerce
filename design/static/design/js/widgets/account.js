...
(function () {
  ...
  if (window._widgetAccountInit) {
    return;
  }
  window._widgetAccountInit = true;

  function initWidget(widget) {
    if (widget.dataset.accountInitialized) {
      return;
    }
    widget.dataset.accountInitialized = 'true';

    const button = widget.querySelector('.widget-account-button');
    const menu = widget.querySelector('.widget-account-menu');
    ...
    button.addEventListener('click', function (e) {
      ...
      document.querySelectorAll('.widget-account.is-open').forEach(function (w) {
        ...
        const btn = w.querySelector('.widget-account-button');
        if (btn) {
    ...
    menu.addEventListener('keydown', function (e) {
      const links = menu.querySelectorAll('.widget-account-link');
