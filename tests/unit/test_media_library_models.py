...
class TestMediaAssetModel:
    ...
    def test_media_asset_dimensions(self, admin_user):
        ...
        asset = MediaAssetFactory(width=3840, height=2160, uploaded_by=admin_user)
    ...
    def test_media_asset_file_size_tracking(self, admin_user):
        ...
        # 5MB file
        asset = MediaAssetFactory(file_size=5 * 1024 * 1024, uploaded_by=admin_user)
    ...
    def test_media_asset_without_folder(self, admin_user):
        ...
        asset = MediaAssetFactory(folder=None, uploaded_by=admin_user)
    ...
    def test_media_asset_public_flag(self, admin_user):
        ...
        asset = MediaAssetFactory(is_public=True, uploaded_by=admin_user)
    ...
    def test_media_asset_usage_tracking(self, admin_user):
        ...
        not_in_use = MediaAssetFactory(usage_count=0, uploaded_by=admin_user)
    ...
    def test_media_asset_alt_text(self, admin_user):
        ...
        asset = MediaAssetFactory(alt_text="Product photo showing laptop", uploaded_by=admin_user)
...
class TestMediaFolderModel:
    ...
    def test_create_media_folder(self):
        ...
        folder = MediaFolderFactory(name="Products", description="Product images")
...
class TestThumbnailModel:
    ...
    def test_create_thumbnail(self, admin_user):
        ...
        asset = MediaAssetFactory(uploaded_by=admin_user)
        preset = ImageSizePresetFactory(name="small", width=300, height=300)

        thumbnail = ThumbnailFactory(media_asset=asset, size_preset=preset, width=300, height=300)
    ...
    def test_thumbnail_str_representation(self, admin_user):
        ...
        thumbnail = ThumbnailFactory(media_asset=asset, size_preset=preset, small=True)
    ...
    def test_thumbnail_webp_support(self, admin_user):
        ...
        thumbnail = ThumbnailFactory(media_asset=asset, size_preset=preset)
...
class TestImageSizePresetModel:
    ...
    def test_create_image_size_preset(self):
        ...
        preset = ImageSizePresetFactory(
            name="thumbnail", width=150, height=150, crop_mode="crop", quality=85
        )
    ...
    def test_preset_str_representation(self):
        ...
        preset = ImageSizePresetFactory(name="medium", width=600, height=600)
    ...
    def test_system_preset_flag(self):
        ...
        system_preset = ImageSizePresetFactory(name="small", is_system_preset=True, small=True)
        custom_preset = ImageSizePresetFactory(name="custom", is_system_preset=False)
...
class TestMediaProcessingJobModel:
    ...
    def test_create_processing_job(self, admin_user):
        ...
        job = MediaProcessingJobFactory(
            media_asset=asset, job_type="thumbnail_generation", status="pending"
        )
    ...
    def test_job_status_transitions(self, admin_user):
        ...
        asset = MediaAssetFactory(uploaded_by=admin_user)
        job = MediaProcessingJobFactory(media_asset=asset, status="pending")
    ...
    def test_job_error_tracking(self, admin_user):
        ...
        asset = MediaAssetFactory(uploaded_by=admin_user)
        job = MediaProcessingJobFactory(
            media_asset=asset, status="failed", error_message="File not found"
        )
    ...
    def test_job_progress_tracking(self, admin_user):
        ...
        asset = MediaAssetFactory(uploaded_by=admin_user)
        job = MediaProcessingJobFactory(media_asset=asset, progress=50)
...
class TestModelRelationships:
    ...
    def test_thumbnail_preset_relationship(self, admin_user):
        ...
        asset = MediaAssetFactory(uploaded_by=admin_user)
        thumbnail = ThumbnailFactory(media_asset=asset, size_preset="small", small=True)
