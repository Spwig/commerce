...
class TestCartServiceAddItemCurrency:
    ...
    def test_add_item_sets_cart_currency_to_default(
        self, eur_site_settings, eur_product_no_tracking
    ):
    ...
    def test_add_item_unit_price_matches_product_currency(
        self, eur_site_settings, eur_product_no_tracking
    ):
...
class TestRecalculateTotalsCurrency:
    ...
    def test_recalculate_totals_uses_cart_currency(
        self, eur_site_settings, eur_product_no_tracking
    ):
    ...
    def test_recalculate_totals_no_currency_mismatch_error(
        self, eur_site_settings, eur_product_no_tracking
    ):
...
class TestMiniCartApiCurrency:
    ...
    def test_format_cart_for_minicart_includes_currency(
        self, eur_site_settings, eur_product_no_tracking
    ):
    ...
    def test_format_cart_for_minicart_no_dollar_in_formatted(
        self, eur_site_settings, eur_product_no_tracking
    ):
...
class TestCartRecommendationCurrency:
    ...
    def test_recommendation_service_no_hardcoded_dollar(self):
        ...
        service_path = os.path.join(
            ...
            "cart",
            "services",
            "cart_recommendation_service.py",
        )
