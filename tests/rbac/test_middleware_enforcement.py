...
class TestAdminAccessMiddleware:
    ...
    def test_staff_with_admin_role_has_access(self, request_factory, staff_user, admin_role, add_session_to_request):
    ...
    def test_pos_only_staff_blocked_from_admin(self, request_factory, staff_user, pos_only_role, add_session_to_request):
    ...
    def test_staff_with_no_roles_has_access(self, request_factory, staff_user, add_session_to_request):
        """
    ...
    def test_admin_login_page_always_accessible(self, request_factory, staff_user, pos_only_role, add_session_to_request):
    ...
    def test_non_admin_paths_not_checked(self, request_factory, staff_user, pos_only_role, add_session_to_request):
    ...
    def test_middleware_handles_language_prefixes(self, request_factory, staff_user, admin_role, add_session_to_request):
...
class TestMFAEnforcementMiddleware:
    ...
    def test_exempt_paths_bypass_middleware(self, request_factory, staff_user, add_session_to_request):
    ...
    def test_admin_paths_trigger_mfa_check(self, request_factory, staff_user, add_session_to_request):
    ...
    def test_non_admin_paths_bypass_mfa_check(self, request_factory, staff_user, add_session_to_request):
...
class TestMiddlewareOrdering:
    ...
    def test_admin_access_middleware_present(self):
        ...
        assert admin_access_mw in middleware, (
            "AdminAccessMiddleware must be in MIDDLEWARE"
        )
...
class TestRBACIntegration:
    ...
    def test_pos_staff_can_access_pos_api_but_not_admin(self, request_factory, staff_user, pos_only_role, add_session_to_request):
        """
        Verify POS-only staff can access POS but not admin.
        This is a critical business rule.
        """
        from staff_roles.services import can_access_pos, can_access_admin
    ...
    def test_admin_staff_can_access_both_admin_and_pos(self, request_factory, add_session_to_request):
