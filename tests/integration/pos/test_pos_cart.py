...
from tests.factories import (
    ProductFactory, StockItemFactory, VoucherFactory,
...
class TestAddToCart:
    ...
    def test_rejects_draft_product(self, pos_client, open_shift, category, site_settings):
        ...
        data = assert_pos_success(resp)
        assert any(
            item['product_id'] == draft.id for item in data['cart']['items']
        )
    ...
    def test_no_inventory_product_always_available(self, pos_client, open_shift, product_no_inventory):
...
class TestRemoveCartItem:
    ...
    def test_remove_returns_updated_cart(self, pos_client, open_shift, product_with_stock, product_no_inventory):
...
class TestApplyVoucher:
    ...
    def test_valid_voucher(self, pos_client, open_shift, product_with_stock):
        voucher = VoucherFactory(code='SAVE10', discount_type='percentage', discount_value=Decimal('10.00'))
...
class TestRemoveVoucher:
    ...
    def test_remove_voucher(self, pos_client, open_shift, product_with_stock):
        voucher = VoucherFactory(code='REMOVE10', discount_type='percentage', discount_value=Decimal('10.00'))
        _add_item(pos_client, product_with_stock.id, quantity=2)
...
class TestApplyGiftCard:
    ...
    def test_zero_balance_gift_card(self, pos_client, open_shift, product_with_stock, gift_card_product):
        from catalog.models import GiftCard
...
class TestClearCart:
    ...
    def test_clears_all_items(self, pos_client, open_shift, product_with_stock, product_no_inventory):
...
class TestManualItemDiscount:
    ...
    def test_percentage_discount(
        self, pos_client, open_shift, product_with_stock, staff_discount_config,
    ):
        _, item_id = _add_item(pos_client, product_with_stock.id, quantity=1)
    ...
    def test_requires_discount_config(
        self, pos_client, open_shift, product_with_stock,
    ):
...
class TestManagerApproval:
    ...
    def test_verify_pin_success(
        self, pos_client, open_shift, manager_discount_config,
    ):
    ...
    def test_non_manager_pin_rejected(
        self, pos_client, open_shift, staff_discount_config,
    ):
    ...
    def test_approve_with_manager_token(
        self, pos_client, open_shift, product_with_stock,
        staff_discount_config, manager_discount_config,
    ):
