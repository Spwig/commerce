...
from tests.factories import CustomerMessageFactory, OrderFactory, UserFactory
...
class TestMessageListView:
    ...
    def test_does_not_show_anonymous_messages_with_different_email(self, customer_client):
...
class TestMessageDetailView:
    ...
    def test_follow_up_post_sets_re_prefix(self, customer_client, customer_user, replied_message):
    ...
    def test_follow_up_post_sets_user_fields(self, customer_client, customer_user, replied_message):
    ...
    def test_follow_up_post_sets_status_unread(self, customer_client, replied_message):
    ...
    def test_follow_up_post_redirects_to_detail_page(self, customer_client, replied_message):
    ...
    def test_follow_up_post_shows_success_message(self, customer_client, replied_message):
    ...
    def test_follow_up_post_with_empty_message_shows_errors(self, customer_client, replied_message):
    ...
    def test_follow_up_post_without_action_does_not_create(self, customer_client, replied_message):
...
class TestMessageNewView:
    ...
    def test_post_shows_success_flash_message(self, customer_client):
        ...
        assert len(flash_messages) > 0
        assert (
            "submitted" in str(flash_messages[0]).lower()
            or "sent" in str(flash_messages[0]).lower()
        )
    ...
    def test_post_with_other_users_order_is_rejected(self, customer_client, other_user_order):
...
class TestMessageSecurity:
    ...
    def test_user_cannot_link_other_users_order_via_post(self, customer_client, other_user_order):
