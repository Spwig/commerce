...
@pytest.fixture
def seeded_tax_presets(db):
    """Run the seed_tax_presets management command to populate preset groups."""
    from django.core.management import call_command

    call_command("seed_tax_presets", verbosity=0)
...
class TestTaxServicePresets:
    ...
    def test_load_preset_creates_rates(self, site_settings, seeded_tax_presets):
    ...
    def test_load_preset_idempotent(self, site_settings, seeded_tax_presets):
...
class TestTaxPresetAPI:
    ...
    def test_list_presets(self, admin_client, site_settings, seeded_tax_presets):
    ...
    def test_preset_has_rate_count(self, admin_client, site_settings, seeded_tax_presets):
...
class TestTaxAdminAJAX:
    ...
    def test_load_preset_endpoint(self, django_admin_client, site_settings, seeded_tax_presets):
