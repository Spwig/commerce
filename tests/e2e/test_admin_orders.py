...
class TestAdminOrderView:
    ...
    def test_order_list_shows_created_orders(self, admin_product, site_settings, customer_user):
    ...
    def test_order_detail_shows_items(self, admin_product, site_settings, customer_user):
        """Order detail page shows order items and customer info."""
        product = ProductFactory(
            name="Order Detail Widget",
            slug="order-detail-widget",
            price=Decimal("25.00"),
            status="published",
        )
        order = OrderFactory(
    ...
    def test_order_status_is_correct(self, admin_product, site_settings, customer_user):
