...
class CustomElement(models.Model):
    ...
    name = models.CharField(
        _("Name"), max_length=100, help_text=_("Display name for the custom element")
    )
    slug = models.SlugField(
        _("Slug"), max_length=100, unique=True, help_text=_("URL-friendly identifier")
    )
    ...
    target_model = models.CharField(
        ...
        blank=True,
        help_text=_(
            'Model to bind data from (e.g., "catalog.Product"). Leave empty for static elements.'
        ),
    )
    ...
    is_active = models.BooleanField(
        _("Active"), default=True, help_text=_("Whether this element is available for use")
    )
