...
urlpatterns = [
    ...
    path(
        'custom-elements/',
        api_views.CustomElementListAPI.as_view(),
        name='list'
    ),
    path(
        'custom-elements/<int:pk>/',
        api_views.CustomElementDetailAPI.as_view(),
        name='detail'
    ),
    ...
    # Element bindings
    path(
        'custom-elements/<int:pk>/bindings/',
        api_views.ElementBindingAPI.as_view(),
        name='bindings'
    ),
    path(
    ...
    path(
        'primitives/',
        api_views.ElementPrimitivesAPI.as_view(),
        name='primitives'
    ),
    path(
    ...
    path(
        'bindable-models/',
        api_views.BindableModelsAPI.as_view(),
        name='bindable_models'
    ),
    path(
        'thumbnail-presets/',
        api_views.ThumbnailPresetsAPI.as_view(),
        name='thumbnail_presets'
    ),
]
