...
def render_custom_element(context, custom_element, instance):
    ...
    return mark_safe(_render_element_tree(
        custom_element.root_element,
        instance,
        bindings,
        request
    ))
...
def render_custom_element_by_slug(context, slug, instance):
    ...
    try:
        custom_element = CustomElement.objects.select_related(
            'root_element'
        ).prefetch_related(
            'bindings__element',
            'root_element__child_elements'
