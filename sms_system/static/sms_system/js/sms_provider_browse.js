    ...
    async install(providerSlug, providerName) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/sms-system/providers/install/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
  ...
  class ProviderUpdater {
    ...
    async update(providerSlug, providerVersion) {
      try {
        ...
        const response = await fetch(
          AdminUtils.buildAdminUrl(`/admin/sms-system/providers/update/${providerSlug}/`),
          {
            method: 'POST',
            headers: {
              'X-CSRFToken': this.csrfToken,
    ...
    document.querySelectorAll('.provider-details-link').forEach(function (button) {
      button.addEventListener('click', function (e) {
        ...
        try {
          ...
          const providerData = providersData.find(function (p) {
