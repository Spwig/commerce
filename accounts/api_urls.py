...
urlpatterns = [
    ...
    path('password-reset-confirm/<str:uidb64>/<str:token>/',
         api_views.password_reset_confirm, name='password_reset_confirm'),
    ...
    path('communication-preferences/', api_views.get_communication_preferences, name='communication_preferences_get'),
    path('communication-preferences/update/', api_views.update_communication_preference, name='communication_preference_update'),
    path('communication-preferences/bulk-update/', api_views.bulk_update_communication_preferences, name='communication_preferences_bulk_update'),
    path('communication-preferences/unsubscribe-all/', api_views.unsubscribe_all_communications, name='unsubscribe_all'),
