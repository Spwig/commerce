        ...
        try:
            ...
            export_data = {
                ...
                'consent': {
                    ...
                    'timestamp': prefs.consent_timestamp.isoformat() if prefs.consent_timestamp else None,
                ...
                'verification': {
                    ...
                    'email_verified_at': prefs.email_verified_at.isoformat() if prefs.email_verified_at else None,
                    'sms_verified': prefs.sms_verified,
                    'sms_verified_at': prefs.sms_verified_at.isoformat() if prefs.sms_verified_at else None,
                },
                # Change history
