...
from admin_api.permissions import IsStaffUser, category_permission
...
def staff_invite(request):
    ...
    try:
        ...
        site_url = site_settings.site_url.rstrip('/') if site_settings and site_settings.site_url else ''
    ...
    return Response({
        ...
        'data': {
            ...
            'is_active': False,
            'is_owner': False,
            'invitation_sent_at': invitation.created_at.isoformat() if invitation.created_at else timezone.now().isoformat(),
            'groups': role_data,
        }
