...
urlpatterns = [
    ...
    path(
        "auth/password-reset/",
        auth.staff_password_reset_request,
        name="staff_password_reset_request",
    ),
    path(
        "auth/password-reset/confirm/",
        auth.staff_password_reset_confirm,
    ...
    path(
        ...
        inventory.inventory_reorder_suggestions,
    ...
    path(
        ...
        inventory.inventory_settings_update,
        name="inventory_settings_update",
    ),
    ...
    path(
        "orders/<str:order_number>/status/", orders.update_order_status, name="update_order_status"
    ),
    ...
    path(
        ...
        documents.order_invoice_pdf,
        name="order_invoice_pdf",
    ),
    path(
        "orders/<str:order_number>/packing-slip/pdf/",
        documents.order_packing_slip_pdf,
        name="order_packing_slip_pdf",
    ),
    path(
        "orders/<str:order_number>/pick-list/pdf/",
        documents.order_pick_list_pdf,
        name="order_pick_list_pdf",
    ),
    ...
    path(
        ...
        products.reorder_product_images,
    ...
    path(
        "products/<int:product_id>/images/<int:image_id>/update/",
    ...
    path(
        "products/<int:product_id>/variants/create/", variants.create_variant, name="create_variant"
    ),
    path(
        "products/<int:product_id>/variants/<int:variant_id>/update/",
        variants.update_variant,
        name="update_variant",
    ),
    path(
        "products/<int:product_id>/variants/<int:variant_id>/delete/",
        variants.delete_variant,
        name="delete_variant",
    ),
    # Product attribute assignment endpoints
    path(
        "products/<int:product_id>/attributes/assign/",
        attributes.assign_product_attributes,
        name="assign_product_attributes",
    ),
    ...
    path(
        "products/bulk/assign-category/",
        bulk_products.bulk_assign_category,
        name="bulk_assign_category",
    ),
    ...
    path(
        "categories/<int:category_id>/update/", categories.update_category, name="update_category"
    ),
    path(
        "categories/<int:category_id>/delete/", categories.delete_category, name="delete_category"
    ),
    # Category image/banner management endpoints
    path(
        "categories/<int:category_id>/image/",
        categories.upload_category_image,
        name="upload_category_image",
    ),
    path(
        "categories/<int:category_id>/image/delete/",
        categories.delete_category_image,
        name="delete_category_image",
    ),
    path(
        "categories/<int:category_id>/banner/",
        categories.upload_category_banner,
        name="upload_category_banner",
    ),
    path(
        "categories/<int:category_id>/banner/delete/",
        categories.delete_category_banner,
        name="delete_category_banner",
    ),
    ...
    path(
        "messages/<str:source>/<int:message_id>/status/",
        messages.update_message_status,
        name="update_message_status",
    ),
    path(
        "messages/contact_form/<int:message_id>/reply/",
    ...
    path(
        "settings/sessions/<str:device_id>/revoke/", settings.revoke_session, name="revoke_session"
    ),
    ...
    path(
        ...
        branding.branding_settings_update,
        name="branding_settings_update",
    ),
