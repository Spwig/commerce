...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.getElementById('reply-composer-form');
        if (!form) return;

        var submitBtn = form.querySelector('[data-action="submit-reply"]');
        ...
        var messageId = form.getAttribute('data-message-id');
        var lang = document.documentElement.lang || 'en';
        var replyUrl = '/' + lang + '/admin/admin_api/customermessage/' + messageId + '/reply/';
        ...
        submitBtn.addEventListener('click', function(e) {
            ...
            var csrfToken = window.AdminUtils
