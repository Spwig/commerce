...
class AuditService:
    ...
    def log_stock_adjustment(
        ...
        return cls.log(
            ...
            old_value={"quantity": old_quantity, "warehouse": warehouse_name},
            new_value={"quantity": new_quantity, "warehouse": warehouse_name, "reason": reason},
            request=request,
        )

    @classmethod
    def log_product_status_change(
        cls, user, product, old_status: str, new_status: str, request: HttpRequest | None = None
    ):
    ...
    def log_logout(
        ...
        return cls.log(
            ...
            old_value={},
            new_value={"device_id": device_id, "logout_all": logout_all},
            request=request,
        )
    ...
    def log_category_change(
        cls, user, action_suffix, category, old_value=None, new_value=None, request=None
    ):
    ...
    @classmethod
    def log_brand_change(
        cls, user, action_suffix, brand, old_value=None, new_value=None, request=None
    ):
    ...
    @classmethod
    def log_variant_change(
        cls, user, action_suffix, variant, old_value=None, new_value=None, request=None
    ):
    ...
    def log_bulk_operation(
        cls, user, action, resource_type, created_count, error_count, request=None
    ):
