...
(function() {
    ...
    var configEl = document.getElementById('tax-rate-config');
    var TAX_FILTER_URL = configEl ? configEl.dataset.filterUrl : '';
    var TAX_PRESET_URL = configEl ? configEl.dataset.presetUrl : '';
    ...
    function updateActiveFilters() {
        ...
        if (search) {
            tags.push('<span class="active-filter-tag">Search: ' + search +
                ' <i class="fas fa-times" data-action="clear-single-filter" data-filter-id="filter-search"></i></span>');
        }
        if (country.value) {
            tags.push('<span class="active-filter-tag">Country: ' + country.options[country.selectedIndex].text +
                ' <i class="fas fa-times" data-action="clear-single-filter" data-filter-id="filter-country"></i></span>');
        }
        if (taxType.value) {
            tags.push('<span class="active-filter-tag">Type: ' + taxType.options[taxType.selectedIndex].text +
                ' <i class="fas fa-times" data-action="clear-single-filter" data-filter-id="filter-tax-type"></i></span>');
        }
        if (status.value) {
            tags.push('<span class="active-filter-tag">Status: ' + status.options[status.selectedIndex].text +
