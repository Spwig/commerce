...
PRESET_RATES = {
    ...
    'us_sales_tax': [
        ...
        ('US', 'United States', 'AK', 'Alaska', Decimal('0.0000'), 'sales_tax', 'No state sales tax; local taxes may apply'),
        ...
        ('US', 'United States', 'DE', 'Delaware', Decimal('0.0000'), 'sales_tax', 'No state sales tax'),
        ...
        ('US', 'United States', 'HI', 'Hawaii', Decimal('0.0400'), 'sales_tax', 'General Excise Tax'),
        ...
        ('US', 'United States', 'LA', 'Louisiana', Decimal('0.0500'), 'sales_tax', 'Raised from 4.45% in January 2025'),
        ...
        ('US', 'United States', 'MT', 'Montana', Decimal('0.0000'), 'sales_tax', 'No state sales tax'),
        ('US', 'United States', 'NE', 'Nebraska', Decimal('0.0550'), 'sales_tax', ''),
        ('US', 'United States', 'NV', 'Nevada', Decimal('0.0460'), 'sales_tax', ''),
        ('US', 'United States', 'NH', 'New Hampshire', Decimal('0.0000'), 'sales_tax', 'No state sales tax'),
        ...
        ('US', 'United States', 'OR', 'Oregon', Decimal('0.0000'), 'sales_tax', 'No state sales tax'),
    ...
    'ca_gst_hst': [
        ...
        ('CA', 'Canada', 'NS', 'Nova Scotia', Decimal('0.1400'), 'gst', 'HST - Reduced from 15% in April 2025'),
    ...
    # ==========================================
    'asia_pacific': [
        ('JP', 'Japan', '', '', Decimal('0.1000'), 'vat', 'Consumption tax; 8% reduced rate on food'),
