...
urlpatterns = [
    ...
    path(
        "elements/config/<str:element_type>/", api_views.get_element_config, name="element_config"
    ),
    ...
    path(
        "page/<int:page_id>/preview/<int:version_id>/",
        api_views.preview_version,
        name="preview_version",
    ),
    path(
        "page/<int:page_id>/publish-history/", api_views.get_publish_history, name="publish_history"
    ),
    # Page Settings API endpoints
    path(
        "page/<int:page_id>/settings/",
        api_views.get_page_settings_config,
        name="page_settings_config",
    ),
    path(
        "page/<int:page_id>/settings/update/",
        api_views.update_page_settings,
        name="update_page_settings",
    ),
    # Preview thumbnail capture
    path(
        "page/<int:page_id>/capture-thumbnail/",
    ...
    path(
        ...
        api_views.RuleGroupAPIView.as_view(),
        name="rule_group_detail",
    ),
    path(
        "rule-groups/<int:group_id>/structure/",
        api_views.save_rule_group_structure,
        name="rule_group_structure",
    ),
