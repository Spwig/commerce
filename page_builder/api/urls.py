...
urlpatterns = [
    ...
    path('translation-health/',
         translation_endpoints.translation_health,
         name='translation_health'),

    path('translate-element/',
         translation_endpoints.translate_element,
         name='translate_element'),

    path('element/<str:element_id>/translation-status/',
         translation_endpoints.element_translation_status,
         name='element_translation_status'),

    path('element/<str:element_id>/save-translations/',
         translation_endpoints.save_element_translations,
         name='save_element_translations'),

    path('element/<str:element_id>/clear-translations/',
         translation_endpoints.clear_element_translations,
         name='clear_translations'),

    path('schedule-page-translation/',
    ...
    path('translation-status/<int:job_id>/',
