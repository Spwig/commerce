...
class RuleBuilderPopup {
    ...
    bindEvents() {
        ...
        // Create new group
        document.getElementById('btnCreateNewGroup')?.addEventListener('click', () => this.createNewGroup());
    ...
    async createNewGroup() {
        const name = await AdminModal.prompt({message: 'Enter group name:', defaultValue: 'New Rule Group'});
        if (!name) return;
