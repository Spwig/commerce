...
class StoreLocator {
    ...
    parseConfig() {
        return {
            ...
            defaultLng: parseFloat(this.element.dataset.defaultLng) || -74.0060,
    ...
    initializeMap() {
        ...
        L.Icon.Default.mergeOptions({
            iconRetinaUrl: (this.element.dataset.leafletImages || '/static/core/vendor/leaflet/images') + '/marker-icon-2x.png',
            iconUrl: (this.element.dataset.leafletImages || '/static/core/vendor/leaflet/images') + '/marker-icon.png',
            shadowUrl: (this.element.dataset.leafletImages || '/static/core/vendor/leaflet/images') + '/marker-shadow.png',
        });
