    ...
    class PBModal {
        ...
        registerTrigger() {
            switch (this.config.trigger) {
                case 'button_click': this.registerButtonTrigger(); break;
                case 'time_delay': this.registerDelayTrigger(); break;
                case 'exit_intent': this.registerExitIntentTrigger(); break;
                case 'scroll_percent': this.registerScrollTrigger(); break;
                case 'page_load': this.open(); break;
            }
        }
        ...
        static get(id) { return PBModal.instances.get(id); }
        static openById(id) { const i = PBModal.get(id); if (i) i.open(); }
        static closeById(id) { const i = PBModal.get(id); if (i) i.close(); }
        static closeAll() { PBModal.instances.forEach(i => i.close()); }
    }
