...
class BlogPostCarousel {
    ...
    init() {
        ...
        window.addEventListener('resize', () => {
            this.currentIndex = Math.min(this.currentIndex, Math.max(0, this.totalSlides - this.getPerView()));
            this.updateCarousel();
        });
    ...
    updateButtons() {
        ...
        if (this.nextBtn) this.nextBtn.disabled = !this.config.infinite && this.currentIndex >= maxIndex;
    }
