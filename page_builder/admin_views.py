...
from .models import Page, PageTemplate, VisibilityRule, RuleGroup, RuleGroupMember
...
def filter_pages(request):
    ...
    html = render_to_string(
        'admin/page_builder/partials/page_cards.html',
...
def rule_builder_view(request, group_id=None):
    ...
    all_groups = RuleGroup.objects.filter(
    ...
    return TemplateResponse(
        request,
        'admin/page_builder/rulegroup/builder.html',
        context
    )
...
def rule_builder_popup_view(request, group_id=None):
    ...
    return TemplateResponse(
        request,
        'admin/page_builder/rulegroup/builder_popup.html',
        context
    )
...
def visibility_rule_wizard_view(request, rule_id=None):
    ...
    return TemplateResponse(
        request,
        'admin/page_builder/visibilityrule/wizard.html',
        context
    )
