...
urlpatterns = [
    ...
    path(
        "visibilityrule/filter/",
        admin_views.filter_visibility_rules,
        name="filter_visibility_rules",
    ),
    path(
        "visibilityrule/<int:rule_id>/toggle-status/",
        admin_views.toggle_visibility_rule_status,
        name="toggle_visibility_rule_status",
    ),
    path(
        "visibilityrule/wizard/",
        admin_views.visibility_rule_wizard_view,
        name="visibility_rule_wizard",
    ),
    path(
        "visibilityrule/wizard/<int:rule_id>/",
        admin_views.visibility_rule_wizard_view,
        name="visibility_rule_wizard_edit",
    ),
    # Rule Group Admin Endpoints
    path("rulegroup/filter/", admin_views.filter_rule_groups, name="filter_rule_groups"),
    path(
        "rulegroup/<int:group_id>/toggle-status/",
        admin_views.toggle_rule_group_status,
        name="toggle_rule_group_status",
    ),
    # Rule Builder Views
    path("rulegroup/builder/", admin_views.rule_builder_view, name="rule_builder"),
    path(
        "rulegroup/builder/<int:group_id>/", admin_views.rule_builder_view, name="rule_builder_edit"
    ),
    path(
        "rulegroup/builder-popup/", admin_views.rule_builder_popup_view, name="rule_builder_popup"
    ),
    path(
        "rulegroup/builder-popup/<int:group_id>/",
        admin_views.rule_builder_popup_view,
        name="rule_builder_popup_edit",
    ),
