...
DEFAULT_RULES = [
    ...
    (
        "User is Logged In",
        "Matches when the visitor is authenticated",
        "user_logged_in",
        "is_true",
        {},
    ),
    (
        "User is Guest",
        "Matches when the visitor is not logged in",
        "user_logged_in",
        "is_false",
        {},
    ),
    (
        ...
        "Matches returning customers who placed at least one order",
        "has_purchased",
        "is_true",
        {},
    ),
    ...
    (
        "Returning Visitor",
        "Matches visitors who have been to the site before",
        "first_visit",
        "is_false",
        {},
    ),
    ...
    (
        "Cart Has Items",
        "Matches when the cart contains at least one item",
        "cart_items",
        "greater_than",
        {"value": 0},
    ),
    ...
    (
        "Has Wishlist Items",
        "Matches visitors with items in their wishlist",
        "wishlist_items",
        "is_true",
        {},
    ),
...
DEFAULT_GROUPS = [
    ...
    (
        "Returning Customers",
        "Show to visitors who have purchased before",
        "AND",
        ["Has Purchased Before"],
    ),
    ...
    (
        "Returning Visitors",
        "Show to visitors who have been here before",
        "AND",
        ["Returning Visitor"],
    ),
