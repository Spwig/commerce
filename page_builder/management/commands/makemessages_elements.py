...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--element", type=str, help="Generate translations for specific element only"
        )
        ...
        parser.add_argument(
            "--all-locales", action="store_true", help="Process all configured locales"
        )

        parser.add_argument(
            "--domain", default="django", help="Translation domain (default: django)"
        )
        ...
        parser.add_argument(
            "--no-location", action="store_true", help="Don't write '#: filename:line' lines."
        )

        parser.add_argument(
            "--keep-pot", action="store_true", help="Keep .pot file after creating .po files."
        )
