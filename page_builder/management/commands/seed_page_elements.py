...
class Command(SeedCommand):
    ...
    def _apply_translations(self, Element):
        ...
        for key, translations in ELEMENT_TRANSLATIONS.items():
            if ":" in key:
                ...
                Element.objects.filter(id__in=page_element_ids, name=element_name).update(
                    translations=translations
                )
            else:
                Element.objects.filter(name=key).update(translations=translations)
    ...
    def _seed_404_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            order=order,
            column_span=12,
            content={"height": 60, "height_unit": "px"},
            is_active=True,
        )
        ...
        Element.objects.create(
            ...
            order=order,
            column_span=12,
            content={"height": 20, "height_unit": "px"},
            is_active=True,
        )
        ...
        Element.objects.create(
            ...
            order=order,
            column_span=12,
            content={"height": 30, "height_unit": "px"},
            is_active=True,
        )
        ...
        Element.objects.create(
            page=page,
            element_type="spacer",
            name="Divider Top Spacer",
            order=order,
            column_span=12,
            content={"height": 40, "height_unit": "px"},
            is_active=True,
        )
        ...
        Element.objects.create(
            ...
            text_align="center",
            content={
                "text": "Or explore our most popular sections:",
                "size": "base",
                "color": "#6b7280",
            },
            is_active=True,
        ...
        Element.objects.create(
            page=page,
            element_type="spacer",
            name="Categories Spacer",
            order=order,
            column_span=12,
            content={"height": 16, "height_unit": "px"},
            is_active=True,
        )
        ...
        cat_container = Element.objects.create(
            page=page,
            element_type="container",
            name="Category Buttons Container",
            order=order,
            column_span=12,
            text_align="center",
            content={
        ...
        for idx, cat in enumerate(category_links, start=1):
            ...
            Element.objects.create(
                page=None,
                parent_element=cat_container,
                element_type="button",
                name=f"{cat['text']} Link",
                order=idx,
                column_span=12,
    ...
    def _seed_about_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            content={
                "title": "Our Story",
                "subtitle": "Building quality products since we first opened our doors",
                "text_align": "center",
            },
            is_active=True,
        )
        ...
        Element.objects.create(
            page=None,
            parent_element=welcome_container,
            element_type="heading",
            name="Welcome Title",
            order=1,
            column_span=12,
            text_align="center",
            content={"text": "Welcome to Our Store", "tag": "h2"},
            is_active=True,
        )
        ...
        Element.objects.create(
            ...
            column_span=12,
            text_align="center",
            content={"text": "What Sets Us Apart", "tag": "h2"},
            is_active=True,
        )
        ...
        features = [
            {
                ...
                "description": "We carefully select every item in our catalog, ensuring it meets our high standards for quality and value.",
            },
            {
                "icon": "fa-truck",
                "title": "Fast Shipping",
                "description": "Quick and reliable delivery to your doorstep. We partner with trusted carriers to ensure your order arrives safely.",
            },
            {
                "icon": "fa-headset",
                "title": "Customer Support",
                "description": "Our friendly team is here to help with any questions or concerns. We believe in building lasting relationships.",
            },
        ]
        ...
        for idx, feature in enumerate(features, start=1):
            ...
            card = Element.objects.create(
                page=None,
                parent_element=features_grid,
                element_type="container",
                name=f"{feature['title']} Card",
                order=idx,
                column_span=12,
                text_align="center",
                content={
            ...
            Element.objects.create(
                ...
                parent_element=card,
                element_type="heading",
                name=f"{feature['title']} Title",
                order=3,
                column_span=12,
                text_align="center",
                content={"text": feature["title"], "tag": "h3"},
                is_active=True,
            )
            count += 1
            Element.objects.create(
                ...
                parent_element=card,
                element_type="text",
                name=f"{feature['title']} Description",
                order=4,
                column_span=12,
                text_align="center",
    ...
    def _seed_contact_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            parent_element=right_col,
            element_type="spacer",
            name="Info Title Spacer",
            order=2,
            column_span=12,
            content={"height": 8, "height_unit": "px"},
            is_active=True,
        )
        ...
        for idx, item in enumerate(contact_items, start=3):
            ...
            Element.objects.create(
                page=None,
                parent_element=info_row,
                element_type="icon",
                name=f"{item['label']} Icon",
                order=1,
                column_span=12,
                content={
                    "icon": item["icon"],
            ...
            Element.objects.create(
                page=None,
                parent_element=text_container,
                element_type="text",
                name=f"{item['label']} Label",
                order=1,
                column_span=12,
                content={"text": item["label"], "size": "sm", "weight": "semibold"},
                is_active=True,
            )
            count += 1
            Element.objects.create(
                ...
                order=2,
                column_span=12,
                content={"text": item["value"], "size": "base"},
                is_active=True,
            )
        ...
        Element.objects.create(
            ...
            order=10,
            column_span=12,
            content={"height": 24, "height_unit": "px"},
            is_active=True,
        )
        ...
        Element.objects.create(
            ...
            parent_element=right_col,
            element_type="spacer",
            name="Social Links Spacer",
            order=12,
            column_span=12,
            content={"height": 12, "height_unit": "px"},
            is_active=True,
        )
    ...
    def _seed_faq_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            order=order,
            column_span=12,
            content={"height": 50, "height_unit": "px"},
            is_active=True,
        )
        ...
        faq_sections = [
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "answer": "Yes! We ship to most countries worldwide. International shipping times vary by destination, typically 7-14 business days. Please note that customs fees may apply.",
                        "is_open": False,
                    },
                ],
            },
                ...
                "items": [
                    {
                        ...
                        "answer": "We offer a 30-day return policy for most items. Products must be unused and in original packaging. Some items like personalized products may not be eligible for return.",
                        "is_open": False,
                    },
                    {
                        "question": "How do I return an item?",
                        "answer": "To initiate a return, log into your account, go to Order History, and select the item you wish to return. Follow the prompts to print a return label and ship the item back to us.",
                        "is_open": False,
                    },
                    {
            ...
            },
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "answer": "Absolutely. We use industry-standard SSL encryption to protect your data. We never store your full credit card details on our servers.",
                        "is_open": False,
                    },
                ],
            },
        ...
        for child_order, section in enumerate(faq_sections, start=1):
            ...
            Element.objects.create(
                page=None,
                parent_element=main_container,
                element_type="faq_accordion",
                name=section["name"],
                order=child_order,
                column_span=12,
                content={
    ...
    def _seed_shipping_elements(self, Page, Element):
        ...
        for idx, opt in enumerate(shipping_options, start=1):
            ...
            card = Element.objects.create(
                page=None,
                parent_element=options_row,
                element_type="container",
                name=f"{opt['title']} Card",
                order=idx,
                column_span=12,
                text_align="center",
                content={
                    ...
                    "custom_styles": "border-radius: 12px;",
                    "layout_initialized": True,
                },
                is_active=True,
            )
            for child_order, (etype, ename, econtent) in enumerate(
                [
                    (
                        "icon",
                        f"{opt['title']} Icon",
                        {"icon": opt["icon"], "icon_style": "solid", "size": 40, "size_unit": "px"},
                    ),
                    ("spacer", f"{opt['title']} Spacer", {"height": 8, "height_unit": "px"}),
                    (
                        "heading",
                        f"{opt['title']} Title",
                        {"text": opt["title"], "tag": "h3", "size": "lg", "weight": "semibold"},
                    ),
                    ("text", f"{opt['title']} Time", {"text": opt["time"], "size": "base"}),
                    (
                        "text",
                        f"{opt['title']} Price",
                        {"text": opt["price"], "size": "lg", "weight": "bold"},
                    ),
                ],
                start=1,
            ):
        ...
        Element.objects.create(
            ...
            content={
                ...
                "items": [
                    {
                        "question": "How long does shipping take?",
                        "answer": "Standard shipping takes 5-7 business days and Express shipping takes 2-3 business days. Delivery times start after your order has been processed (typically 1-2 business days).",
                        "is_open": True,
                    },
                    {
                        "question": "How can I track my order?",
                        "answer": "Once your order ships, you will receive an email with tracking information. You can also track your order by logging into your account and viewing your order history.",
                        "is_open": False,
                    },
                    {
                        "question": "Do you ship internationally?",
                        "answer": "Yes, we ship to most countries worldwide. International shipping typically takes 7-14 business days depending on the destination. Customers are responsible for any customs duties or import taxes.",
                        "is_open": False,
                    },
                    {
                        "question": "What if my package is lost or damaged?",
                        "answer": "If your order hasn't arrived within the estimated delivery window, contact us with your order number. For damaged packages, contact us within 48 hours of delivery with photos of the packaging and damaged items.",
                        "is_open": False,
                    },
                    {
                        "question": "Can I change my shipping address after ordering?",
                        "answer": "Address changes can be made before your order is dispatched. Contact us as soon as possible at support@example.com with your order number and the corrected address.",
                        "is_open": False,
                    },
                    {
                        "question": "Are there any shipping restrictions?",
                        "answer": "Some products may have shipping restrictions due to size, weight, or destination regulations. If your order cannot be shipped to your location, we will contact you to arrange an alternative or provide a refund.",
                        "is_open": False,
                    },
                ],
            },
        ...
        Element.objects.create(
            page=None,
            parent_element=content_container,
            element_type="text",
            name="Intro Text",
            order=1,
            column_span=12,
            content={
                "text": 'This Shipping Policy applies to orders placed through [Store Name] ("we", "us", "our") on [Website URL].',
                "size": "base",
                "line_height": "1.75",
            },
            is_active=True,
    ...
    def _seed_returns_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            content={
                ...
                "items": [
                    {
                        "question": "What is your return policy?",
                        "answer": "We offer a return window of [X] days from delivery. Items must be unused, unworn, and in original condition with packaging and tags. Some items are excluded, including sale/clearance items, gift cards, personalized products, hygiene-sealed items once opened, and perishable goods.",
                        "is_open": True,
                    },
                    {
                        "question": "How do I return an item?",
                        "answer": "1. Contact us at support@example.com with your order number and reason for return.\n2. We will confirm eligibility and provide return instructions.\n3. Send the item to the return address provided.\n4. Keep your tracking number and shipping receipt.",
                        "is_open": False,
                    },
                    {
                        "question": "What if my item arrived damaged or incorrect?",
                        "answer": "Contact us within [X] days of delivery with your order number, a description of the issue, and photos/videos where helpful. You may be entitled to a repair, replacement, or refund as required by law.",
                        "is_open": False,
                    },
                    {
                        "question": "Who pays for return shipping?",
                        "answer": "For change-of-mind returns, the customer pays return shipping unless stated otherwise. For faulty, damaged, or incorrect items, we cover return shipping (or reimburse reasonable costs).",
                        "is_open": False,
                    },
                    {
                        "question": "When will I receive my refund?",
                        "answer": "Refunds are processed to your original payment method within [X] business days after we receive and inspect the return. Your bank or payment provider may take additional time to post the refund. Original shipping fees are not refunded unless required by law.",
                        "is_open": False,
                    },
                    {
                        "question": "Can I exchange an item instead?",
                        "answer": "Yes, we offer exchanges for size, color, or variant within [X] days, subject to stock availability. If the requested item is unavailable, we will issue a refund or store credit.",
                        "is_open": False,
                    },
                    {
                        "question": "Can I cancel my order before it ships?",
                        "answer": "Yes, orders can be cancelled before dispatch by contacting support@example.com as soon as possible. If the order has already shipped, it will be treated as a return subject to this policy.",
                        "is_open": False,
                    },
                ],
            },
        ...
        Element.objects.create(
            ...
            text_align="center",
            content={
                "text": "Full Returns & Refunds Policy",
                "tag": "h2",
                "size": "xl",
                "weight": "semibold",
            },
    ...
    def _seed_home_elements(self, Page, Element):
        ...
        Element.objects.create(
            page=page,
            element_type="category_showcase",
    ...
    def _seed_maintenance_elements(self, Page, Element):
        ...
        Element.objects.create(
            ...
            content={
                ...
                "hover_animation_timing": "ease-out",
            },
            is_active=True,
        )
    ...
    def _privacy_sections(self):
        ...
        return [
            ...
            },
            {
                ...
                "content": "We use cookies and similar technologies to operate the Site, remember your preferences, and analyze usage. You can manage your cookie preferences through your browser settings or our cookie preference center.\n\nFor full details on the cookies we use and how to control them, please see our Cookie Policy.",
            },
            {
                "title": "9) Marketing communications",
                "content": "With your consent, we may send you promotional emails about products, offers, and news. You can opt out at any time by:\n\n\u2022 Clicking the \u201cunsubscribe\u201d link in any marketing email\n\u2022 Updating your communication preferences in your account settings\n\u2022 Contacting us directly\n\nOpting out of marketing communications will not affect transactional messages related to your orders.",
            },
            {
            ...
            },
            {
                ...
                "content": "Your information may be transferred to and processed in countries other than your own. These countries may have data protection laws that differ from those in your jurisdiction.\n\nWhere we transfer data internationally, we take steps to ensure appropriate safeguards are in place to protect your information in accordance with applicable data protection laws.",
            },
            {
                "title": "12) Third-party links",
                "content": "Our Site may contain links to third-party websites, services, or social media platforms. We are not responsible for the privacy practices or content of these external sites.\n\nWe encourage you to review the privacy policies of any third-party sites you visit before providing any personal information.",
            },
            {
                "title": "13) Changes to this Privacy Policy",
                "content": "We may update this Privacy Policy from time to time to reflect changes in our practices, legal requirements, or for other reasons. The \u201cLast updated\u201d date at the top of this page indicates when changes were last made.\n\nWe encourage you to review this page periodically. Continued use of the Site after changes are posted constitutes your acceptance of the updated policy.",
            },
            {
                "title": "14) Contact",
    ...
    def _terms_sections(self):
        ...
        return [
            ...
            },
            {
                ...
                "content": "All content on this Site \u2014 including text, graphics, logos, images, product descriptions, and software \u2014 is the property of [Store Name] or its licensors and is protected by copyright, trademark, and other intellectual property laws.\n\nYou may not reproduce, distribute, modify, create derivative works from, or publicly display any content from this Site without our prior written consent.",
            },
            {
                "title": "9) User content",
                "content": "By submitting content to the Site (such as product reviews, comments, or other feedback), you grant us a non-exclusive, royalty-free, perpetual, and worldwide license to use, reproduce, modify, and display that content in connection with operating the Site.\n\nYou are responsible for the content you submit and agree that it will not:\n\n\u2022 Violate any third-party rights\n\u2022 Contain defamatory, obscene, or offensive material\n\u2022 Contain spam, advertising, or solicitations\n\u2022 Contain false or misleading statements",
            },
            {
                "title": "10) Disclaimer of warranties",
                "content": "The Site and all products and services are provided on an \u201cas is\u201d and \u201cas available\u201d basis without warranties of any kind, whether express or implied.\n\nWe do not warrant that:\n\n\u2022 The Site will be uninterrupted, secure, or error-free\n\u2022 Results obtained from the Site will be accurate or reliable\n\u2022 The quality of any products or services will meet your expectations\n\nThis disclaimer does not affect your statutory rights as a consumer.",
            },
            {
                "title": "11) Limitation of liability",
                "content": "To the fullest extent permitted by law, [Store Name] shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:\n\n\u2022 Your use of or inability to use the Site\n\u2022 Any products purchased through the Site\n\u2022 Unauthorized access to or alteration of your data\n\u2022 Any interruption or cessation of service\n\u2022 Any bugs, viruses, or other harmful code transmitted through the Site\n\nOur total liability to you for any claim arising from or related to these Terms shall not exceed the amount you paid for the relevant product or service.",
            },
            {
                "title": "12) Indemnification",
                "content": "You agree to indemnify, defend, and hold harmless [Store Name], its officers, directors, employees, and agents from any claims, damages, losses, liabilities, or expenses (including legal fees) arising from your use of the Site, your violation of these Terms, or your violation of any rights of a third party.",
            },
            {
                "title": "13) Third-party links",
                "content": "The Site may contain links to third-party websites or services that are not owned or controlled by us. We have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites.\n\nWe encourage you to review the terms and privacy policies of any third-party sites you visit.",
            },
            {
                "title": "14) Governing law",
                "content": "These Terms shall be governed by and construed in accordance with the laws of [Jurisdiction]. Any disputes arising from these Terms or your use of the Site shall be subject to the exclusive jurisdiction of the courts in [Jurisdiction].\n\nIf any provision of these Terms is found to be unenforceable, the remaining provisions shall continue in full force and effect.",
            },
            {
                "title": "15) Changes to these Terms",
                "content": "We may update these Terms from time to time to reflect changes in our practices, legal requirements, or for other reasons. The \u201cLast updated\u201d date at the top of this page indicates when changes were last made.\n\nContinued use of the Site after changes are posted constitutes your acceptance of the revised Terms. We encourage you to review this page periodically.",
            },
            {
                "title": "16) Contact",
                "content": "If you have questions about these Terms of Use, contact:\n[Store Name]\nEmail: support@example.com\nAddress: [Business Address]",
            },
        ]
    ...
    def _cookie_sections(self):
        ...
        return [
            ...
            },
            {
                ...
                "content": "Some browsers offer \u201cDo Not Track\u201d (DNT) signals. Because there is no consistent industry standard for DNT, our response to DNT signals may vary. Please refer to our Privacy Policy for more details on how we handle tracking preferences.",
            },
            {
                "title": "8) Updates to this Cookie Policy",
                "content": "We may update this policy from time to time to reflect changes in our practices or for legal/regulatory reasons. The \u201cLast updated\u201d date at the top of this page indicates when changes were last made.",
            },
            {
                "title": "9) Contact",
                "content": "If you have questions about this Cookie Policy, contact:\n[Store Name]\nEmail: support@example.com\nAddress: [Business Address]",
            },
        ]
        ...
        return [
            {
                ...
                "content": "If you change your mind, you may request a return within [X] days of delivery, provided that:\n\n\u2022 the item is unused, unworn, and in original condition\n\u2022 it includes original packaging, tags, manuals, and accessories (if applicable)\n\u2022 you can provide proof of purchase (order number / receipt)\n\nNot eligible for change-of-mind returns:\n\n\u2022 sale/clearance items (unless required by law)\n\u2022 gift cards / digital products\n\u2022 personalized or made-to-order items\n\u2022 items sealed for hygiene reasons once opened (e.g., cosmetics, underwear)\n\u2022 perishable goods",
            },
            {
                "title": "2) Faulty, damaged, or incorrect items",
                "content": "If your item is faulty, damaged, or not what you ordered, contact us within [X] days of delivery with:\n\n\u2022 your order number\n\u2022 a description of the issue\n\u2022 photos/videos where helpful\n\nWhere required by law, you may be entitled to a repair, replacement, or refund.",
            },
            {
                "title": "3) Return window",
                "content": "Returns must be requested within [X] days of delivery and shipped back within [X] days after approval.",
            },
            {
                "title": "4) How to request a return",
                "content": "1. Contact us at support@example.com with your order number and reason for return.\n2. We will confirm eligibility and provide return instructions and (if applicable) a return authorization.\n3. Send the item to: [Return Address]\n4. Keep your tracking number and shipping receipt.",
            },
            {
                "title": "5) Return shipping costs",
                "content": "\u2022 Change of mind: customer pays return shipping unless stated otherwise.\n\u2022 Faulty/damaged/incorrect: we cover return shipping (or reimburse reasonable costs) where applicable.\n\u2022 If you choose a shipping method without tracking/insurance, returns are sent at your risk.",
            },
            {
                "title": "6) Condition checks and restocking fees",
                "content": "We inspect all returns. If the item is not returned in original condition, we may:\n\n\u2022 refuse the return, or\n\u2022 issue a partial refund reflecting loss in value",
            },
            {
                "title": "7) Refunds",
                "content": "If approved, refunds are processed to the original payment method:\n\n\u2022 Processing time: [X] business days after we receive and inspect the return\n\u2022 Banks/payment providers may take additional time to post the refund\n\nOriginal shipping fees are not refunded unless required by law.",
            },
            {
                "title": "8) Exchanges",
                "content": "We offer exchanges for size/color/variant within [X] days, subject to stock availability.\n\nIf the requested exchange item is unavailable, we will issue a refund or store credit (as selected).",
            },
            {
                "title": "9) Cancellations (before dispatch)",
                "content": "Orders can be cancelled before dispatch by contacting support@example.com as soon as possible. If the order has already shipped, it will be treated as a return (subject to this policy).",
            },
            {
                "title": "10) Gifts",
                "content": "If the item was marked as a gift:\n\n\u2022 refunds may be issued as store credit to the gift recipient, or\n\u2022 refunded to the original purchaser (depending on circumstances and local law)",
            },
            {
                "title": "11) Digital products and services",
                "content": "Unless required by law, digital products, downloads, and online services are non-refundable once delivered or accessed.",
            },
            {
                "title": "12) Local law and consumer rights",
                "content": "This policy is intended to comply with applicable consumer protection laws. Where local laws provide mandatory rights (e.g., for faulty goods), those rights are not limited by this policy.",
            },
            {
                "title": "13) Contact",
