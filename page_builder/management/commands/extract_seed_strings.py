...
SEEDED_PAGE_SLUGS = [
    '404', '500', 'about', 'contact', 'faq',
    'privacy-policy', 'terms-of-use', 'cookie-policy',
    'shipping-info', 'returns-policy', 'home', 'maintenance',
]

# Content fields that contain translatable text
TRANSLATABLE_FIELDS = {
    'text', 'title', 'subtitle', 'description',
    'button_text', 'cta_text', 'placeholder', 'success_message',
    'view_all_text',
}
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        target_languages = [
            code for code, _name in settings.LANGUAGES if code != 'en'
        ]
        ...
        for slug in SEEDED_PAGE_SLUGS:
            ...
            for element in elements:
                ...
                if element.translations:
                    element_data['existing_translations'] = list(
                        element.translations.keys()
                    )
