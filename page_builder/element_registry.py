...
class ElementRegistry:
    ...
    def __init__(self):
        ...
        self._loaded = False
        self._base_properties: dict[str, Any] | None = None

    def _load_base_properties(self) -> dict[str, Any] | None:
    ...
    def _merge_with_base(self, element_config: dict[str, Any]) -> dict[str, Any]:
        ...
        for _tab_key, tab_config in base_tabs.items():
        ...
        sorted_tabs = dict(sorted(merged_tabs.items(), key=lambda x: x[1].get("order", 999)))
    ...
    def discover_elements(self, force_reload: bool = False) -> None:
        ...
        elements_dir = (
            Path(settings.BASE_DIR) / "page_builder" / "templates" / "page_builder" / "elements"
        )
    ...
    def get_elements_for_visual_builder(self) -> dict[str, Any]:
        ...
        for category, element_types in self._categories.items():
            ...
            if category_elements:
                categories[category] = {"name": category.title(), "elements": category_elements}
    ...
    def get_element_metadata(self) -> dict[str, Any]:
        ...
        return {
            etype: {
                ...
                "defaults": el.config_data.get("defaults", {})
...
def get_element(element_type: str) -> ElementConfig | None:
