...
class ShopDashboardAdmin(admin.ModelAdmin):
    ...
    def shop_dashboard_view(self, request):
        ...
        profit_metrics = ShopAnalyticsService.get_profit_metrics(start_date, end_date, compare)
        ...
        traffic_source_analytics = ShopAnalyticsService.get_traffic_source_analytics(
            start_date, end_date
        )
        ...
        top_products = ShopAnalyticsService.get_top_products(start_date, end_date, limit=10)
        ...
        referrer_stats = ShopAnalyticsService.get_referrer_stats(start_date, end_date, limit=10)
    ...
    def shop_dashboard_api(self, request):
        ...
        traffic_source_analytics_api = ShopAnalyticsService.get_traffic_source_analytics(
            start_date, end_date
        )
        sales_over_time = ShopAnalyticsService.get_sales_over_time(
            start_date, end_date, compare, grouping
