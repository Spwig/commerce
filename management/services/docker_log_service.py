...
class DockerLogService:
    ...
    def get_redis_client(self):
        ...
        if self._redis_client is None:
            ...
            redis_location = settings.CACHES.get('default', {}).get('LOCATION', 'redis://redis:6379/1')
            if '://' in redis_location:
                ...
                self._redis_client = redis_lib.Redis(host=host, port=port, db=1, decode_responses=True)
    ...
    def parse_log_line(self, line: str, container_type: str) -> Optional[Dict]:
    ...
    def get_log_stats(self) -> Dict:
        ...
        for container in self.CONTAINER_SERVICES.keys():
        ...
        for container in self.CONTAINER_SERVICES.keys():
            ...
            while len(entries_to_create) < batch_size:
                ...
                try:
                    ...
                    entries_to_create.append(LogEntry(
