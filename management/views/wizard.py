...
def storage_destinations_view(request):
    ...
    return render(request, 'admin/management/storage_destinations.html', {
...
def delete_destination_view(request, destination_id):
    ...
    return render(request, 'admin/management/storage_destination_delete.html', {
