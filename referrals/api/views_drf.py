...
from referrals.services import track_click, set_ref_cookie
...
@extend_schema_view(
    ...
    partial_update=extend_schema(tags=['Referrals'], summary=_("Partially update referral program")),
...
class ReferralProgramViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        stats = {
            ...
            'average_risk_score': attributions.exclude(
...
@extend_schema_view(
    ...
    partial_update=extend_schema(tags=['Referrals'], summary=_("Partially update referral identity")),
