...
class ReferralDashboardViewTest(TestCase):
    ...
    def test_dashboard_post_updates_program(self):
        ...
        response = self.client.post(reverse('referrals:dashboard'), {
...
class ApproveAttributionViewTest(TestCase):
    ...
    def test_requires_post(self):
        ...
        response = self.client.get(
            reverse('referrals:approve_attribution', args=[attribution.pk])
        )
...
class IssueRewardViewTest(TestCase):
    ...
    def test_requires_post(self):
        ...
        response = self.client.get(
            reverse('referrals:issue_reward', args=[reward.pk])
        )
...
class RevokeRewardViewTest(TestCase):
    ...
    def test_requires_post(self):
        ...
        response = self.client.get(
            reverse('referrals:revoke_reward', args=[reward.pk])
        )
