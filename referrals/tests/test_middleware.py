...
class MiddlewareIntegrationTest(TestCase):
    ...
    def setUp(self):
        self.program = create_referral_program()
        self.factory = RequestFactory()
        self.tracking_middleware = ReferralTrackingMiddleware(get_response=lambda r: HttpResponse())
        self.context_middleware = RequestContextMiddleware(get_response=lambda r: HttpResponse())
