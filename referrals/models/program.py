...
class ReferralProgram(models.Model):
    ...
    reward_config = models.JSONField(
        ...
        help_text=_('Reward types, amounts, and double-sided settings. Example: {"referrer": {"kind": "credit", "amount": 10}, "referee": {"kind": "discount", "amount": 10}}')
    )
    ...
    def get_program(cls):
        ...
        program, created = cls.objects.get_or_create(
            ...
            defaults={
                ...
                'status': 'draft',
                'reward_config': {
                    'referrer': {'kind': 'credit', 'amount': 10, 'currency': get_default_currency()},
                    'referee': {'kind': 'discount', 'amount': 10, 'currency': get_default_currency()},
                    'double_sided': True,
                },
                'eligibility_rules': {
    ...
    def delete(self, *args, **kwargs):
        ...
        raise ValidationError(_('Cannot delete the referral program. Set status to "Paused" instead.'))
