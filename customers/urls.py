...
urlpatterns = [
    ...
    path('dashboard/',
         views.CustomerDashboardViewSet.as_view({'get': 'list'}),
         name='dashboard'),
    path('stats/',
         views.CustomerDashboardViewSet.as_view({'get': 'stats'}),
         name='stats'),
    path('insights/',
         views.CustomerDashboardViewSet.as_view({'get': 'insights'}),
         name='insights'),
    ...
    path('loyalty-status/',
         ...
         name='loyalty-status'),
    path('savings/',
         views.CustomerAnalyticsViewSet.as_view({'get': 'savings'}),
         name='savings'),
    ...
    path('admin/addresses/<int:address_id>/set-default/',
