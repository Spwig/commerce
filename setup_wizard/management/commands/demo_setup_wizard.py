...
class Command(BaseCommand):
    ...
    def reset_setup(self):
        ...
        SetupProgress.get_progress()

        self.stdout.write(self.style.SUCCESS("✅ Setup progress reset successfully!"))
        self.show_status()
    ...
    def complete_step(self, step_key):
        ...
        if hasattr(progress, step_key):
            ...
            progress.save()
            self.stdout.write(self.style.SUCCESS(f"✅ Marked {step_key} as completed!"))
            self.show_status()
        else:
            self.stdout.write(self.style.ERROR(f"❌ Unknown step: {step_key}"))
    ...
    def show_help(self):
        ...
        self.stdout.write(
            "  python manage.py demo_setup_wizard --complete-step site_info_completed"
        )
