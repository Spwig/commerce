...
class SiteInfoForm(forms.Form):
    ...
    site_name = forms.CharField(
        max_length=100,
        required=True,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "My Awesome Store"}),
    ...
    site_url = forms.URLField(
        ...
        widget=forms.URLInput(
            attrs={"class": "form-control", "placeholder": "https://yourstore.com"}
        ),
    ...
    favicon = forms.ImageField(
        ...
        help_text=_(
            "Upload a favicon for your site (recommended: 32x32 or 16x16 pixels, ICO, PNG, or SVG format)"
        ),
    )
...
class ContactInfoForm(forms.Form):
    ...
    admin_email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "admin@yourstore.com"}
        ),
    ...
    support_email = forms.EmailField(
        ...
        validators=[EmailValidator()],
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "support@yourstore.com"}
        ),
...
class BusinessAddressForm(forms.Form):
    ...
    address_line_2 = forms.CharField(
        max_length=255,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Suite 100"}),
    ...
    city = forms.CharField(
        max_length=100,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "New York"}),
        help_text=_("City"),
    )
    ...
    state_province = forms.CharField(
        max_length=100,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "NY"}),
    ...
    country = forms.CharField(
        max_length=100,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "United States"}),
        help_text=_("Country"),
    )
...
class EcommerceSettingsForm(forms.Form):
    ...
    enable_error_reporting = forms.BooleanField(
        ...
        help_text=_(
            "Send anonymized error reports to help us improve the platform. No personal data is ever transmitted. You can change this anytime in Site Settings."
        ),
    )
...
class SocialMediaForm(forms.Form):
    ...
    facebook_url = forms.URLField(
        required=False,
        widget=forms.URLInput(
            attrs={"class": "form-control", "placeholder": "https://facebook.com/yourstore"}
        ),
    ...
    twitter_url = forms.URLField(
        required=False,
        widget=forms.URLInput(
            attrs={"class": "form-control", "placeholder": "https://twitter.com/yourstore"}
        ),
    ...
    instagram_url = forms.URLField(
        required=False,
        widget=forms.URLInput(
            attrs={"class": "form-control", "placeholder": "https://instagram.com/yourstore"}
        ),
    ...
    linkedin_url = forms.URLField(
        required=False,
        widget=forms.URLInput(
            attrs={"class": "form-control", "placeholder": "https://linkedin.com/company/yourstore"}
        ),
