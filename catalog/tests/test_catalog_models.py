...
from catalog.models import Category, CustomizationOption, CustomizationValue, Product
...
class CustomizationOptionModelTest(TestCase):
    ...
    def test_auto_slug_generation(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Wood Type Selection", option_type="select"
        )
    ...
    def test_validate_value_text_required(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Name", option_type="text", is_required=True, max_length=20
        )
    ...
    def test_validate_value_color(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Thread Color", option_type="color"
        )
    ...
    def test_calculate_price_free(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Gift Message", option_type="textarea", pricing_type="free"
        )
    ...
    def test_sort_order(self):
        ...
        opt1 = CustomizationOption.objects.create(
            product=self.product, name="Option 3", option_type="text", sort_order=30
        )
        opt2 = CustomizationOption.objects.create(
            product=self.product, name="Option 1", option_type="text", sort_order=10
        )
        opt3 = CustomizationOption.objects.create(
            product=self.product, name="Option 2", option_type="text", sort_order=20
        )
...
class CustomizationValueModelTest(TestCase):
    ...
    def test_create_text_customization_value(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Engraving Text", option_type="text"
        )
    ...
    def test_get_display_value_text(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Name", option_type="text"
        )

        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, text_value="John Doe"
        )
    ...
    def test_get_display_value_number(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Quantity", option_type="number"
        )

        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, number_value=Decimal("42.5")
        )
    ...
    def test_get_display_value_select(self):
        ...
        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, choice_value="oak"
        )
    ...
    def test_get_display_value_color(self):
        ...
        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, choice_value="#FF5733"
        )
    ...
    def test_get_value_for_export_text(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Message", option_type="textarea"
        )
    ...
    def test_get_value_for_export_number(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Width", option_type="number"
        )

        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, number_value=Decimal("48.50")
        )
    ...
    def test_get_value_for_export_select(self):
        ...
        value = CustomizationValue.objects.create(
            order_item=self.order_item, customization_option=option, choice_value="cotton"
        )
    ...
    def test_str_representation(self):
        ...
        option = CustomizationOption.objects.create(
            product=self.product, name="Engraving", option_type="text"
        )
...
class ProductCustomizationIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name="Custom Furniture", slug="custom-furniture")
...
class CustomizationAPITest(TestCase):
    ...
    def test_validate_customizations_success(self):
        ...
        self.assertEqual(
            Decimal(validated[str(self.text_option.id)]["calculated_price"]), Decimal("5.00")
        )

        # Check gold thread price (price_modifier = 5)
        self.assertEqual(
            Decimal(validated[str(self.color_option.id)]["calculated_price"]), Decimal("5.00")
        )

        # Check total customization price ($5 text + $5 gold = $10)
        self.assertEqual(
            Decimal(response.data["total_customization_price"]["amount"]), Decimal("10.00")
        )

        # Check total product price ($25 base + $10 customizations = $35)
        self.assertEqual(Decimal(response.data["total_product_price"]["amount"]), Decimal("35.00"))

    def test_validate_customizations_missing_required(self):
        """Test validation fails when required customization is missing"""
        url = f"/api/catalog/products/{self.product.slug}/validate_customizations/"
        data = {"customizations": {str(self.color_option.id): "red"}}
        response = self.client.post(url, data, format="json")
    ...
    def test_validate_customizations_invalid_value(self):
        ...
        data = {
            "customizations": {
                str(
                    self.text_option.id
                ): "This is a very long name that exceeds the twenty character limit",
    ...
    def test_validate_customizations_non_customizable_product(self):
        ...
        data = {"customizations": {"some_option": "some_value"}}
        response = self.client.post(url, data, format="json")
