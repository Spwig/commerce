...
from catalog.models import Category, CustomizationOption, Product
...
class CustomizationOptionsAPITest(APITestCase):
    ...
    def test_get_customization_options_success(self):
        ...
        url = reverse(
            "catalog_api:product-customization-options", kwargs={"slug": self.product.slug}
        )
    ...
    def test_get_customization_options_non_customizable(self):
        ...
        url = reverse(
            "catalog_api:product-customization-options", kwargs={"slug": self.standard_product.slug}
        )
        response = self.client.get(url)
...
class ValidateCustomizationsAPITest(APITestCase):
    ...
    def test_validate_customizations_success(self):
        ...
        url = reverse(
            "catalog_api:product-validate-customizations", kwargs={"slug": self.product.slug}
        )
        data = {
            "customizations": {
        ...
        self.assertEqual(
            Decimal(response.data["total_customization_price"]["amount"]), Decimal("30.00")
        )
    ...
    def test_validate_customizations_optional_only(self):
        ...
        data = {"customizations": {str(self.wood_option.id): "oak"}}
        ...
        self.assertEqual(
            Decimal(response.data["total_customization_price"]["amount"]), Decimal("0.00")
        )
    ...
    def test_validate_customizations_missing_required(self):
        ...
        data = {"customizations": {str(self.text_option.id): "John"}}
    ...
    def test_validate_customizations_text_too_long(self):
        ...
        long_text = "A" * 51
        data = {
            "customizations": {str(self.text_option.id): long_text, str(self.wood_option.id): "oak"}
        }
    ...
    def test_validate_customizations_non_customizable_product(self):
        ...
        url = reverse(
            "catalog_api:product-validate-customizations",
            kwargs={"slug": self.standard_product.slug},
        )
        data = {"customizations": {}}
    ...
    def test_validate_customizations_complex_pricing(self):
        ...
        self.assertEqual(
            Decimal(response.data["total_customization_price"]["amount"]), Decimal("56.00")
        )
