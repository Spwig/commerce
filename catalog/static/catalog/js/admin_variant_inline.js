...
(function() {
        ...
        const observer = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                mutation.addedNodes.forEach(function(node) {
                    if (node.nodeType === 1 && node.classList && node.classList.contains('variant-inline-item')) {
    ...
    function initializeVariantStockManagement() {
        ...
        console.log(`[Variants] Initializing stock management for ${stockInputs.length} stock input(s)`);
