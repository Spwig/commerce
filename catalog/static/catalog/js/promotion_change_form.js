...
(function () {
    ...
    var t = {};
    (function () {
        var el = document.getElementById('promotion-change-form-i18n');
        if (el) {
            try {
    ...
    class PromotionSelector {
        ...
        moveSelectedItems() {
            const selectedItems = Array.from(this.availableList.querySelectorAll('.selector-item.selected'));
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateReview() {
            ...
            document.getElementById('review-discount-type').textContent = discountTypeLabels[discountType] || '-';
            ...
            const startDate = document.getElementById('id_start_date').value;
            document.getElementById('review-start-date').textContent = startDate ? new Date(startDate).toLocaleDateString() : '-';

            const endDate = document.getElementById('id_end_date').value;
            document.getElementById('review-end-date').textContent = endDate ? new Date(endDate).toLocaleDateString() : t.noEndDate;
