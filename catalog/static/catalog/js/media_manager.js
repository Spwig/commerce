    ...
    setupDeleteButtons() {
        this.imagesGrid.querySelectorAll('.image-card-delete').forEach(btn => {
            btn.addEventListener('click', async (e) => {
                ...
                if (await AdminModal.confirm({message: 'Are you sure you want to remove this image?', danger: true, confirmText: 'Remove'})) {
                    card.remove();
                    this.updateImagePositions();
            ...
            toggle.addEventListener('change', (e) => {
                if (e.target.checked) {
                    ...
                    if (!header.querySelector('.primary-badge')) {
                        ...
                        dragHandle.insertAdjacentHTML('afterend', '<span class="primary-badge"><i class="fas fa-star"></i> Primary</span>');
                    }
                } else {
