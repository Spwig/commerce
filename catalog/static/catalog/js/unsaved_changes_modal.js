...
(function() {
    ...
    var STORAGE_KEY = 'product_editor_redirect';
    var pendingUrl = null;
    var overlay = document.getElementById('unsaved-changes-modal');
    var form = document.getElementById('product-form');

    // On page load, check if we need to redirect after a save
    var redirectUrl = sessionStorage.getItem(STORAGE_KEY);
    if (redirectUrl) {
    ...
    var cancelBtn = document.getElementById('unsaved-modal-cancel');
    var closeBtn = document.getElementById('unsaved-modal-close');
    ...
    var saveBtn = document.getElementById('unsaved-modal-save');
    if (saveBtn) {
