    ...
    try:
        ...
        for img in images:
            ...
            if img.media_asset:
                ...
                thumbnails = img.media_asset.thumbnails.all() if hasattr(img.media_asset, 'thumbnails') else []
                if thumbnails:
                    # Use first thumbnail
                    data['thumbnail_url'] = thumbnails[0].file.url if thumbnails[0].file else data['url']
                else:
