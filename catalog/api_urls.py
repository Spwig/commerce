...
from .api import booking_endpoints, image_endpoints, translation_endpoints
...
urlpatterns = [
    ...
    path(
        "products/<slug:product_slug>/check-stock/",
        api_views.check_warehouse_stock,
    ...
    path(
        "products/<slug:product_slug>/availability/",
        api_views.product_availability,
        name="product-availability",
    ),
    path(
        "products/<slug:product_slug>/notify-me/",
        api_views.stock_notification_subscribe,
        name="stock-notification-subscribe",
    ),
    # Gift card endpoints
    path(
        "gift-cards/check-balance/",
        api_views.check_gift_card_balance,
        name="gift-card-check-balance",
    ),
    ...
    path(
        "license-pools/<int:pool_id>/",
        license_api_views.get_license_pool,
        name="license-pool-detail",
    ),
    path(
        "licenses/bulk-generate/",
        license_api_views.bulk_generate_licenses,
        name="license-bulk-generate",
    ),
    # Product translation endpoints
    path(
        "products/<int:product_id>/translations/",
        translation_endpoints.get_product_translations,
        name="product-translations",
    ),
    path(
        "products/<int:product_id>/translations/save/",
        translation_endpoints.save_product_translation,
        name="product-translation-save",
    ),
    path(
        "products/<int:product_id>/translations/save-all/",
    ...
    path(
        "products/<int:product_id>/attribute-assignments/",
        api_views.list_product_attributes,
        name="product-attributes-list",
    ),
    path(
        "products/<int:product_id>/attribute-assignments/add/",
        api_views.add_product_attribute,
        name="product-attribute-add",
    ),
    path(
        "products/<int:product_id>/attribute-assignments/<int:assignment_id>/remove/",
        api_views.remove_product_attribute,
        name="product-attribute-remove",
    ),
    path(
        "products/<int:product_id>/attribute-assignments/<int:assignment_id>/values/",
        api_views.update_attribute_values,
        name="product-attribute-values-update",
    ),
    path(
        "products/<int:product_id>/attribute-assignments/search/",
        api_views.search_available_attributes,
        name="product-attributes-search",
    ),
    # Booking endpoints
    path(
        "products/<slug:product_slug>/booking/availability/",
        booking_endpoints.booking_availability,
        name="booking-availability",
    ),
    path(
        "products/<slug:product_slug>/booking/slots/",
        booking_endpoints.booking_slots,
        name="booking-slots",
    ),
    path(
        "products/<slug:product_slug>/booking/check/",
        booking_endpoints.booking_check,
        name="booking-check",
    ),
    path(
        "products/<slug:product_slug>/booking/resource-availability/",
        booking_endpoints.booking_resource_availability,
        name="booking-resource-availability",
    ),
    path(
        "products/<slug:product_slug>/booking/resources/<int:resource_id>/",
        booking_endpoints.booking_resource_detail,
        name="booking-resource-detail",
    ),
    path(
        "products/<slug:product_slug>/booking/ical/<str:ical_uid>/",
        booking_endpoints.booking_ical,
        name="booking-ical",
    ),
    path(
        "products/<slug:product_slug>/booking/waitlist/",
        booking_endpoints.booking_waitlist,
        name="booking-waitlist",
    ),
    # Customer booking self-service (authenticated)
    path("bookings/my/", booking_endpoints.my_bookings, name="my-bookings"),
    path(
    ...
    path(
        "bookings/<int:booking_id>/cancel/", booking_endpoints.booking_cancel, name="booking-cancel"
    ),
    path(
