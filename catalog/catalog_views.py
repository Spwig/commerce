...
from .models import Category, Promotion, LicenseKey, Product, LicensePool, ExternalLicenseSync, DigitalAsset
...
def filter_categories(request):
    ...
    if has_products == 'yes':
        categories = categories.annotate(products_count=Count('products')).filter(products_count__gt=0)
    ...
    if has_subcategories == 'yes':
        categories = categories.annotate(children_count=Count('children')).filter(children_count__gt=0)
    ...
    html = render_to_string('admin/catalog/partials/category_cards.html', {
...
def filter_promotions(request):
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/partials/promotion_cards.html', {
...
def filter_license_keys(request):
    ...
    licenses = LicenseKey.objects.select_related(
        ...
        'user', 'order_item', 'order_item__order'
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/licensekey/partials/license_cards.html', {
...
def filter_license_pools(request):
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/licensepool/partials/pool_cards.html', {
...
def filter_external_sync(request):
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/externallicensesync/partials/sync_cards.html', {
...
def filter_digital_assets(request):
    ...
    assets = DigitalAsset.objects.select_related(
        'product', 'created_by'
    )
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/digitalasset/partials/asset_cards.html', {
...
def filter_products(request):
    ...
    products = Product.objects.select_related('category', 'brand').prefetch_related('digital_assets')
    ...
    # Render results as HTML
    html = render_to_string('admin/catalog/product/partials/product_cards.html', {
