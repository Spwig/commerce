...
from catalog import views, admin_views
...
urlpatterns = [
    ...
    path('giftcardtransaction/filter/', admin_views.filter_gift_card_transactions, name='filter_gift_card_transactions'),
    ...
    path(
        'quick-add-attribute/',
        admin_views.quick_add_attribute,
        name='quick_add_attribute'
    ),
    ...
    path(
        'product/<int:product_id>/variants/list/',
        admin_views.list_variants,
        name='list_variants'
    ),
    path(
    ...
    path(
        'variant/<int:variant_id>/detail/',
        admin_views.variant_detail,
        name='variant_detail'
    ),
    path(
        'variant/<int:variant_id>/update/',
        admin_views.update_variant,
        name='update_variant'
    ),
    path(
    ...
    path(
        'slot/<int:slot_id>/options/',
        admin_views.slot_options_manager,
        name='slot_options_manager'
    ),
    path(
    ...
    path(
        'product/<int:product_id>/slots/list/',
        admin_views.list_slots,
        name='list_slots'
    ),
    path(
        'product/<int:product_id>/slots/create/',
        admin_views.create_slot,
        name='create_slot'
    ),
    path(
        'slot/<int:slot_id>/detail/',
        admin_views.slot_detail,
        name='slot_detail'
    ),
    path(
        'slot/<int:slot_id>/update/',
        admin_views.update_slot,
        name='update_slot'
    ),
    path(
        'slot/<int:slot_id>/delete/',
        admin_views.delete_slot,
        name='delete_slot'
    ),

    # Configuration Preset AJAX CRUD
    path(
        'product/<int:product_id>/presets/list/',
        admin_views.list_presets,
        name='list_presets'
    ),
    path(
        'product/<int:product_id>/presets/create/',
        admin_views.create_preset,
        name='create_preset'
    ),
    path(
        'preset/<int:preset_id>/detail/',
        admin_views.preset_detail,
        name='preset_detail'
    ),
    path(
        'preset/<int:preset_id>/update/',
        admin_views.update_preset,
        name='update_preset'
    ),
    path(
        'preset/<int:preset_id>/delete/',
        admin_views.delete_preset,
        name='delete_preset'
    ),
    # Product Recycle Bin
    path(
        'product/recycle-bin/',
        admin_views.product_recycle_bin,
        name='catalog_product_recycle_bin'
    ),

    # Booking Calendar API
    path(
        'booking/calendar-api/',
        admin_views.booking_calendar_api,
        name='booking_calendar_api'
    ),
