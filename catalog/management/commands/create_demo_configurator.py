...
from configurator_3d.models import NodeMapping, SceneConfig
        ...
        "slots": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    {
                        "name": "Matte Black Wheels",
                        "sku": "WRAP-WHL-MATTE-BLK",
                        "color": "#1A1A1A",
                        "metallic": 0.3,
                        "roughness": 0.8,
                    },
                    {
                        "name": "Gunmetal Wheels",
                        "sku": "WRAP-WHL-GUNMETAL",
                        "color": "#53565A",
                        "metallic": 0.8,
                        "roughness": 0.3,
                    },
    ...
    "cat_collar": {
        ...
        "slots": [
            ...
            },
            {
                ...
                "targets": [
                    {
                        "target_node": "Stitches_01_Collar_Stitches_0",
                        "material_name": "Collar_Stitches",
                    },
                ],
                "options": [
                    {
                        "name": "White",
                        "sku": "COLLAR-STI-WHITE",
                        "color": "#F0F0F0",
                        "metallic": 0.0,
                        "roughness": 1.0,
                        "is_default": True,
        ...
        "slots": [
            {
                ...
                "targets": [
                    {
                        "target_node": "Stereo textured mesh_Material0_0",
                        "material_name": "Material0",
                    },
                    {
                        "target_node": "Stereo textured mesh_Material1_0",
                        "material_name": "Material1",
                    },
                    {
                        "target_node": "Stereo textured mesh_Material2_0",
                        "material_name": "Material2",
                    },
                    {
                        "target_node": "Stereo textured mesh_Material3_0",
...
class Command(BaseCommand):
    ...
    def _delete_product(self, spec):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Deleted product {sku} + {deleted_count} option products")
        )
    ...
    def _create_product(self, spec):
        ...
        if Product.objects.filter(sku=product_data["sku"]).exists():
            self.stderr.write(
                self.style.ERROR(
                    f"Product {product_data['sku']} already exists. Use --delete first to recreate."
                )
            )
            return
        ...
        for slot_spec in spec["slots"]:
            ...
            for i, opt_spec in enumerate(slot_spec["options"]):
                ...
                targets = slot_spec.get("targets") or [
                    {
                        "target_node": slot_spec["target_node"],
                        "material_name": slot_spec["material_name"],
                    },
                ]
        ...
        self.stdout.write(
            f"  3D Setup: http://localhost:8000/en/admin/product/{product.id}/3d-scene/"
        )
