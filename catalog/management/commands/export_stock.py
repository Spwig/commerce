...
from catalog.models import StockItem, Warehouse, SalesRegion, Product
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--warehouse',
            type=str,
            help='Filter by warehouse code (optional)'
        )
        parser.add_argument(
            '--region',
            type=str,
            help='Filter by region code (optional)'
        )
        parser.add_argument(
            '--sku',
            type=str,
            help='Filter by product SKU pattern (supports * wildcard, optional)'
        )
        ...
        try:
            with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
                ...
                for stock_item in queryset:
                    ...
                    threshold = stock_item.low_stock_threshold or stock_item.product.low_stock_threshold
