...
class SpwigLicenseServerAdapter(BaseLicenseProviderAdapter):
    ...
    def create_license(self, license_key, product, order) -> tuple[bool, str, dict]:
        ...
        if success:
            ...
            logger.info(
                f"Successfully created license {license_key.key} in Spwig Built-in License Server (ID: {external_id})"
            )
    ...
    def test_connection(self) -> dict:
        ...
        try:
            ...
            logger.exception("Connection test failed for Spwig Built-in License Server")
