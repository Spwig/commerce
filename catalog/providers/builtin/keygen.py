...
class KeygenAdapter(BaseLicenseProviderAdapter):
    ...
    def create_license(self, license_key, product, order) -> tuple[bool, str, dict]:
        ...
        data = {
            "data": {
                ...
                "attributes": {
                    ...
                    "expiry": license_key.expires_at.isoformat()
        ...
        if success and response.get("data"):
            ...
            logger.info(
                f"Successfully created license {license_key.key} in Keygen (ID: {external_id})"
            )
    ...
    def activate_device(
        ...
        data = {
            "data": {
                ...
                "relationships": {
                    "license": {"data": {"type": "licenses", "id": keygen_license_id}}
                },
            }
        }
        ...
        if success and response.get("data"):
            ...
            logger.info(
                f"Successfully activated device {device_fingerprint} in Keygen (ID: {activation_id})"
            )
    ...
    def suspend_license(self, license_key) -> tuple[bool, dict]:
        ...
        data = {"data": {"type": "licenses", "attributes": {"suspended": True}}}
    ...
    def test_connection(self) -> dict:
        ...
        try:
            ...
            logger.exception("Connection test failed for Keygen.sh")
