...
urlpatterns = [
    ...
    path(
        "forms/<int:pk>/builder/fields/<int:field_id>/delete/",
        views.delete_field,
        name="delete_field",
    ),
    path(
        "forms/<int:pk>/builder/fields/<int:field_id>/update/",
        views.update_field,
        name="update_field",
    ),
    ...
    path(
        "forms/<int:pk>/builder/steps/<int:step_id>/update/", views.update_step, name="update_step"
    ),
    path(
        "forms/<int:pk>/builder/steps/<int:step_id>/delete/", views.delete_step, name="delete_step"
    ),
    ...
    path(
        "forms/<int:pk>/builder/rules/<int:rule_id>/update/", views.update_rule, name="update_rule"
    ),
    path(
        "forms/<int:pk>/builder/rules/<int:rule_id>/delete/", views.delete_rule, name="delete_rule"
    ),
    ...
    path(
        "forms/<int:pk>/builder/actions/<int:action_id>/update/",
        views.update_action,
        name="update_action",
    ),
    path(
        "forms/<int:pk>/builder/actions/<int:action_id>/delete/",
        views.delete_action,
        name="delete_action",
    ),
]
