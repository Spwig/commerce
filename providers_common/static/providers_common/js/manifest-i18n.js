...
const ManifestI18n = (function() {
    ...
    function _resolve(translations) {
        ...
        var lang = getAdminLanguage();
        var defaultLang = translations.default_language || 'en';
    ...
    function apply(translations) {
        var strings = _resolve(translations);
        if (!strings) return;
...
document.addEventListener('DOMContentLoaded', function () {
    var el = document.getElementById('manifest-translations');
