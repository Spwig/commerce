...
def get_2fa_grace_period_status(context):
    ...
    if settings.staff_2fa_enforcement == 'required' and settings.staff_2fa_enforcement_date:
        ...
        if user.date_joined > settings.staff_2fa_enforcement_date:
            grace_end = user.date_joined + timezone.timedelta(days=settings.staff_2fa_grace_period_days)
        else:
            grace_end = settings.staff_2fa_enforcement_date + timezone.timedelta(days=settings.staff_2fa_grace_period_days)
