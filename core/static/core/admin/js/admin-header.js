  ...
  function handleHeaderActions(e) {
    ...
    switch (action) {
      ...
      case 'help-show-categories':
        e.preventDefault();
        if (
          typeof window.HelpSystem !== 'undefined' &&
          typeof window.HelpSystem.showCategories === 'function'
        ) {
      ...
      case 'help-submit-feedback':
        ...
        if (
          typeof window.HelpSystem !== 'undefined' &&
          typeof window.HelpSystem.submitFeedback === 'function'
        ) {
      ...
      case 'help-submit-feedback-comment':
        ...
        if (
          typeof window.HelpSystem !== 'undefined' &&
          typeof window.HelpSystem.submitFeedbackComment === 'function'
        ) {
