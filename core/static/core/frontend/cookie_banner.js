...
(function () {
    ...
    var COOKIE_NAME = 'spwig_cookie_consent';
    var banner = document.getElementById('cookie-banner');

    if (!banner) return;

    var consentUrl = banner.dataset.cookieConsentUrl;
    var mode = banner.dataset.cookieConsentMode;
    ...
    function setConsentCookie(consent) {
        ...
        document.cookie = COOKIE_NAME + '=' + encodeURIComponent(JSON.stringify(consent))
            + '; max-age=' + (365 * 24 * 3600) + '; path=/; samesite=lax' + secure;
    }
    ...
    function getModalConsent() {
        ...
        var functional = document.getElementById('consent-functional');
        return {
            necessary: true,
