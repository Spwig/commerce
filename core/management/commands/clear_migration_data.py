...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        from catalog.models import Category, Product, ProductImage, ProductReview, ProductVariant
        from customers.models import AbandonedCart, CustomerMetrics, CustomerNote
        from orders.models import Address, Order, OrderItem
        from vouchers.models import AppliedVoucher, GiftCard, VoucherCode, VoucherUsage
