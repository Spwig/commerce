...
from core.models import HelpCategory, HelpTopic, HelpFeedback
    ...
    def _export_json(self, output_path, topics_qs, include_stats):
        ...
        for topic in topics_qs:
            ...
            if include_stats:
                ...
                # Get recent feedback
                recent_feedback = HelpFeedback.objects.filter(
                    topic=topic,
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            ...
            for topic in topics_qs.order_by('category__order', 'category__name', 'slug'):
                ...
                if include_stats:
                    ...
                    f.write(f'**Helpful:** {topic.helpful_count}/{topic.helpful_count + topic.not_helpful_count}')
