...
urlpatterns = [
    ...
    path(
        "health/detailed/", views.health_detailed, name="health_detailed"
    ),  # Detailed (requires staff auth)
...
urlpatterns += [
    ...
    path(
        "license/third-party-notices/", views.third_party_notices_view, name="third_party_notices"
    ),
]
...
urlpatterns += [
    ...
    path(
        ...
        currency_endpoints.list_active_currencies,
        name="api_currencies_active",
    ),
    path(
        "api/currencies/activate/",
        currency_endpoints.activate_currencies,
        name="api_currencies_activate",
    ),
    path(
        "api/currencies/deactivate/",
        currency_endpoints.deactivate_currencies,
        name="api_currencies_deactivate",
    ),
    path(
    ...
    path(
        "api/translation/health/", translation_api.translation_health, name="api_translation_health"
    ),
    path(
        "api/translation/languages/",
        translation_api.get_available_languages_api,
        name="api_translation_languages",
    ),
    path(
        "api/translation/<str:model_type>/<int:object_id>/<str:field_key>/status/",
        translation_api.generic_translation_status,
        name="api_generic_translation_status",
    ),
    path(
        "api/translation/<str:model_type>/<int:object_id>/<str:field_key>/translate/",
        translation_api.translate_generic_field,
        name="api_translate_generic_field",
    ),
    path(
        "api/translation/<str:model_type>/<int:object_id>/<str:field_key>/save/",
        translation_api.save_generic_translations,
        name="api_save_generic_translations",
    ),
    path(
        "api/translation/<str:model_type>/<int:object_id>/<str:field_key>/save_field/",
        translation_api.save_field_value,
        name="api_save_field_value",
    ),
...
from design.views import BrandCSSView, EditorContentCSSView, LayeredCSSView, ThemeCSSView
...
urlpatterns += [
    ...
    path(
        "webhooks/shipping/<str:provider_key>/", provider_webhook, name="shipping_provider_webhook"
    ),
]
...
urlpatterns += i18n_patterns(
    ...
    path(
        "admin/translations/translationjob/",
        RedirectView.as_view(url="/admin/translations/jobs/", permanent=True),
    ),
    path(
        "admin/translations/translationjob/<path:rest>/",
        RedirectView.as_view(url="/admin/translations/jobs/", permanent=True),
    ),
...
urlpatterns += [
    ...
    path(
        "admin/api/swagger/", SpectacularSwaggerView.as_view(url_name="schema"), name="swagger-ui"
    ),
