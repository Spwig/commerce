...
class UnitConverter:
    ...
    @classmethod
    def convert_weight(cls, value: Decimal, from_unit: str, to_unit: str) -> Optional[Decimal]:
        """
    ...
    @classmethod
    def convert_length(cls, value: Decimal, from_unit: str, to_unit: str) -> Optional[Decimal]:
        """
    ...
    @classmethod
    def convert_volume(cls, value: Decimal, from_unit: str, to_unit: str) -> Optional[Decimal]:
        """
    ...
    @classmethod
    def convert_area(cls, value: Decimal, from_unit: str, to_unit: str) -> Optional[Decimal]:
        """
    ...
    @classmethod
    def convert_temperature(cls, value: Decimal, from_unit: str, to_unit: str) -> Optional[Decimal]:
        """
