...
def generate_oauth_providers_summary():
    ...
    try:
        ...
        description_text = _('Configure which social login providers (Google, Apple, Microsoft) are available to customers')
        dashboard_btn_text = _('Open OAuth Dashboard')
        accounts_btn_text = _('View Connected Accounts')
        setup_guide_title = _('Setup Guide')
        wizard_intro = _('Visit the OAuth Dashboard to configure social login providers using our step-by-step wizard. Each provider has detailed instructions for:')
        ...
        tip_label = _('Tip:')
        tip_text = _('Start with Google OAuth - it\'s free, unlimited, and trusted by billions of users.')
...
def _auto_initialize_oauth_providers():
    ...
    try:
        ...
        providers = [
            ...
            {'provider': 'microsoft', 'display_name': 'Microsoft', 'button_order': 3, 'enabled': False},
        ]
