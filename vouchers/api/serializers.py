...
class VoucherCodeSerializer(serializers.ModelSerializer):
    ...
    max_discount_amount = MoneySerializerField(max_digits=10, decimal_places=2, required=False, allow_null=True)
    min_order_value = MoneySerializerField(max_digits=10, decimal_places=2, required=False, allow_null=True)
    gift_card_balance = MoneySerializerField(max_digits=10, decimal_places=2, required=False, allow_null=True, read_only=True)
    original_gift_card_value = MoneySerializerField(max_digits=10, decimal_places=2, required=False, allow_null=True)
