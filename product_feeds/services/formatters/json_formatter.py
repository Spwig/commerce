...
class JSONFeedFormatter(BaseFeedFormatter):
    ...
    def _build_google_feed(self, items: List[ProductFeedItem], metadata: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _build_meta_feed(self, items: List[ProductFeedItem], metadata: Dict[str, Any]) -> Dict[str, Any]:
        """
