...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var feedPreview = document.getElementById('feed-preview');
            ...
            try {
                ...
                if (result.success) {
                    ...
                    if (result.preview && feedPreview) {
                        ...
                        document.getElementById('preview-product-count').textContent = result.preview.product_count || 0;
                        document.getElementById('preview-category-count').textContent = result.preview.category_count || 0;
