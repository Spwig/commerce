...
urlpatterns = [
    ...
    path('providers/install/<slug:provider_slug>/', wizard.install_provider_ajax, name='install_provider'),
    path('providers/update/<slug:provider_slug>/', wizard.update_provider_ajax, name='update_provider'),
