...
urlpatterns = [
    ...
    path('groups/<int:group_id>/permanent-delete/', views.permanent_delete_group, name='permanent_delete_group'),
    ...
    path('fields/<int:field_id>/permanent-delete/', views.permanent_delete_field, name='permanent_delete_field'),
