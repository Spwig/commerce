...
def scene_setup(request, product_id):
        ...
        geometry_data.append(
            {
                ...
                "media_url": ga.media_asset.original_file.url
        ...
        texture_data.append(
            {
                ...
                "media_url": ta.media_asset.original_file.url
    ...
    scene_data = {
        "base_model_url": scene.base_model.original_file.url
        if scene.base_model and scene.base_model.original_file
        else None,
        ...
        "environment_image_id": str(scene.environment_image_id)
        if scene.environment_image_id
        else None,
    ...
    return JsonResponse(
        {
            ...
            "geometry_asset": {
                ...
                "media_url": ga.media_asset.original_file.url
                if ga.media_asset.original_file
                else "",
                "target_node": ga.target_node,
                "node_data": ga.node_data,
            },
    ...
    return JsonResponse(
        {
            ...
            "texture_asset": {
                ...
                "media_url": ta.media_asset.original_file.url
                if ta.media_asset.original_file
                else "",
                "texture_type": ta.texture_type,
                "texture_type_display": ta.get_texture_type_display(),
            },
...
def capture_thumbnail(request, product_id):
    ...
    try:
        ...
        return JsonResponse(
            {"error": _("An error occurred while capturing the thumbnail. Please try again.")},
            status=500,
        )
