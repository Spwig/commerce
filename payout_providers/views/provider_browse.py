...
class ProviderBrowseView(View):
    ...
    def get(self, request):
        ...
        try:
            ...
            available_from_server = update_manager.list_available_components(component_type='payout_provider')
...
def install_provider_ajax(request, provider_slug):
    ...
    try:
        ...
        available_providers = update_manager.list_available_components(component_type='payout_provider')
