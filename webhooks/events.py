...
WEBHOOK_EVENTS = {
    ...
    "order.status_changed": (_("Fired when order status changes"), WebhookEventCategory.ORDER),
    "order.note_added": (_("Fired when a note is added to an order"), WebhookEventCategory.ORDER),
    # Payment Events
    "payment.received": (_("Fired when a payment is received"), WebhookEventCategory.PAYMENT),
    "payment.failed": (_("Fired when a payment attempt fails"), WebhookEventCategory.PAYMENT),
    "payment.pending": (
        _("Fired when a payment is pending confirmation"),
        WebhookEventCategory.PAYMENT,
    ),
    # Refund Events
    "refund.created": (_("Fired when a refund is initiated"), WebhookEventCategory.REFUND),
    "refund.completed": (_("Fired when a refund is completed"), WebhookEventCategory.REFUND),
    "refund.failed": (_("Fired when a refund fails"), WebhookEventCategory.REFUND),
    # Shipment Events
    "shipment.created": (_("Fired when a shipment is created"), WebhookEventCategory.SHIPMENT),
    "shipment.shipped": (_("Fired when a shipment is dispatched"), WebhookEventCategory.SHIPMENT),
    "shipment.in_transit": (
    ...
    "shipment.delivered": (_("Fired when a shipment is delivered"), WebhookEventCategory.SHIPMENT),
    "shipment.failed": (_("Fired when a shipment delivery fails"), WebhookEventCategory.SHIPMENT),
    "shipment.returned": (_("Fired when a shipment is returned"), WebhookEventCategory.SHIPMENT),
    ...
    "inventory.restocked": (_("Fired when a product is restocked"), WebhookEventCategory.INVENTORY),
    "inventory.adjusted": (
        _("Fired when inventory is manually adjusted"),
        WebhookEventCategory.INVENTORY,
    ),
    # Product Events
    "product.created": (_("Fired when a new product is created"), WebhookEventCategory.PRODUCT),
    "product.updated": (_("Fired when product details are updated"), WebhookEventCategory.PRODUCT),
    "product.deleted": (_("Fired when a product is deleted"), WebhookEventCategory.PRODUCT),
    "product.published": (_("Fired when a product is published"), WebhookEventCategory.PRODUCT),
    "product.unpublished": (_("Fired when a product is unpublished"), WebhookEventCategory.PRODUCT),
    # Customer Events
    "customer.created": (_("Fired when a new customer registers"), WebhookEventCategory.CUSTOMER),
    "customer.updated": (
    ...
    "cart.recovered": (_("Fired when an abandoned cart is recovered"), WebhookEventCategory.CART),
    # Translation Events
