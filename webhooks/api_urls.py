...
urlpatterns = [
    ...
    path(
        "endpoints/<uuid:pk>/rotate-secret/",
        api_views.rotate_webhook_secret,
        name="endpoint-rotate-secret",
    ),
    path(
        "endpoints/<uuid:pk>/reset-failures/",
        api_views.reset_endpoint_failures,
        name="endpoint-reset-failures",
    ),
    ...
    path(
        "deliveries/<uuid:pk>/", api_views.WebhookDeliveryDetail.as_view(), name="delivery-detail"
    ),
