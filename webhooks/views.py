...
from .events import get_events_by_category, WebhookEventCategory
...
def endpoint_wizard(request):
    ...
    if request.method == 'POST':
        ...
        messages.success(
            request,
            _('Webhook endpoint "%(name)s" created successfully. '
...
def filter_endpoints(request):
    ...
    html = render_to_string(
        'admin/webhooks/partials/endpoint_cards.html',
        {'endpoints': queryset, 'request': request}
    )
