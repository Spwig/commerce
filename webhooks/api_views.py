    ...
    @extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                name='endpoint',
                type=str,
                description=_('Filter by endpoint UUID')
            ),
            OpenApiParameter(
                name='event_type',
                type=str,
    ...
    responses={
        200: inline_serializer(
            ...
            fields={
                ...
                'signature_verification': drf_serializers.CharField(help_text='Signature verification docs'),
...
def get_webhook_documentation(request):
    ...
    from .events import get_events_by_category, WEBHOOK_EVENTS
    ...
    for category, events in events_by_category.items():
        category_data = {
            'category': category,
            'events': events,
            'payload_schema': payload_schemas.get(category, {
