...
class CampaignSignalIntegrationTestCase(TestCase):
    ...
    def test_order_placed_triggers_campaign(self):
        ...
        user = User.objects.create_user(
            username="testcustomer", email="customer@example.com", password="testpass123"
        )
        ...
        campaign = LoyaltyCampaign.objects.create(
            ...
            actions=[{"type": "award_points", "points": 100, "reason": "First order bonus"}],
        )
        ...
        executions = LoyaltyCampaignExecution.objects.filter(campaign=campaign, member=member)
    ...
    def test_order_below_minimum_skips_campaign(self):
        ...
        # Create user
        user = User.objects.create_user(
            username="testcustomer2", email="customer2@example.com", password="testpass123"
        )
    ...
    def test_customer_signup_triggers_campaign(self):
        ...
        user = User.objects.create_user(
            username="newcustomer", email="newcustomer@example.com", password="testpass123"
        )
    ...
    def test_tier_promotion_triggers_campaign(self):
        ...
        user = User.objects.create_user(
            username="testcustomer3", email="customer3@example.com", password="testpass123"
        )
        ...
        campaign = LoyaltyCampaign.objects.create(
            ...
            status=LoyaltyCampaign.STATUS_ACTIVE,
            target_all_members=True,
            actions=[{"type": "award_points", "points": 200, "reason": "Tier promotion bonus"}],
        )
    ...
    def test_multiple_campaigns_trigger_for_same_event(self):
        ...
        # Create user
        user = User.objects.create_user(
            username="testcustomer4", email="customer4@example.com", password="testpass123"
        )
    ...
    def test_inactive_campaign_does_not_trigger(self):
        ...
        # Create user
        user = User.objects.create_user(
            username="testcustomer5", email="customer5@example.com", password="testpass123"
        )
    ...
    def test_tier_targeting_filters_members(self):
        ...
        bronze_user = User.objects.create_user(
            username="bronzemember", email="bronze@example.com", password="testpass123"
        )
        ...
        gold_user = User.objects.create_user(
            username="goldmember", email="gold@example.com", password="testpass123"
        )
