...
class SegmentEvaluatorTestCase(TestCase):
    ...
    def test_points_based_segment(self):
        ...
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member1, segment))  # 500 points
        self.assertTrue(self.evaluator.evaluate_member_for_segment(self.member2, segment))  # 2000 points
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member3, segment))  # 10000 points
    ...
    def test_order_count_segment(self):
        ...
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member1, segment))  # 1 order
        self.assertTrue(self.evaluator.evaluate_member_for_segment(self.member2, segment))  # 2 orders
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member3, segment))  # 0 orders
    ...
    def test_redemption_based_segment(self):
        ...
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member1, segment))  # No redemptions
        self.assertTrue(self.evaluator.evaluate_member_for_segment(self.member2, segment))  # 1 redemption
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member3, segment))  # No redemptions
    ...
    def test_combined_rules_segment(self):
        ...
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member1, segment))  # Wrong tier
        self.assertTrue(self.evaluator.evaluate_member_for_segment(self.member2, segment))  # Matches all
        self.assertFalse(self.evaluator.evaluate_member_for_segment(self.member3, segment))  # Wrong tier
