...
class MultiStepJourneyTestCase(TestCase):
    ...
    def test_journey_with_branching(self):
        ...
        user2 = User.objects.create_user(
            username="vipuser", email="vip@example.com", password="testpass123"
        )
        ...
        campaign = LoyaltyCampaign.objects.create(
            ...
            journey_steps=[
                ...
                },
                {
                    ...
                    "actions": [
                        {"type": "award_points", "points": 500, "reason": "Bonus for high points"}
                    ],
                    "next_step_delay_days": 1,
                },
                {
        ...
        campaign = LoyaltyCampaign.objects.create(
            ...
            journey_steps=[
                ...
                },
                {
                    ...
                    "actions": [
                        {"type": "award_points", "points": 500, "reason": "Active shopper bonus"}
                    ],
                },
            ],
        )
    ...
    def test_journey_variable_delays(self):
        ...
        user2 = User.objects.create_user(
            username="vipuser2", email="vip2@example.com", password="testpass123"
        )
        member2 = LoyaltyMember.objects.get(customer=user2)
