...
urlpatterns = [
    ...
    path('analytics/campaign/<int:campaign_id>/', analytics.campaign_analytics, name='campaign_analytics'),
    path('analytics/campaign/<int:campaign_id>/export/', analytics.export_campaign_report, name='export_campaign_report'),
    ...
    path('campaigns/<int:campaign_id>/activate/', views.toggle_campaign_status, name='activate_campaign'),
    path('campaigns/<int:campaign_id>/deactivate/', views.toggle_campaign_status, name='deactivate_campaign'),
    ...
    path('account/rewards/<int:reward_id>/redeem/', views.customer_redeem_reward, name='customer_redeem'),
    path('account/redemptions/<int:redemption_id>/', views.customer_redemption_detail, name='customer_redemption_detail'),
