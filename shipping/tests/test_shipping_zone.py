...
class ShippingZoneModelTest(TestCase):
    ...
    def test_matches_address_no_restrictions(self):
        ...
        self.assertTrue(
            zone.matches_address({"country": "JP", "state": "Tokyo", "postal_code": "100-0001"})
        )
    ...
    def test_matches_address_country_match(self):
        ...
        self.assertTrue(zone.matches_address({"country": "US"}))
        self.assertTrue(
            zone.matches_address({"country": "US", "state": "CA", "postal_code": "90210"})
        )
    ...
    def test_matches_address_state_no_match(self):
        ...
        self.assertFalse(
            zone.matches_address({"country": "US", "state": "NY", "postal_code": "10001"})
        )
    ...
    def test_matches_address_postal_pattern_match(self):
        ...
        self.assertTrue(
            zone.matches_address({"country": "US", "state": "NY", "postal_code": "10018"})
        )
        self.assertTrue(
            zone.matches_address({"country": "US", "state": "NY", "postal_code": "11201"})
        )
        ...
        self.assertFalse(
            zone.matches_address({"country": "US", "state": "NY", "postal_code": "12345"})
        )
    ...
    def test_matches_address_postal_pattern_no_match(self):
        ...
        self.assertTrue(
            zone.matches_address({"country": "CA", "state": "MB", "postal_code": "R3T 2N2"})
        )
        self.assertFalse(
            zone.matches_address({"country": "CA", "state": "ON", "postal_code": "M5V 3A8"})
        )
    ...
    def test_matches_address_multiple_patterns(self):
        ...
        self.assertTrue(
            zone.matches_address({"country": "US", "state": "CA", "postal_code": "94102"})
        )
        self.assertFalse(
            zone.matches_address({"country": "US", "state": "CA", "postal_code": "92101"})
        )
    ...
    def test_matches_address_combined_restrictions(self):
        ...
        # Wrong state
        self.assertFalse(
            zone.matches_address({"country": "US", "state": "NY", "postal_code": "90210"})
        )

        # Wrong postal pattern
        self.assertFalse(
            zone.matches_address({"country": "US", "state": "CA", "postal_code": "95000"})
        )

        # Wrong country
        self.assertFalse(
            zone.matches_address({"country": "CA", "state": "BC", "postal_code": "90210"})
        )
    ...
    def test_matches_address_case_insensitive_country(self):
        """Test country matching is case-insensitive (normalized to uppercase)"""
        zone = ShippingZone.objects.create(
            name="USA",
            priority=0,
            countries=["US"],
        ...
        # Current implementation normalizes to uppercase, so lowercase matches
        self.assertTrue(zone.matches_address({"country": "us"}))
        self.assertTrue(zone.matches_address({"country": "US"}))
    ...
    def test_whitespace_in_postal_code(self):
        ...
        self.assertTrue(
            zone.matches_address({"country": "CA", "state": "ON", "postal_code": "M5V3A8"})
        )
