...
from shipping.providers.loader import check_platform_compatibility, validate_provider_package
...
class ProviderBaseTest(TestCase):
    ...
    def test_mock_provider_implements_interface(self):
        ...
        provider = MockProvider(
            credentials={"api_key": "test_key_12345", "api_secret": "test_secret_12345"}
        )
...
class MockProviderTest(TestCase):
    ...
    def test_credential_validation(self):
        ...
        # Valid credentials
        valid_creds = {"api_key": "test_key_12345", "api_secret": "test_secret_12345"}
    ...
    def test_webhook_signature_verification(self):
        ...
        self.assertTrue(self.provider.verify_webhook_signature(payload, correct_sig))

        # Test with incorrect signature
        self.assertFalse(self.provider.verify_webhook_signature(payload, "wrong_signature"))
...
class ProviderLoaderTest(TestCase):
    ...
    def test_validate_manifest_structure(self):
        ...
        # Valid manifest — uses new `component_type` field
        valid_manifest = {
            "name": "Test Provider",
            "version": "1.0.0",
    ...
    def test_platform_compatibility_check(self):
        ...
        # Compatible
        manifest = {"name": "Test Provider", "min_platform_version": "1.0.0"}
