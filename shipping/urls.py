...
urlpatterns = [
    ...
    path('admin/carrierpreset/<uuid:carrier_id>/toggle-active/', toggle_carrier_active, name='carrier_toggle_active'),
    path('admin/carrierpreset/<uuid:carrier_id>/set-default/', set_carrier_default, name='carrier_set_default'),
    ...
    path('admin/provideraccount/<uuid:provider_id>/toggle-active/', toggle_provider_active, name='provider_toggle_active'),
    path('admin/provideraccount/<uuid:provider_id>/set-default/', set_provider_default, name='provider_set_default'),
    path('admin/provideraccount/<uuid:provider_id>/test-connection/', test_provider_connection, name='provider_test_connection'),
    path('admin/provideraccount/<uuid:provider_id>/delete/', delete_provider, name='provider_delete'),
