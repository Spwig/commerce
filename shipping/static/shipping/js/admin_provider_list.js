...
(function () {
  ...
  function toggleProviderActive(providerId, button) {
    ...
    fetch(
      AdminUtils.buildAdminUrl(`/admin/shipping/provideraccount/${providerId}/toggle-active/`),
      {
        method: 'POST',
        headers: {
  ...
  function testProviderConnection(providerId, button) {
    ...
    fetch(
      AdminUtils.buildAdminUrl(`/admin/shipping/provideraccount/${providerId}/test-connection/`),
      {
        method: 'POST',
        headers: {
          'X-CSRFToken': AdminUtils.getCsrfToken(),
