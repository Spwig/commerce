...
(function() {
    ...
    var configEl = document.getElementById('provider-account-config');
    var i18n = {};
    if (configEl) {
        try {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var secretFields = document.querySelectorAll('input[data-secret="true"]');
        secretFields.forEach(function(field) {
            ...
            if (fieldRow && !fieldRow.querySelector('.shipping-credential-help')) {
                ...
                var fieldContainer = field.closest('div');
                if (fieldContainer) {
