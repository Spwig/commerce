...
def parse_fedex_date(date_str: str | None) -> datetime | None:
    """
...
def parse_money(money_obj: Any | None) -> Decimal | None:
    """
...
def get_currency(money_obj: Any | None, fallback: str = "USD") -> str:
    """
