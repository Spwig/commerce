...
class ProviderBrowseView(View):
    ...
    def get(self, request):
        ...
        installed_db = {
            ...
            for p in ComponentRegistry.objects.filter(component_type="shipping_provider")
        }
        ...
        for provider in available_providers:
            ...
            documentation_url = provider.get("documentation_url") or manifest.get(
                "documentation_url", ""
            )
...
def install_provider_ajax(request, provider_slug):
    ...
    if ComponentRegistry.objects.filter(
