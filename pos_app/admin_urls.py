...
from .dashboard_views import (
    pos_dashboard, filter_terminals, filter_shifts, enable_store_location,
    filter_promo_slides, filter_receipt_templates,
    filter_terminal_providers, filter_terminal_readers,
    sync_readers, quick_assign_reader, refresh_reader_status,
    unlock_terminal, activate_license,
)
from . import admin_views
from .wizard_views import (
    TerminalWizardStep1View, TerminalWizardStep2View, TerminalWizardStep3View,
    TerminalWizardStep4View, TerminalWizardStep5View,
    ReaderWizardStep1View, ReaderWizardStep2View, ReaderWizardStep3View,
)
...
urlpatterns = [
    ...
    path('readers/<uuid:reader_id>/refresh-status/', refresh_reader_status, name='refresh_reader_status'),
