define(['exports'], function (t) {
      ...
      (y = Object.assign
        ...
        : function (t) {
            for (let e = 1; e < arguments.length; e++) {
              const s = arguments[e];
              for (const n in s) ({}).hasOwnProperty.call(s, n) && (t[n] = s[n]);
            }
            return t;
          }),
  ...
  function k(t, e) {
    ...
    const s = e.replace(/FromIndex$/, ''),
      n = e !== s,
      r = N.includes(s);
    if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || (!r && !C.includes(s))) return;
  ...
  class P {
    ...
    async expireEntries(t, e) {
      ...
      const a = [];
      for (const t of r) (await s.delete(B, t.id), a.push(t.url));
      return a;
    }
    m(t) {
      return this.u + '|' + T(t);
  ...
  class A {
    constructor(t, e) {
      ((this.I = {}),
        ...
        (this.O = [...t.plugins]),
        (this.k = new Map()));
      for (const t of this.O) this.k.set(t, {});
    ...
    async cachePut(t, e) {
      ...
      let a;
      const o = await this.B(e);
      if (!o) return !1;
      const { cacheName: c, matchOptions: h } = this.L,
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const i = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                a = await t.keys(e, i);
              for (const e of a) if (r === j(e.url, s)) return t.match(e, n);
  ...
  class F {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        r = new A(this, { event: e, request: s, params: n }),
        i = this.T(r, s, e);
      return [i, this.P(i, r, s, e)];
    }
    async T(t, e, n) {
      let r;
      await t.runCallbacks('handlerWillStart', { event: n, request: e });
      try {
        if (((r = await this.M(e, t)), !r || 'error' === r.type))
  ...
  ((t.CacheFirst = class extends F {
    ...
    (t.ExpirationPlugin = class {
      ...
      J(t) {
        ...
        let e = this.Y.get(t);
        return (e || ((e = new M(t, this.X)), this.Y.set(t, e)), e);
      }
      V(t) {
        if (!this.D) return !0;
        const e = this.Z(t);
    ...
    (t.NetworkFirst = class extends F {
      constructor(t = {}) {
        (super(t),
          this.plugins.some(t => 'cacheWillUpdate' in t) || this.plugins.unshift(W),
      ...
      async M(t, e) {
        ...
        let i;
        if (this.nt) {
          const { id: s, promise: a } = this.rt({ request: t, logs: n, handler: e });
          ((i = s), r.push(a));
        }
    ...
    (t.StaleWhileRevalidate = class extends F {
      constructor(t = {}) {
        (super(t), this.plugins.some(t => 'cacheWillUpdate' in t) || this.plugins.unshift(W));
      }
      async M(t, e) {
