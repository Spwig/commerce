...
(function () {
    ...
    function showAdminTable() {
        ...
        var table = document.getElementById('admin-table-view');
    ...
    document.addEventListener('click', async function (e) {
        ...
        if (action === 'toggle-affiliate-status') {
            ...
            var statusAction = activate ? 'activate' : 'pause';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var config = document.getElementById('affiliate-list-config');
        if (config && window.AdminListFilters) {
            var lang = document.documentElement.lang || 'en';
            var filterPath = config.dataset.filterPath;
