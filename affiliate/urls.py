...
merchant_patterns = [
    ...
    path('programs/<int:program_id>/affiliates/', views.ProgramAffiliatesView.as_view(), name='program_affiliates'),
...
urlpatterns = [
    ...
    path('programs/<int:program_id>/activate/', views.toggle_program_status, name='activate_program'),
    path('programs/<int:program_id>/pause/', views.toggle_program_status, name='pause_program'),
    path('programs/<int:program_id>/archived/', views.update_program_status, {'new_status': 'archived'}, name='archive_program'),
    path('programs/<int:program_id>/active/', views.update_program_status, {'new_status': 'active'}, name='activate_program_status'),
    path('programs/<int:program_id>/paused/', views.update_program_status, {'new_status': 'paused'}, name='pause_program_status'),
    path('programs/<int:program_id>/members/filter/', views.filter_program_members, name='filter_program_members'),

    # Admin AJAX Endpoints - Affiliates
    path('affiliates/filter/', views.filter_affiliates, name='filter_affiliates'),
    path('affiliates/<int:affiliate_id>/approve/', views.toggle_affiliate_status, name='approve_affiliate'),
    path('affiliates/<int:affiliate_id>/suspend/', views.toggle_affiliate_status, name='suspend_affiliate'),
    path('affiliates/<int:affiliate_id>/activate/', views.toggle_affiliate_status, name='activate_affiliate'),
    ...
    path('memberships/<int:membership_id>/approve/', views.toggle_membership_status, name='approve_membership'),
    path('memberships/<int:membership_id>/reject/', views.toggle_membership_status, name='reject_membership'),
