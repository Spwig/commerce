...
class UtilityRegistry:
    ...
    def register_builtin_utilities(self):
        ...
        # Color Picker
        self.register_utility('color_picker', {
            ...
            'supported_properties': [
                'color', 'background_color', 'border_color', 'text_color',
                'hover_background_color', 'hover_border_color', 'overlay_color',
                'dark_background_color', 'dark_border_color'
            ],
            'options': {
                'show_opacity': True,
                'show_swatches': True,
        ...
        # Gradient Creator
        self.register_utility('gradient_creator', {
            ...
            'supported_properties': [
                'background_gradient', 'hover_background_gradient',
                'overlay_gradient', 'hover_overlay_gradient'
            ],
            'options': {
        ...
        # Border Editor
        self.register_utility('border_editor', {
            ...
            'supported_properties': [
                ...
                'border_radius_top', 'border_radius_right', 'border_radius_bottom',
                'border_radius_left', 'custom_border'
            ],
            'options': {
        ...
        # Spacing Editor
        self.register_utility('spacing_editor', {
        ...
        # Shadow Editor
        self.register_utility('shadow_editor', {
            ...
            'supported_properties': [
                'box_shadow', 'hover_box_shadow', 'text_shadow'
            ],
            'options': {
        ...
        # Unit Selector
        self.register_utility('unit_selector', {
            ...
            'supported_properties': [
                'width_unit', 'height_unit', 'padding_unit', 'margin_unit',
                'gap_unit', 'min_height_unit', 'max_height_unit'
            ],
            'options': {
        ...
        # Background Editor
        self.register_utility('background_editor', {
            'display_name': _('Background Editor'),
            'description': _('Comprehensive background styling editor with images, gradients, and patterns'),
            'component_type': 'popup',
            ...
            'supported_properties': [
                ...
                'background_attachment', 'background_gradient'
            ],
            'options': {
                'color_picker_integration': True,
        ...
        # Typography Editor
        self.register_utility('typography_editor', {
        ...
        # Translation Editor
        self.register_utility('translation_editor', {
            ...
            'supported_properties': [
                'translatable_text', 'translatable_content', 'translatable_title',
    ...
    def get_utility(self, name: str) -> Optional[UtilityConfig]:
