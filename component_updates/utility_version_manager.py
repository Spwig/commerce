...
class UtilityVersionManager:
    ...
    def install_utility_version(
        utility_slug: str, version: str, package_path: Path
    ) -> dict[str, Any]:
        """
    ...
    @staticmethod
    def get_current_version(utility_slug: str) -> str | None:
    ...
    @staticmethod
    def rollback_utility(utility_slug: str, to_version: str | None = None) -> dict[str, Any]:
        """
        ...
        try:
            ...
            if not current:
                return {"success": False, "error": f"No current version for {utility_slug}"}
    ...
    @staticmethod
    def uninstall_utility(utility_slug: str, version: str | None = None) -> dict[str, Any]:
        """
